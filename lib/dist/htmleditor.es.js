import ot, { createContext as _r, useContext as Or, useReducer as Sr, useMemo as ce, useState as se, useCallback as P, useRef as re, useEffect as oe, forwardRef as It, createElement as wt, memo as kr, useLayoutEffect as Mn, useImperativeHandle as Pr } from "react";
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    var g = ot, m = Symbol.for("react.transitional.element"), T = Symbol.for("react.portal"), E = Symbol.for("react.fragment"), A = Symbol.for("react.strict_mode"), k = Symbol.for("react.profiler"), O = Symbol.for("react.consumer"), v = Symbol.for("react.context"), b = Symbol.for("react.forward_ref"), y = Symbol.for("react.suspense"), S = Symbol.for("react.suspense_list"), C = Symbol.for("react.memo"), N = Symbol.for("react.lazy"), w = Symbol.for("react.activity"), L = Symbol.for("react.client.reference"), q = g.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, B = Object.prototype.hasOwnProperty, F = Array.isArray, J = console.createTask ? console.createTask : function() {
      return null;
    };
    g = {
    ...
    var Y, Q = {}, ae = g.react_stack_bottom_frame.bind(
      g,
      o
    )(), le = J(n(o)), R = {};
    Pe.Fragment = E, Pe.jsx = function(l, M, D) {
...
var cn;
function Ir() {
  return cn || (cn = 1, process.env.NODE_ENV === "production" ? We.exports = Lr() : We.exports = Mr()), We.exports;
}
var h = Ir();
const At = 100, Ct = 50, Rt = 200, ln = 5, _t = (e) => e < Rt, Ot = (e) => e > Ct, Hr = 96, ye = (e) => Math.round(e * Hr), Qe = {
  NORMAL: {
    name: "Normal",
    label: 'Normal (1")',
    top: 1,
...
}, gi = (e) => Object.keys(et).includes(e), hi = () => Object.keys(et), Be = Bn, be = "<p><br></p>", zr = "continuous", Le = (e, t = Be) => ({
  id: Ht(),
  index: e,
  size: t,
  content: be,
  images: [],
  isBreakPoint: !1
}), Ke = (e) => typeof e != "string" || e.trim() === "" ? be : e, Dn = (e, t = Be) => (e.length > 0 ? e : [Le(0, t)]).map((n, a) => ({
  id: n.id || Ht(),
  index: a,
  size: n.size || t,
  ...
  top: 0,
  height: He(e).height
}], Ge = (e) => e.slice(0, -1).map((t, r) => ({
  id: `auto-break-${r}`,
  pageNumber: r + 1
})), St = (e = {}) => {
  const t = (/* @__PURE__ */ new Date()).toISOString(), r = e.pageSize || Be, n = Dn(e.pages || [Le(0, r)], r);
  return {
    id: Ht(),
  ...
  switch (t.type) {
    case W.INITIALIZE_DOCUMENT: {
      const { initialContent: n = be, pageSize: a = Be } = t.payload || {}, o = { ...Le(0, a), content: Ke(n) };
      return St({
        title: e.title,
        pageSize: a,
        pages: [o]
    ...
    case W.UPDATE_PAGES: {
      const n = Array.isArray(t.payload) ? { pages: t.payload } : t.payload || {}, a = Dn(n.pages || [], e.pageSize), o = Array.isArray(n.pageBreaks) ? n.pageBreaks : Ge(a);
      return {
        ...e,
        pages: a,
    ...
    case W.SET_EDITOR_MODE: {
      ...
      return n === "continuous" ? a = e.pages.map((i) => i.content).filter((i) => i && i !== be).join(`
`) || be : e.continuousContent && e.continuousContent !== be && (o = [{ ...Le(0, e.pageSize), content: e.continuousContent }]), {
        ...e,
        editorMode: n,
        continuousContent: a,
        pages: o,
...
function Fr() {
  if (un) return ee;
  un = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, r = e ? Symbol.for("react.portal") : 60106, n = e ? Symbol.for("react.fragment") : 60107, a = e ? Symbol.for("react.strict_mode") : 60108, o = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, i = e ? Symbol.for("react.context") : 60110, d = e ? Symbol.for("react.async_mode") : 60111, c = e ? Symbol.for("react.concurrent_mode") : 60111, f = e ? Symbol.for("react.forward_ref") : 60112, u = e ? Symbol.for("react.suspense") : 60113, p = e ? Symbol.for("react.suspense_list") : 60120, g = e ? Symbol.for("react.memo") : 60115, m = e ? Symbol.for("react.lazy") : 60116, T = e ? Symbol.for("react.block") : 60121, E = e ? Symbol.for("react.fundamental") : 60117, A = e ? Symbol.for("react.responder") : 60118, k = e ? Symbol.for("react.scope") : 60119;
  function O(b) {
  ...
  return ee.AsyncMode = d, ee.ConcurrentMode = c, ee.ContextConsumer = i, ee.ContextProvider = s, ee.Element = t, ee.ForwardRef = f, ee.Fragment = n, ee.Lazy = m, ee.Memo = g, ee.Portal = r, ee.Profiler = o, ee.StrictMode = a, ee.Suspense = u, ee.isAsyncMode = function(b) {
    ...
    return typeof b == "string" || typeof b == "function" || b === n || b === c || b === o || b === a || b === u || b === p || typeof b == "object" && b !== null && (b.$$typeof === m || b.$$typeof === g || b.$$typeof === s || b.$$typeof === i || b.$$typeof === f || b.$$typeof === E || b.$$typeof === A || b.$$typeof === k || b.$$typeof === T);
  }, ee.typeOf = O, ee;
}
var te = {};
/** @license React v16.13.1
...
function Ur() {
  return dn || (dn = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function O(H) {
      ...
      H === n || H === c || H === o || H === a || H === u || H === p || typeof H == "object" && H !== null && (H.$$typeof === m || H.$$typeof === g || H.$$typeof === s || H.$$typeof === i || H.$$typeof === f || H.$$typeof === E || H.$$typeof === A || H.$$typeof === k || H.$$typeof === T);
    }
    function v(H) {
    ...
    var b = d, y = c, S = i, C = s, N = t, w = f, L = n, q = m, B = g, F = r, J = o, Y = a, Q = u, ae = !1;
    function le(H) {
      return ae || (ae = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), R(H) || v(H) === d;
    }
    function R(H) {
      return v(H) === c;
    }
  ...
  return Tt = function(i, d) {
    ...
    function E(R) {
      ...
      function D($, U, I, G, K, V, ie) {
        ...
        return U[I] == null ? $ ? U[I] === null ? new T("The " + K + " `" + V + "` is marked as required " + ("in `" + G + "`, but its value is `null`.")) : new T("The " + K + " `" + V + "` is marked as required in " + ("`" + G + "`, but its value is `undefined`.")) : null : R(U, I, G, K, V);
      }
      var j = D.bind(null, !1);
    ...
    function O(R) {
      function l(M, D, j, $, U) {
        if (typeof R != "function")
          return new T("Property `" + U + "` of component `" + j + "` has invalid PropType notation inside arrayOf.");
        var I = M[D];
        if (!Array.isArray(I)) {
          var G = Y(I);
          return new T("Invalid " + $ + " `" + U + "` of type " + ("`" + G + "` supplied to `" + j + "`, expected an array."));
        }
    ...
    function v() {
      function R(l, M, D, j, $) {
        ...
        if (!i(U)) {
          var I = Y(U);
          return new T("Invalid " + j + " `" + $ + "` of type " + ("`" + I + "` supplied to `" + D + "`, expected a single ReactElement."));
        }
        return null;
      }
      return E(R);
    ...
    function b() {
      function R(l, M, D, j, $) {
        ...
        if (!e.isValidElementType(U)) {
          var I = Y(U);
          return new T("Invalid " + j + " `" + $ + "` of type " + ("`" + I + "` supplied to `" + D + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return E(R);
    ...
    function y(R) {
      function l(M, D, j, $, U) {
        if (!(M[D] instanceof R)) {
          ...
          return new T("Invalid " + $ + " `" + U + "` of type " + ("`" + G + "` supplied to `" + j + "`, expected ") + ("instance of `" + I + "`."));
        }
        return null;
      }
      return E(l);
    ...
    function S(R) {
      ...
      function l(M, D, j, $, U) {
        ...
        return new T("Invalid " + $ + " `" + U + "` of value `" + String(I) + "` " + ("supplied to `" + j + "`, expected one of " + K + "."));
      }
      return E(l);
    }
    function C(R) {
      function l(M, D, j, $, U) {
        if (typeof R != "function")
          return new T("Property `" + U + "` of component `" + j + "` has invalid PropType notation inside objectOf.");
        var I = M[D], G = Y(I);
        if (G !== "object")
          return new T("Invalid " + $ + " `" + U + "` of type " + ("`" + G + "` supplied to `" + j + "`, expected an object."));
        for (var K in I)
          if (n(I, K)) {
            var V = R(I, K, j, $, U + "." + K, r);
            if (V instanceof Error)
    ...
    function N(R) {
      ...
      for (var l = 0; l < R.length; l++) {
        ...
        if (typeof M != "function")
          return o(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ae(M) + " at index " + l + "."
          ), s;
      }
      function D(j, $, U, I, G) {
        ...
        return new T("Invalid " + I + " `" + G + "` supplied to " + ("`" + U + "`" + ue + "."));
      }
      return E(D);
    }
    function w() {
      function R(l, M, D, j, $) {
        return F(l[M]) ? null : new T("Invalid " + j + " `" + $ + "` supplied to " + ("`" + D + "`, expected a ReactNode."));
      }
      return E(R);
    }
    ...
    function q(R) {
      function l(M, D, j, $, U) {
        var I = M[D], G = Y(I);
        if (G !== "object")
          return new T("Invalid " + $ + " `" + U + "` of type `" + G + "` " + ("supplied to `" + j + "`, expected `object`."));
        for (var K in R) {
          var V = R[K];
...
function Zr() {
  ...
  if (En = 1, process.env.NODE_ENV !== "production") {
    var e = Fn(), t = !0;
    qe.exports = /* @__PURE__ */ qr()(e.isElement, t);
  } else
    qe.exports = /* @__PURE__ */ Yr()();
  return qe.exports;
}
var Vr = /* @__PURE__ */ Zr();
const x = /* @__PURE__ */ Nr(Vr), Wn = {
  ...
  // 72 pt ≈ 96 px
], st = "16px", Xr = (e) => Math.round(e * 96 / 72), Jr = (e) => Math.round(e * 72 / 96 * 2) / 2, yi = (e) => {
  ...
  const [e, t] = se(bn), r = we(), n = P((g, m, T = null) => {
    try {
      ...
      try {
        ...
        return O.appendChild(v), A.insertNode(O), A.selectNodeContents(O), E.removeAllRanges(), E.addRange(A), t((b) => ({ ...b, [g]: m })), !0;
      } catch {
        if (T) {
          const O = g === "fontSize" ? Qr[m] || "3" : m;
          return document.execCommand(T, !1, O), t((v) => ({ ...v, [g]: m })), !0;
        }
        return !1;
      }
    } catch (E) {
    ...
    try {
      ...
      if (!m || m.rangeCount === 0)
        return !1;
      const T = m.getRangeAt(0), E = T.toString(), k = {
        justifyLeft: "left",
      ...
      if (!k)
        return !1;
      if (!E) {
        const v = T.startContainer, b = v.nodeType === Node.TEXT_NODE ? v.parentElement : v, y = Me(b) || ro();
        return y && (y.style.textAlign = k, i(k)), !0;
      }
      const O = no(T);
      if (O.length === 0) {
        const v = document.createElement("p");
        v.style.textAlign = k;
        const b = T.extractContents();
        v.appendChild(b), T.insertNode(v), T.selectNodeContents(v), m.removeAllRanges(), m.addRange(T);
      } else
        O.forEach((v) => {
          v.style.textAlign = k;
        });
    ...
    try {
      ...
      if (!m || m.rangeCount === 0)
        return !1;
      const T = m.getRangeAt(0), E = document.createElement("div");
      if (E.innerHTML = g, Array.from(E.children).some(
        (k) => ["TABLE", "UL", "OL", "BLOCKQUOTE", "PRE", "DIV", "H1", "H2", "H3", "H4", "H5", "H6"].includes(k.tagName)
      )) {
        const k = T.startContainer, O = k.nodeType === Node.TEXT_NODE ? k.parentElement : k, v = Me(O);
        if (v && ["P", "H1", "H2", "H3", "H4", "H5", "H6"].includes(v.tagName)) {
          const b = v.tagName.toLowerCase();
          if (T.startOffset === 0 && (k === v || k.nodeType === Node.TEXT_NODE && k === v.firstChild))
            v.parentNode.insertBefore(E, v);
          else if (T.startOffset === k.textContent?.length && k === v.lastChild && T.endOffset === k.textContent?.length) {
            const C = v.nextSibling;
            C ? v.parentNode.insertBefore(E, C) : v.parentNode.appendChild(E);
          } else {
            const C = T.extractContents(), N = document.createTextNode(""), w = document.createElement(b);
          ...
          T.insertNode(E);
        T.setStartAfter(E), T.setEndAfter(E), m.removeAllRanges(), m.addRange(T);
      } else
    ...
    try {
      ...
      console.warn(`[useFormatting] Error executing command "${g}":`, T);
    }
  }, [o, a, d, c, r]), u = P(() => {
    try {
      ...
      if (!g || g.rangeCount === 0)
        return;
      const m = g.getRangeAt(0), T = m.toString();
      let E = st, A = "Arial", k = "#000000", O = "p", v = "left";
      if (T) {
        const y = m.startContainer, S = y.nodeType === Node.TEXT_NODE ? y.parentElement : y;
        if (S) {
          const C = window.getComputedStyle(S), N = C.fontSize, w = C.fontFamily;
          ...
          if (q) {
            ...
            ["h1", "h2", "h3", "h4", "h5", "h6", "p"].includes(B) && (O = B);
...
function no(e) {
  const t = [], r = e.startContainer, n = e.endContainer, a = Me(
...
const Ee = 'page-break, [data-page-break="true"]', oo = (e, t = {}) => {
  if (!e || typeof document > "u")
    return [];
  const r = t.pageSize || "A4", n = He(r), a = e.querySelectorAll(Ee), o = [];
  o.push({
    id: "page-0",
    pageNumber: 1,
    top: 0,
  ...
  const n = He(e), a = Br(r), o = n.height - a, s = t / 100;
  return o / s;
}, so = (e, t) => {
  if (!e || !t)
    return 0;
  ...
  try {
    const d = Array.from(e.querySelectorAll(Ee));
    if (t > d.length)
    ...
    }), e.querySelectorAll(Ee).forEach((m, T) => {
      m.setAttribute("data-page-number", String(T + 2));
    }), f && o && setTimeout(() => {
      o(0);
    }, 50), n) {
      const m = e.innerHTML;
    ...
    for (let p = 0; p < c.length && u < vn; p++) {
      ...
      if (m && m.overflowIndex > 0) {
        ...
        for (let O = 0; O < g.length; O++) {
          const v = g[O];
          v && v.getBoundingClientRect && (T += qn(v));
        }
        if (T - d < ho)
          continue;
        const A = p + 2;
  ...
  const a = we(), o = re(null), s = re(null), i = re(e), d = re(r), c = re(n), f = re(!1);
  oe(() => {
    i.current = e;
  }, [e]), oe(() => {
    d.current = r;
  ...
  const u = P((y = {}) => t?.current ? oo(t.current, y) : [], [t]), p = P((y = {}) => {
    const S = u(y);
    return a.updatePageBoundaries(S), S;
  }, [u, a]), g = P((y = {}) => {
    const S = typeof y.delay == "number" ? y.delay : wo;
    xo(p, o, y, S);
  }, [p]), m = P(() => {
    t?.current && yo(
      t.current,
    ...
    To(m, s, y);
  }, [m]), E = P((y) => !y?.current || !t?.current ? 0 : so(y.current, t.current), [t]), A = P((y) => {
    t?.current && Yn(t.current, y);
  }, [t]), k = P((y, S) => {
    if (!S?.current || !t?.current) {
      console.warn("[scrollToPage] Missing refs");
      return;
    }
    bo(S.current, t.current, y, A);
  }, [t, A]), O = P(async (y) => t?.current ? co(
    t.current,
    y,
    i.current,
    d.current,
    ...
    A,
    m
  ) : !1, [t, u, a, p, A, m]), b = P((y) => t?.current ? fo(
    y,
    t.current,
    a.updateContinuousContent,
    p,
...
function vi(e, { width: t, height: r }) {
  xe(e) && (e.tagName === "IMG" ? (e.style.width = `${t}px`, e.style.height = `${r}px`, e.width = t, e.height = r) : e.tagName === "DIV" && (e.style.width = `${t}px`, e.style.height = `${r}px`));
}
function _o(e, t = Se) {
  if (!xe(e)) return null;
...
const So = "html-editor-storage", ko = 1, fe = "images";
function Po() {
...
function No(e) {
  return new Promise((t, r) => {
    ...
    a.onload = async (o) => {
      ...
      try {
        const c = await De(), f = `editor-image-${Po()}`, p = c.transaction([fe], "readwrite").objectStore(fe), g = {
          key: f,
          dataUrl: s,
          size: d,
          type: e.type,
...
const Ta = [
  ...
  const s = (g, m, T, E = null, A = !1) => /* @__PURE__ */ h.jsx(
    "button",
    {
      onClick: g,
    ...
    try {
      ...
      const T = await No(g), E = await Lo(T);
      if (E && n) {
        const A = `<img src="${E}" data-key="${T}" alt="Inserted image" />`;
        n(A);
      } else
...
const Ca = 20, Ra = 20, Rn = 20, _n = -12, _a = {
...
}, Sa = (e, t, r) => !!((ve(t) || ve(r)) && (e.key.length === 1 || e.key === "Enter" || e.key === " ")), ka = (e, t, r) => !!((e.key === "Backspace" || e.key === "Delete") && (ve(t) || ve(r))), ve = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && ve(e.parentElement) : !1, Ft = ({
  dimensions: e,
  editorRef: t,
  onInput: r,
  onContentChange: n,
  ...
  const u = ce(() => Hn(f), [f]), p = c / 100, g = P((v, b) => {
    if (!v) return !1;
    const y = v.getBoundingClientRect(), S = b - y.top;
    return S < u.top || S > y.height - u.bottom;
  }, [u.top, u.bottom]), m = P((v, b) => {
    b.preventDefault();
    const y = v.getBoundingClientRect(), S = b.clientX - y.left, C = b.clientY - y.top, N = y.width - Rn - Ca, w = _n, L = y.width - Rn, q = _n + Ra;
    S >= N && S <= L && C >= w && C <= q && d && d(v);
  }, [d]), T = P((v) => {
    v.preventDefault();
    const b = t.current.getBoundingClientRect();
    if (v.clientY - b.top < u.top) {
      const S = t.current.firstElementChild;
      S && S.tagName !== "PAGE-BREAK" && On(S, !0);
    } else {
      const S = t.current.lastElementChild;
      S && S.tagName !== "PAGE-BREAK" && On(S, !1);
    }
  }, [t, u.top]), E = P((v) => {
    const b = window.getSelection();
    if (!b || b.rangeCount === 0) return;
    const y = b.getRangeAt(0), { startContainer: S, endContainer: C } = y;
    if (Sa(v, S, C))
    ...
    const b = window.getSelection();
    if (!b || b.rangeCount === 0) return;
    const y = b.getRangeAt(0), { startContainer: S } = y;
    if (ve(S))
      return v.preventDefault(), !1;
  }, []), O = P((v) => {
    const b = va(v);
...
const Pa = kr(Ft), rr = ({
  ...
  const T = Math.max(e?.length || 0, 1), E = (A) => {
    if (T <= 1) {
...
const Na = ot.memo(rr), Ze = 10, La = 300, Ma = 200;
function Ia(e) {
  switch (e) {
    case z.TOP_LEFT:
    case z.BOTTOM_RIGHT:
...
function ja(e, t, r, n) {
  const { ctrlKey: a, metaKey: o, shiftKey: s, key: i } = e, d = a || o, c = r.offsetWidth, f = r.offsetHeight, p = {
    // Increase width
    ">": d && s ? () => ({
      width: Math.min(n.maxWidth || 800, c + Ze),
      height: f
    }) : null,
    // Decrease width
    "<": d && s ? () => ({
      width: Math.max(n.minWidth || 50, c - Ze),
      height: f
    }) : null,
    // Increase height
    "+": d && s ? () => ({
      width: c,
      height: Math.min(n.maxHeight || 600, f + Ze)
    }) : null,
    // Decrease height
    "-": d && s ? () => ({
      width: c,
      height: Math.max(n.minHeight || 50, f - Ze)
    }) : null,
    // Reset to default
...
const Ut = ({
  ...
  const d = P((E) => {
    ...
    A && (o.current.overlay = A, o.current.image = E, document.body.appendChild(A), A.querySelectorAll(".resize-handler").forEach((O) => {
    ...
    const A = E.currentTarget.dataset.handler, k = o.current.image.getBoundingClientRect(), O = window.pageYOffset || document.documentElement.scrollTop, v = window.pageXOffset || document.documentElement.scrollLeft;
    o.current.start = {
      x: E.clientX,
      y: E.clientY,
    ...
    const { x: A, y: k, width: O, height: v } = o.current.start, b = o.current.handler, y = E.clientX, S = E.clientY, C = Ba({
      handler: b,
      startX: A,
      startY: k,
      currentX: y,
  ...
  return oe(() => {
    ...
    if (!e.current) return;
    const E = e.current;
    return E.addEventListener("click", g), E.addEventListener("keydown", m), window.addEventListener("resize", T), () => {
      E.removeEventListener("click", g), E.removeEventListener("keydown", m), window.removeEventListener("resize", T), o.current.isResizing && (document.removeEventListener("mousemove", u), document.removeEventListener("mouseup", p), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = ""), o.current.overlay && bt(o.current.overlay);
    };
  }, [e, g, m, T, u, p]), oe(() => {
    if (!e.current) return;
    const E = new MutationObserver((A) => {
      A.forEach((k) => {
        k.type === "childList" && k.removedNodes.forEach((O) => {
          O.nodeType === Node.ELEMENT_NODE && xe(O) && O === o.current.image && c();
        });
      });
    });
...
const sr = {
  ...
  const [s, i] = se({ top: 0, left: 0 }), [d, c] = se(!1), [f, u] = se("top"), [p, g] = se(o), m = re(null), T = we(), E = (w) => {
  ...
  const b = P(() => {
    ...
    let ae = Math.max(10, Math.min(Q, q - L.width - 10)), le = Math.max(10, Math.min(Y, B - L.height - 10));
    i({ top: le, left: ae }), u(J), c(!0);
  }, [e]);
  Mn(() => {
    b();
    const w = () => {
...
function Wa(e) {
  ...
  for (let s = 0; s < t.columns - 1; s++) {
    const i = nt(X.COLUMN, s, t, n, e);
    r.appendChild(i);
  }
  for (let s = 0; s < t.rows - 1; s++) {
    const i = nt(X.ROW, s, t, n, e);
    r.appendChild(i);
  }
  const a = rt(X.TABLE_BOTTOM, t, n);
  r.appendChild(a);
  const o = rt(X.TABLE_RIGHT, t, n);
...
function nt(e, t, r, n, a) {
  ...
  return Oe(s, e, t, r, n, a), s;
}
function rt(e, t, r) {
  const n = e === X.TABLE_RIGHT ? r.height : r.width, a = ar(e, n);
  return Oe(a, e, null, t, r, null), a;
}
function Mt(e, t) {
  if (!e || !t) return;
  Ae(t);
  ...
  if (a.length !== r.columns - 1 || o.length !== r.rows - 1 || !s || !i) {
    ...
    for (let u = 0; u < r.columns - 1; u++) {
      const p = nt(X.COLUMN, u, r, n, t);
      e.appendChild(p);
    }
    for (let u = 0; u < r.rows - 1; u++) {
      const p = nt(X.ROW, u, r, n, t);
      e.appendChild(p);
    }
    const c = rt(X.TABLE_BOTTOM, r, n);
    e.appendChild(c);
    const f = rt(X.TABLE_RIGHT, r, n);
    e.appendChild(f);
  } else
    a.forEach((c, f) => {
      Oe(c, X.COLUMN, f, r, n, t);
    }), o.forEach((c, f) => {
      Oe(c, X.ROW, f, r, n, t);
    }), s && Oe(s, X.TABLE_BOTTOM, null, r, n, null), i && Oe(i, X.TABLE_RIGHT, null, r, n, null);
}
function Ne(e) {
  e && e.parentNode && e.parentNode.removeChild(e);
}
function qt(e, t = "Operation") {
  return he(e) ? !0 : (console.warn(`${t}: Invalid table element`), !1);
}
function qa(e) {
...
function ir(e, t, r = 0) {
  ...
  try {
    const o = qa(a);
    n < e.rows.length ? e.rows[n].parentNode.insertBefore(o, e.rows[n]) : e.rows[e.rows.length - 1].parentNode.appendChild(o), Ae(e);
    const s = me(e);
    return s && je(e, {
...
function ni(e, t) {
  ...
  try {
    const r = e.rows[t];
    r.parentNode.removeChild(r), Ae(e);
    const n = me(e);
    return n && je(e, {
      columnWidths: n.columnWidths,
      rowHeights: n.rowHeights
...
const Yt = ({
  ...
  const o = re(null), s = re(null), i = re(null), d = re(null), c = re(null), f = re(a), u = re(!1), [p, g] = se(null), m = we();
  oe(() => {
    f.current = a;
  }, [a]);
  const T = P(() => {
    s.current && (s.current.classList.remove("selected"), s.current = null), o.current && (Ne(o.current), o.current = null), g(null), i.current = null, d.current = null, c.current = null, u.current = !1, n && n();
  }, [n]), E = P((C) => {
    if (Je(C), !s.current) return;
    ...
    document.body.style.cursor = F, document.addEventListener("mousemove", O), document.addEventListener("mouseup", v);
  }, []), A = P((C) => {
    ...
    if (!he(C)) return;
    o.current && (Ne(o.current), o.current = null), C.classList.add("selected"), A(C) && (g(C), r && r(C));
  }, [r, A]), O = P((C) => {
    ...
    je(s.current, Q), o.current && Mt(o.current, s.current);
  }, []), v = P((C) => {
    if (u.current) {
      if (Je(C), s.current && i.current) {
        const N = {
          structure: i.current.structure
        }, w = {
          structure: me(s.current)
        };
      ...
      if (i.current = null, d.current = null, c.current = null, u.current = !1, document.removeEventListener("mousemove", O), document.removeEventListener("mouseup", v), document.body.classList.remove("table-resize-in-progress"), document.body.style.cursor = "", s.current) {
        const N = new Event("input", { bubbles: !0, cancelable: !0 });
        s.current.dispatchEvent(N), t && t(s.current, me(s.current));
      }
    }
  }, [t, m]), b = P((C) => {
  ...
  return oe(() => {
    ...
    return N && (N.addEventListener("scroll", S), window.addEventListener("scroll", S)), () => {
      N && N.removeEventListener("scroll", S), window.removeEventListener("scroll", S);
    };
  }, [e, S]), oe(() => {
    if (!e.current) return;
    const C = e.current;
    return C.addEventListener("click", b), C.addEventListener("keydown", y), window.addEventListener("resize", S), () => {
      C.removeEventListener("click", b), C.removeEventListener("keydown", y), window.removeEventListener("resize", S), u.current && (document.removeEventListener("mousemove", O), document.removeEventListener("mouseup", v), document.body.classList.remove("table-resize-in-progress"), document.body.style.cursor = ""), o.current && Ne(o.current);
    };
  }, [e, b, y, S, O, v]), oe(() => {
    if (!e.current) return;
    const C = new MutationObserver((N) => {
      N.forEach((w) => {
        w.type === "childList" ? (w.removedNodes.forEach((L) => {
          L.nodeType === Node.ELEMENT_NODE && he(L) && L === p && T();
        ...
        ) && o.current && s.current && (Ne(o.current), o.current = null, A(s.current))) : w.type === "attributes" && ["colspan", "rowspan"].includes(w.attributeName) && p && o.current && s.current && (Ne(o.current), o.current = null, A(s.current));
      });
    });
...
const Ve = {
  ...
  const [s, i] = se({ top: 0, left: 0 }), [d, c] = se(!1), [f, u] = se("top"), [p, g] = se("left"), m = re(null), T = we(), E = P(() => {
    if (!e) return "left";
  ...
  const A = P(() => {
    ...
    if (Y) {
      ...
      $ > j && $ > 0 ? (Q = "bottom", ae = B.bottom + 10) : (Q = "top", ae = B.top - F.height - 10);
    } else
      Q = "top", ae = 10;
    le = B.left + B.width / 2 - F.width / 2;
    const R = window.innerWidth, l = window.innerHeight;
    let M = Math.max(10, Math.min(le, R - F.width - 10)), D = Math.max(10, Math.min(ae, l - F.height - 10));
  ...
  const k = P((B) => {
    ...
    const ae = J ? { element: e, index: Y } : { element: e, index: Y };
    T.recordOperation(
      { type: B, payload: ae },
      { type: B, payload: ae }
    ...
    () => O(_e.INSERT_ROW_ABOVE, Ya),
    [O]
  ), b = ce(
    () => O(_e.INSERT_ROW_BELOW, Za),
    [O]
  ), y = ce(
    () => O(_e.INSERT_COL_LEFT, Ka),
    [O]
  ), S = ce(
    () => O(_e.INSERT_COL_RIGHT, Xa),
    [O]
  ), C = ce(
    () => O(_e.DELETE_ROW, oi),
    [O]
    ...
    rowAction: { ...Ve, background: "#28a745", color: "#fff" },
    colAction: { ...Ve, background: "#0056b3", color: "#fff" },
    delete: { ...Ve, background: "#dc3545", color: "#fff" },
...
const ai = ".table-cell-selected, .table-row-selected, .table-col-selected", Ln = () => {
  ...
  const r = re({
    ...
    hasDragged: !1,
    startCell: null
  }), [n, a] = se(!1), [o, s] = se(!1), [i, d] = se(null), [c, f] = se(null), u = re(null), p = P(() => {
    r.current = {
      selectedCells: /* @__PURE__ */ new Set(),
      selectionMode: null,
      selectedRowIndex: null,
    ...
    const S = y.closest("tr"), C = y.closest("table");
    if (!S || !C) return null;
    const N = Array.from(C.rows).indexOf(S), w = Array.from(S.cells).indexOf(y);
    return { rowIndex: N, cellIndex: w, table: C };
  }, []), T = P((y) => {
    if (y.size === 0) return { mode: null, rowIndex: null, colIndex: null };
    const S = Array.from(y), C = S[0], N = m(C);
    if (!N) return { mode: null, rowIndex: null, colIndex: null };
    const { table: w } = N;
    return S.filter((B) => {
      const F = m(B);
      return F && F.table === w && F.rowIndex === N.rowIndex;
    }).length >= 2 ? { mode: "row", rowIndex: N.rowIndex, colIndex: null } : S.filter((B) => {
      const F = m(B);
    ...
    if (Ln(), !(!w || !y)) {
      ...
      } else y === "column" && C !== null ? Array.from(w.rows).forEach((L) => {
        const q = L.cells[C];
    ...
    const C = T(y);
    r.current.selectedCells = y, r.current.selectionMode = C.mode, r.current.selectedRowIndex = C.rowIndex, r.current.selectedColIndex = C.colIndex, r.current.currentTable = S, f(S), E(C.mode, C.rowIndex, C.colIndex, y, S);
    const N = C.mode ? {
      mode: C.mode,
      cells: y,
      rowIndex: C.rowIndex,
    ...
    const S = y.target.closest("td, th");
    if (!S) return;
    const C = m(S);
    C && (a(!0), d(S), f(C.table), s(!1));
  }, [m]), O = P((y) => {
    if (!n || !i) return;
    const S = y.target.closest("td, th");
    if (!S || !c || !Sn(c, S)) return;
    s(!0), Je(y);
    const C = m(i), N = m(S);
    ...
    const S = y.target.closest("td, th"), C = y.target.closest("table");
    if (!(S && c && Sn(c, S))) {
      if (C && C !== c) {
        g();
        return;
  ...
  return oe(() => {
    if (!e.current) return;
    const y = e.current, S = (N) => {
      N.target.closest("td, th") && k(N);
    }, C = (N) => {
      N.target.closest("td, th") && O(N);
    };
    return y.addEventListener("mousedown", S, !0), y.addEventListener("mouseenter", C, !0), document.addEventListener("mouseup", v), document.addEventListener("click", b), () => {
      y.removeEventListener("mousedown", S, !0), y.removeEventListener("mouseenter", C, !0), document.removeEventListener("mouseup", v), document.removeEventListener("click", b);
    };
  }, [e, k, O, v, b]), oe(() => {
    if (!e.current) return;
...
const ii = 50, vt = 50, ci = 50, li = 100, ui = 300, Kt = It(({
  ...
  const u = $n(), p = we(), { pageSize: g, pageMargins: m, continuousContent: T, pageBoundaries: E, activePage: A, zoomLevel: k, canUndo: O, canRedo: v } = u, b = re(null), y = re(null), { currentFormat: S, formatText: C, updateCurrentFormatFromSelection: N } = eo(), [w, L] = se(!1), [q, B] = se(null), [F, J] = se(!0), [Y, Q] = se(!1), [ae, le] = se(null), [R, l] = se(null), [M, D] = se(null), {
  ...
  } = Ao(g, y, k, m), H = ce(() => He(g), [g]), [ue, Ce] = se(!1), pe = re(null), ze = re(!1), $e = re(!1), Fe = re(!1), Ue = re(T), at = P(() => {
    ze.current = !1;
    const _ = Math.max(0, E.length - 1);
    p.setActivePage(_), setTimeout(() => {
      U(_, b);
    }, ci);
  }, [E.length, p, U]);
  oe(() => {
    if (!y.current || Fe.current) return;
    y.current.innerHTML = T, Fe.current = !0, Ue.current = T;
    const _ = setTimeout(() => {
      I();
    }, ii);
    ...
    if (y.current.innerHTML !== T) {
      ...
      return Ue.current = T, () => clearTimeout(ne);
    }
  }, [T, I, at]), oe(() => {
    s && Fe.current && s(T);
  }, [T, s]);
  const { restoreCursorPosition: it, hasActiveCursorSelection: ct } = Ro({
    updateCurrentFormatFromSelection: N,
    editorRef: y
  }), dr = P((_) => {
    _ !== T && p.updateContinuousContent(_), y.current && y.current.innerHTML !== _ && (y.current.innerHTML = _), Ue.current = _, setTimeout(() => {
      I();
    }, vt);
  }, [T, p, I]), lt = P((_) => {
    if (!y.current || !_) return;
    ct() || it(), document.execCommand("insertHTML", !1, _);
    const ne = y.current.innerHTML;
    p.updateContinuousContent(ne), Ue.current = ne, setTimeout(() => {
      I(), G(200);
    }, vt);
  }, [ct, it, p, I, G]), Xt = ce(() => ({
    /**
    ...
    getSelectedHTMLContent: () => {
      ...
      const ne = _.getRangeAt(0);
      if (!y.current.contains(ne.commonAncestorContainer)) return "";
      if (ne.collapsed) {
        const ge = ne.commonAncestorContainer;
        return ge.nodeType === Node.TEXT_NODE ? ge.parentElement ? ge.parentElement.outerHTML : "" : ge.outerHTML || "";
      }
      let de = ne.commonAncestorContainer;
      if (de.nodeType === Node.TEXT_NODE && (de = de.parentElement), de === y.current) {
        const ge = ne.cloneContents(), Re = document.createElement("div");
        return Re.appendChild(ge), Re.innerHTML;
      }
      return de ? de.outerHTML : "";
    },
    /**
     ...
     */
    getCursorPosition: () => y.current ? vo(y.current) : null,
    /**
     ...
     */
    setPageSize: (_) => {
      p.updatePageSize(_), I({ pageSize: _ });
    },
    /**
     ...
     */
    setPageMargins: (_) => {
      p.updatePageMargins(_), I({ pageMargins: _ });
    },
    /**
  ...
  const ut = P(() => {
    if (!y.current) return;
    let _ = y.current.innerHTML;
    _ = Xe(_), _ !== y.current.innerHTML && (y.current.innerHTML = _);
    const ne = T;
    if (ne !== _) {
      const ge = {
      ...
      p.recordOperation(ge, Re);
    }
    p.updateContinuousContent(_), j(), G(200);
    const de = $(b);
    de !== A && p.setActivePage(de);
  }, [p, j, $, A, G, b, y, T]), fr = P((_) => {
    ut();
  }, [ut]), Jt = P((_) => {
    p.updatePageSize(_), I({ pageSize: _ }), a && a(_);
  }, [p, I, a]), Qt = P((_) => {
    p.updatePageMargins(_), I({ pageMargins: _ }), o && o(_);
  }, [p, I, o]), en = P((_) => {
    _ < 0 || _ >= E.length || ($e.current = !0, p.setActivePage(_), U(_, b), setTimeout(() => {
      $e.current = !1;
    }, ui), t && t(_));
  }, [p, U, t, E.length]), tn = P(() => {
    const _ = E.length + 1;
    ie(_) && (ze.current = !0, setTimeout(() => {
      ze.current && at();
    }, 100)), r && r();
    ...
    handleUndo: () => p.undo(),
    handleRedo: () => p.redo()
  }), [p]), { handleZoomIn: dt, handleZoomOut: ft, handleZoomReset: pt, handleUndo: yr, handleRedo: Tr } = mr;
  Co(
    { handleZoomIn: dt, handleZoomOut: ft, handleZoomReset: pt, handleUndo: yr, handleRedo: Tr },
    { editorRef: y, containerRef: b }
  );
  const Er = P(() => {
    !b.current || !y.current || $e.current || (pe.current && clearTimeout(pe.current), pe.current = setTimeout(() => {
      if ($e.current) {
        pe.current = null;
        return;
      }
      const _ = $(b);
      _ !== A && _ >= 0 && p.setActivePage(_), pe.current = null;
    }, li));
  }, [$, A, p]), br = ce(() => {
    if (!T) return 0;
    const ne = T.replace(/<[^>]*>/g, " ").match(new RegExp("\\p{L}+", "gu"));
    return ne ? ne.length : 0;
  }, [T]), xr = E.length || 1, vr = P((_) => {
    L(!0), B(_);
  }, []), rn = P(() => {
    L(!1), B(null);
  }, []), wr = P((_, ne) => {
  }, []), Ar = P((_) => {
    _ && _.mode === "row" ? (l(_.rowIndex), D(null)) : _ && _.mode === "column" ? (D(_.colIndex), l(null)) : (l(null), D(null));
  }, []), Cr = P((_) => {
    Q(!0), le(_);
  }, []), on = P(() => {
    Q(!1), le(null);
    ...
    /* @__PURE__ */ h.jsxs("div", { className: "editor-container", children: [
      ...
      w && q && /* @__PURE__ */ h.jsx(
        Wt,
        {
          ...
          onDelete: () => {
            if (q) {
              const _ = q.getAttribute("data-key");
              _ && Mo(_).catch((ne) => {
      ...
      c && /* @__PURE__ */ h.jsx("div", { className: "page-manager-sidebar", children: e ? ot.cloneElement(e, {
        onNavigate: en,
        onAddPage: tn,
        onDeletePage: nn,
        onPageSizeChange: Jt,
...
export {
  ...
  xe as isResizableImage,
  he as isResizableTable,
