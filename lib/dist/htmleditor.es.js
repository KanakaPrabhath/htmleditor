...
function dr() {
  return Vt || (Vt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function r(f) {
      ...
      if (C) {
        C = console;
        var I = C.error, M = typeof Symbol == "function" && Symbol.toStringTag && f[Symbol.toStringTag] || f.constructor.name || "Object";
        return I.call(
          C,
    ...
    function d(f, C, I, M, G, W) {
      ...
      if (E.call(C, "key")) {
        z = e(f);
        var q = Object.keys(C).filter(function(V) {
          return V !== "key";
        });
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (z = null, I !== void 0 && (r(I), z = "" + I), o(C) && (r(C.key), z = "" + C.key), "key" in C) {
        I = {};
        for (var K in C)
          K !== "key" && (I[K] = C[K]);
      } else I = C;
    ...
    var w = Ke, v = Symbol.for("react.transitional.element"), b = Symbol.for("react.portal"), S = Symbol.for("react.fragment"), D = Symbol.for("react.strict_mode"), j = Symbol.for("react.profiler"), O = Symbol.for("react.consumer"), y = Symbol.for("react.context"), p = Symbol.for("react.forward_ref"), g = Symbol.for("react.suspense"), R = Symbol.for("react.suspense_list"), A = Symbol.for("react.memo"), L = Symbol.for("react.lazy"), U = Symbol.for("react.activity"), P = Symbol.for("react.client.reference"), B = w.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, E = Object.prototype.hasOwnProperty, H = Array.isArray, Y = console.createTask ? console.createTask : function() {
      return null;
    };
    w = {
    ...
    _e.Fragment = S, _e.jsx = function(f, C, I) {
...
function Er() {
  ...
  return te.AsyncMode = h, te.ConcurrentMode = l, te.ContextConsumer = i, te.ContextProvider = o, te.Element = t, te.ForwardRef = d, te.Fragment = n, te.Lazy = v, te.Memo = w, te.Portal = r, te.Profiler = a, te.StrictMode = s, te.Suspense = c, te.isAsyncMode = function(p) {
    ...
    return typeof p == "string" || typeof p == "function" || p === n || p === l || p === a || p === s || p === c || p === u || typeof p == "object" && p !== null && (p.$$typeof === v || p.$$typeof === w || p.$$typeof === o || p.$$typeof === i || p.$$typeof === d || p.$$typeof === S || p.$$typeof === D || p.$$typeof === j || p.$$typeof === b);
  }, te.typeOf = O, te;
}
var ne = {};
/** @license React v16.13.1
...
function Tr() {
  return Qt || (Qt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function O(k) {
      ...
      k === n || k === l || k === a || k === s || k === c || k === u || typeof k == "object" && k !== null && (k.$$typeof === v || k.$$typeof === w || k.$$typeof === o || k.$$typeof === i || k.$$typeof === d || k.$$typeof === S || k.$$typeof === D || k.$$typeof === j || k.$$typeof === b);
    }
    function y(k) {
    ...
    var p = h, g = l, R = i, A = o, L = t, U = d, P = n, B = v, E = w, H = r, Y = a, Z = s, Q = c, ae = !1;
    function se(k) {
    ...
    ne.AsyncMode = p, ne.ConcurrentMode = g, ne.ContextConsumer = R, ne.ContextProvider = A, ne.Element = L, ne.ForwardRef = U, ne.Fragment = P, ne.Lazy = B, ne.Memo = E, ne.Portal = H, ne.Profiler = Y, ne.StrictMode = Z, ne.Suspense = Q, ne.isAsyncMode = se, ne.isConcurrentMode = x, ne.isContextConsumer = f, ne.isContextProvider = C, ne.isElement = I, ne.isForwardRef = M, ne.isFragment = G, ne.isLazy = W, ne.isMemo = z, ne.isPortal = q, ne.isProfiler = K, ne.isStrictMode = V, ne.isSuspense = ce, ne.isValidElementType = O, ne.typeOf = y;
  })()), ne;
}
var en;
function wn() {
...
function wr() {
  ...
  return at = function(i, h) {
    ...
    function R(x) {
      ...
      function f(C, I, M, G, W) {
        for (var z = C[I], q = 0; q < x.length; q++)
          if (v(z, x[q]))
            return null;
    ...
    function L(x) {
      ...
      for (var f = 0; f < x.length; f++) {
        ...
        if (typeof C != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ae(C) + " at index " + f + "."
          ), o;
      }
    ...
    function U() {
      function x(f, C, I, M, G) {
        return H(f[C]) ? null : new b("Invalid " + M + " `" + G + "` supplied to " + ("`" + I + "`, expected a ReactNode."));
      }
      return S(x);
    }
    function P(x, f, C, I, M) {
      return new b(
        (x || "React class") + ": " + f + " type `" + C + "." + I + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + M + "`."
      );
    }
    function B(x) {
      function f(C, I, M, G, W) {
...
const T = /* @__PURE__ */ lr(Cr), Rn = {
  ...
  const [e, t] = re(ln), r = Te(), n = _((c, u, w = null) => {
    ...
    try {
      ...
      if (!u || u.rangeCount === 0)
        return !1;
      const w = u.getRangeAt(0), v = w.toString(), S = {
        justifyLeft: "left",
    ...
    try {
      ...
      let v = Xe, b = "Arial", S = "p", D = "left";
      if (w) {
        const O = u.startContainer, y = O.nodeType === Node.TEXT_NODE ? O.parentElement : O;
        if (y) {
          const p = window.getComputedStyle(y), g = p.fontSize, R = p.fontFamily;
          g && g.endsWith("px") && (v = g), R && R !== "serif" && (b = R.split(",")[0].replace(/['"]/g, "").trim());
          const A = Ye(y);
          if (A) {
            const L = A.tagName?.toLowerCase();
            ["h1", "h2", "h3", "h4", "h5", "h6", "p"].includes(L) && (S = L);
            const P = window.getComputedStyle(A).textAlign;
...
const Ee = 'page-break, [data-page-break="true"]', Cn = (e) => Re[e] || Re.A4, Lr = (e, t = {}) => {
  if (!e || typeof document > "u")
    return [];
  const r = t.pageSize || "A4", n = Cn(r), s = e.querySelectorAll(Ee), a = [];
  a.push({
    id: "page-0",
    pageNumber: 1,
    top: 0,
  ...
  const n = Cn(e), s = gr(r), a = n.height - s, o = t / 100;
  return a / o;
}, Ir = (e, t) => {
  if (!e || !t)
    return 0;
  ...
  if (!e)
    return !1;
  try {
    const h = Sn(r, n, s) * (t - 1), l = Array.from(e.children);
    let d = 0, c = null;
  ...
  const c = _((g = {}) => t?.current ? Lr(t.current, g) : [], [t]), u = _((g = {}) => {
    const R = c(g);
    return s.updatePageBoundaries(R), R;
  }, [c, s]), w = _((g = {}) => {
    const R = typeof g.delay == "number" ? g.delay : Jr;
    Kr(u, a, g, R);
  }, [u]), v = _(() => {
    t?.current && qr(
      t.current,
    ...
    Zr(v, o, g);
  }, [v]), S = _((g) => !g?.current || !t?.current ? 0 : Ir(g.current, t.current), [t]), D = _((g) => {
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Co = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]], So = J("chevron-right", Co);
/**
 * @license lucide-react v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
        ...
        /* @__PURE__ */ m.jsxs("div", { className: "sidebar-header", children: [
          ...
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              children: e ? /* @__PURE__ */ m.jsx(So, { size: 16 }) : /* @__PURE__ */ m.jsx(Ro, { size: 16 })
            }
          )
        ] }),
...
const Ha = [
...
], Ba = '<table border="1"><tr><td>Cell 1</td><td>Cell 2</td></tr><tr><td>Cell 3</td><td>Cell 4</td></tr></table>', St = ({
  currentFormat: e,
  onFormatText: t,
  onAddPageBreak: r,
  canUndo: n = !1,
  ...
  return /* @__PURE__ */ m.jsxs("div", { className: "editor-toolbar", children: [
    ...
    h(),
    o("justifyLeft", "alignLeft", Ct, "Align Left"),
...
const ve = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && ve(e.parentElement) : !1, Pt = ({
  ...
  const c = be(() => yn(d), [d]), u = l / 100, w = _((y, p) => {
    if (!y) return !1;
    const g = y.getBoundingClientRect(), R = p - g.top;
    return R < c.top || R > g.height - c.bottom;
  }, [c.top, c.bottom]), v = _((y, p) => {
    p.preventDefault();
    const g = y.getBoundingClientRect(), R = p.clientX - g.left, A = p.clientY - g.top, L = g.width - 40, U = -12, P = g.width - 20;
    R >= L && R <= P && A >= U && A <= 8 && h && h(y);
  }, [h]), b = _((y) => {
    y.preventDefault();
    ...
    if (y.clientY - p.top < c.top) {
      ...
      if (R && R.tagName !== "PAGE-BREAK") {
        const A = document.createRange(), L = window.getSelection();
        A.setStart(R, 0), A.collapse(!0), L.removeAllRanges(), L.addRange(A);
      }
    } else {
    ...
    const g = p.getRangeAt(0), { startContainer: R, endContainer: A } = g;
    if ((ve(R) || ve(A)) && (y.key.length === 1 || y.key === "Enter" || y.key === " "))
      return y.preventDefault(), !1;
    if (Da(y))
      return n && n(), !1;
    if ((y.key === "Backspace" || y.key === "Delete") && (ve(R) || ve(A)))
      return y.preventDefault(), !1;
    s && s(y);
  }, [s, n]), D = _((y) => {
    if (!t.current) return;
    ...
    const p = window.getSelection();
    if (!p || p.rangeCount === 0) return;
    const g = p.getRangeAt(0), { startContainer: R } = g;
    if (ve(R))
      return y.preventDefault(), !1;
  }, []), O = _((y) => {
    const p = $a(y);
...
const Ot = ({
  ...
  const u = _((y) => {
    ...
    p && (a.current = p, o.current = y, document.body.appendChild(p), p.querySelectorAll(".resize-handler").forEach((R) => {
    ...
    const p = y.currentTarget.dataset.handler, g = o.current.getBoundingClientRect(), R = window.pageYOffset || document.documentElement.scrollTop, A = window.pageXOffset || document.documentElement.scrollLeft;
    i.current = {
      x: y.clientX,
      y: y.clientY,
      ...
      offsetX: y.clientX - g.left - A,
      offsetY: y.clientY - g.top - R
    }, h.current = p, d.current = !0, document.body.classList.add("resize-in-progress"), document.body.style.cursor = qa(p), document.addEventListener("mousemove", b), document.addEventListener("mouseup", S);
  }, []), b = _((y) => {
    if (!d.current || !o.current || !i.current || !h.current) return;
    y.preventDefault(), y.stopPropagation();
    const { x: p, y: g, width: R, height: A } = i.current, L = h.current, U = y.clientX, P = y.clientY, B = Za({
      handler: L,
      startX: p,
      startY: g,
      currentX: U,
    ...
    if (d.current) {
      ...
      if (i.current = null, h.current = null, d.current = !1, document.removeEventListener("mousemove", b), document.removeEventListener("mouseup", S), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = "", o.current) {
  ...
  return oe(() => {
    ...
    return y.addEventListener("click", D), y.addEventListener("keydown", j), window.addEventListener("resize", O), () => {
      y.removeEventListener("click", D), y.removeEventListener("keydown", j), window.removeEventListener("resize", O), d.current && (document.removeEventListener("mousemove", b), document.removeEventListener("mouseup", S), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = ""), a.current && it(a.current);
    };
  }, [e, D, j, O, b, S]), oe(() => {
    if (!e.current) return;
    const y = new MutationObserver((p) => {
      p.forEach((g) => {
        g.type === "childList" && (g.removedNodes.forEach((R) => {
          R.nodeType === Node.ELEMENT_NODE && me(R) && R === o.current && w();
        }), g.addedNodes.forEach((R) => {
...
const kt = ({
  ...
  const [o, i] = re({ top: 0, left: 0 }), [h, l] = re(!1), [d, c] = re("top"), [u, w] = re(a), v = ee(null), b = ee(null), S = Te(), D = (E) => {
    if (!E)
      return;
  ...
  const g = _(() => {
    ...
    let C = Math.max(10, Math.min(se, x - H.width - 10)), I = Math.max(10, Math.min(ae, f - H.height - 10));
    i({ top: I, left: C }), c(Q), l(!0);
  }, [e]);
  hn(() => {
    g();
    const E = () => {
        ...
        children: [
          ...
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              title: "Align Left",
              style: B(y === "left"),
              children: /* @__PURE__ */ m.jsx(Ct, { size: 14 })
            }
          ),
          /* @__PURE__ */ m.jsx(
            "button",
...
const Nt = ({
  ...
  const b = _(() => {
    ...
    const L = A.currentTarget, U = L.dataset.type, P = parseInt(L.dataset.index, 10);
    ...
    const L = Ja(A, d.current);
    return L && (a.current = L, o.current = A, document.body.appendChild(L), L.querySelectorAll(".table-resize-handler").forEach((P) => {
      P.addEventListener("mousedown", S);
    })), L;
  }, [S]), j = _((A) => {
    if (!ye(A)) return;
    a.current && (Ge(a.current), a.current = null), A.classList.add("selected"), D(A) && (w(A), r && r(A));
  }, [r, D]), O = _((A) => {
    if (!c.current || !o.current || !i.current || !h.current) return;
    A.preventDefault(), A.stopPropagation();
    const { x: L, y: U, structure: P } = i.current, B = h.current, E = l.current, H = A.clientX, Y = A.clientY;
    let Z = 0;
    switch (B) {
      case le.COLUMN:
        Z = H - L;
    ...
    a.current && !a.current.contains(A.target) && b();
  ...
  return oe(() => {
    ...
    return L && (L.addEventListener("scroll", R), window.addEventListener("scroll", R)), () => {
      L && L.removeEventListener("scroll", R), window.removeEventListener("scroll", R);
    };
  }, [e, R]), oe(() => {
    if (!e.current) return;
    const A = e.current;
    return A.addEventListener("click", p), A.addEventListener("keydown", g), window.addEventListener("resize", R), () => {
      A.removeEventListener("click", p), A.removeEventListener("keydown", g), window.removeEventListener("resize", R), c.current && (document.removeEventListener("mousemove", O), document.removeEventListener("mouseup", y), document.body.classList.remove("table-resize-in-progress"), document.body.style.cursor = ""), a.current && Ge(a.current);
    };
  }, [e, p, g, R, O, y]), oe(() => {
    if (!e.current) return;
...
const Lt = ({
  ...
  const [n, s] = re({ top: 0, left: 0 }), [a, o] = re(!1), [i, h] = re("top"), l = ee(null), d = ee(null), c = Te(), u = (g) => {
    ...
    (typeof window < "u" && typeof window.requestAnimationFrame == "function" ? window.requestAnimationFrame : (A) => setTimeout(A, 16))(() => {
      const A = document.querySelector(".table-resize-overlay");
      A && Et(A, g);
    });
  }, w = (g) => {
    if (!g) return null;
  ...
  const D = _(() => {
    ...
    const g = e.getBoundingClientRect(), R = l.current.getBoundingClientRect(), A = window.visualViewport ? window.visualViewport : {
      width: window.innerWidth,
      height: window.innerHeight
    }, L = g.bottom >= 0 && g.top <= A.height && g.right >= 0 && g.left <= A.width;
    let U = "top", P = 0, B = 0;
    if (L) {
      const Q = g.top - R.height - 10, ae = A.height - g.bottom - R.height - 10;
      ae > Q && ae > 0 ? (U = "bottom", P = g.bottom + 10) : (U = "top", P = g.top - R.height - 10);
    } else
      U = "top", P = 10;
    B = g.left + g.width / 2 - R.width / 2;
    const E = window.innerWidth, H = window.innerHeight;
    let Y = Math.max(10, Math.min(B, E - R.width - 10)), Z = Math.max(10, Math.min(P, H - R.height - 10));
  ...
  hn(() => {
    ...
    return R && R.addEventListener("scroll", g), window.addEventListener("scroll", g), window.addEventListener("resize", g), () => {
      R && R.removeEventListener("scroll", g), window.removeEventListener("scroll", g), window.removeEventListener("resize", g), o(!1);
    };
  }, [e, D]), oe(() => {
    const g = (R) => {
      l.current && !l.current.contains(R.target) && R.target !== e && !e.contains(R.target) && r();
    };
  ...
  const j = {
    ...
    if (e && j[g]) {
      const R = w(e), A = b, L = j[g];
      e.style.float = L.float, e.style.margin = L.margin, e.style.marginLeft = L.marginLeft, e.style.marginRight = L.marginRight, S(g), u(e);
      const U = w(e);
      c.recordOperation(
        { type: "TABLE_ALIGN", payload: { element: e, alignment: g, state: U } },
        { type: "TABLE_ALIGN", payload: { element: e, alignment: A, state: R } }
      ), t && t(g);
    }
  }, y = {
    border: "1px solid #ccc",
...
const It = ({
  ...
  const [r, n] = re(/* @__PURE__ */ new Set()), [s, a] = re(null), [o, i] = re(null), [h, l] = re(null), [d, c] = re(!1), [u, w] = re(!1), [v, b] = re(null), [S, D] = re(null);
  Te(), ee(null);
  const j = _(() => {
  ...
  return oe(() => {
    ...
    const P = new MutationObserver((B) => {
      B.forEach((E) => {
        E.type === "childList" && S && !e.current.contains(S) && j();
      });
    });
...
const Qa = 50, ct = 50, es = 50, ts = 100, ns = 300, Dt = Tt(({
  ...
  const c = xn(), u = Te(), { pageSize: w, pageMargins: v, continuousContent: b, pageBoundaries: S, activePage: D, zoomLevel: j, canUndo: O, canRedo: y } = c, p = ee(null), g = ee(null), { currentFormat: R, formatText: A, updateCurrentFormatFromSelection: L } = kr(), [U, P] = re(!1), [B, E] = re(null), [H, Y] = re(!0), [Z, Q] = re(!1), [ae, se] = re(null), x = ee(null), {
      ...
      if (!de && x.current)
        try {
          ...
          if (Se) {
            ...
            Se.nodeType === Node.TEXT_NODE ? je.setStart(Se, Se.textContent.length) : je.setStartAfter(Se), je.collapse(!0), ie.removeAllRanges(), ie.addRange(je);
          }
        }
  ...
  const jt = _(() => {
    ...
    N < 0 || N >= S.length || (pe.current = !0, u.setActivePage(N), I(N, p), setTimeout(() => {
      pe.current = !1;
    }, ns), t && t(N));
  }, [u, I, t, S.length]), Ut = _(() => {
    const N = S.length + 1;
...
export {
  ...
  Ce as DEFAULT_IMAGE_RESIZE_OPTIONS,
