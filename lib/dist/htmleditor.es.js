import qe, { createContext as Cn, useContext as Nn, useReducer as Mn, useMemo as he, useState as de, useCallback as L, useRef as J, useEffect as se, forwardRef as ft, createElement as nt, memo as In, useLayoutEffect as Ln, useImperativeHandle as Dn } from "react";
...
const rt = 100, ot = 50, at = 200, Mt = 5, st = (e) => e < at, it = (e) => e > ot, Un = 96, De = (e) => Math.round(e * Un), Ue = {
...
}, Na = (e) => Object.keys(ve).includes(e), Ma = () => Object.keys(ve), Re = Xt, Te = "<p><br></p>", Wn = "continuous", we = (e, t = Re) => ({
  id: pt(),
  index: e,
  size: t,
  content: Te,
  images: [],
  isBreakPoint: !1
}), ze = (e) => typeof e != "string" || e.trim() === "" ? Te : e, Jt = (e, t = Re) => (e.length > 0 ? e : [we(0, t)]).map((n, s) => ({
  id: n.id || pt(),
  index: s,
  size: n.size || t,
  ...
  switch (t.type) {
    case B.INITIALIZE_DOCUMENT: {
      const { initialContent: n = Te, pageSize: s = Re } = t.payload || {}, a = { ...we(0, s), content: ze(n) };
      return ct({
        title: e.title,
        pageSize: s,
        pages: [a]
    ...
    case B.SET_EDITOR_MODE: {
      ...
      return n === "continuous" ? s = e.pages.map((i) => i.content).filter((i) => i && i !== Te).join(`
...
function Yn() {
  ...
  return Z.AsyncMode = g, Z.ConcurrentMode = f, Z.ContextConsumer = i, Z.ContextProvider = o, Z.Element = t, Z.ForwardRef = p, Z.Fragment = n, Z.Lazy = T, Z.Memo = b, Z.Portal = r, Z.Profiler = a, Z.StrictMode = s, Z.Suspense = c, Z.isAsyncMode = function(d) {
    ...
    return typeof d == "string" || typeof d == "function" || d === n || d === f || d === a || d === s || d === c || d === l || typeof d == "object" && d !== null && (d.$$typeof === T || d.$$typeof === b || d.$$typeof === o || d.$$typeof === i || d.$$typeof === p || d.$$typeof === _ || d.$$typeof === N || d.$$typeof === D || d.$$typeof === v);
  }, Z.typeOf = M, Z;
}
var Y = {};
/** @license React v16.13.1
...
function Vn() {
  return Lt || (Lt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function M(P) {
      ...
      P === n || P === f || P === a || P === s || P === c || P === l || typeof P == "object" && P !== null && (P.$$typeof === T || P.$$typeof === b || P.$$typeof === o || P.$$typeof === i || P.$$typeof === p || P.$$typeof === _ || P.$$typeof === N || P.$$typeof === D || P.$$typeof === v);
    }
    function y(P) {
    ...
    Y.AsyncMode = d, Y.ConcurrentMode = m, Y.ContextConsumer = O, Y.ContextProvider = G, Y.Element = V, Y.ForwardRef = ie, Y.Fragment = re, Y.Lazy = ne, Y.Memo = k, Y.Portal = F, Y.Profiler = te, Y.StrictMode = K, Y.Suspense = Q, Y.isAsyncMode = ae, Y.isConcurrentMode = E, Y.isContextConsumer = u, Y.isContextProvider = A, Y.isElement = R, Y.isForwardRef = S, Y.isFragment = z, Y.isLazy = H, Y.isMemo = C, Y.isPortal = j, Y.isProfiler = U, Y.isStrictMode = $, Y.isSuspense = oe, Y.isValidElementType = M, Y.typeOf = y;
  })()), Y;
}
var Dt;
function nn() {
  ...
  const [e, t] = de(Gt), r = ke(), n = L((c, l, b = null) => {
    try {
      ...
      try {
        ...
        return N.appendChild(D), v.insertNode(N), v.selectNodeContents(N), T.removeAllRanges(), T.addRange(v), t((M) => ({ ...M, [c]: l })), !0;
      } catch {
        if (b) {
          const N = c === "fontSize" ? ar[l] || "3" : l;
          return document.execCommand(b, !1, N), t((D) => ({ ...D, [c]: l })), !0;
        }
        return !1;
      }
    } catch (T) {
    ...
    try {
      ...
      if (!_)
        return !1;
      if (!T) {
        const D = b.startContainer, M = D.nodeType === Node.TEXT_NODE ? D.parentElement : D, y = Fe(M) || cr();
      ...
      if (N.length === 0) {
        ...
        D.style.textAlign = _;
        const M = b.extractContents();
        D.appendChild(M), b.insertNode(D), b.selectNodeContents(D), l.removeAllRanges(), l.addRange(b);
      } else
        N.forEach((D) => {
          D.style.textAlign = _;
        });
...
const me = 'page-break, [data-page-break="true"]', an = (e) => ve[e] || ve.A4, lr = (e, t = {}) => {
  if (!e || typeof document > "u")
    return [];
  const r = t.pageSize || "A4", n = an(r), s = e.querySelectorAll(me), a = [];
  a.push({
    id: "page-0",
    pageNumber: 1,
    top: 0,
    ...
    for (let l = 0; l < f.length && c < Wt; l++) {
      ...
      if (T && T.overflowIndex > 0) {
        ...
        if (v - g < Tr)
          continue;
        const N = l + 2;
        fr(T.overflowElement, N) && (p = !0, c++, f = qt(e));
      }
    }
    if (p) {
      if (s) {
  ...
  const c = L((m = {}) => t?.current ? lr(t.current, m) : [], [t]), l = L((m = {}) => {
    ...
    xr(T, o, m);
  }, [T]), _ = L((m) => !m?.current || !t?.current ? 0 : ur(m.current, t.current), [t]), N = L((m) => {
    ...
    N,
    T
  ) : !1, [t, c, s, l, N, T]), d = L((m) => t?.current ? mr(
    m,
    t.current,
    s.updateContinuousContent,
    l,
...
const Cr = "html-editor-storage", Nr = 1, ue = "images";
function Mr() {
...
function Ir(e) {
  return new Promise((t, r) => {
    ...
    s.onload = async (a) => {
      ...
      try {
        const f = await Oe(), p = `editor-image-${Mr()}`, l = f.transaction([ue], "readwrite").objectStore(ue), b = {
          key: p,
          dataUrl: o,
          size: g,
          type: e.type,
...
async function Lr(e) {
  try {
    ...
    return new Promise((r, n) => {
      const o = t.transaction([ue], "readonly").objectStore(ue).get(e);
      o.onsuccess = () => {
        t.close();
        const i = o.result;
        r(i ? i.dataUrl : null);
...
async function Dr(e) {
  try {
    const t = await Oe();
    return new Promise((r, n) => {
      const o = t.transaction([ue], "readwrite").objectStore(ue).delete(e);
      o.onsuccess = () => {
        t.close(), r();
      }, o.onerror = () => {
...
const na = [
  ...
  const s = tn(), { pages: a, activePage: o, continuousContent: i } = s, { wordCount: g, outline: f } = he(() => {
    if (r !== void 0 && n !== void 0)
      return {
        wordCount: r,
        outline: Yt(i, 1, "continuous-")
      };
    let c = 0;
    const l = [];
    return a.forEach((b, T) => {
      c += oa(b.content), l.push(...Yt(b.content, T + 1, `page-${T}-`));
    }), { wordCount: c, outline: l };
  }, [a, r, n, i]), p = n !== void 0 ? n : a.length;
        ...
        !e && /* @__PURE__ */ h.jsxs("div", { className: "sidebar-content", children: [
          /* @__PURE__ */ h.jsxs("div", { className: "sidebar-section", children: [
            ...
            /* @__PURE__ */ h.jsxs("div", { className: "stat-item", children: [
              ...
              /* @__PURE__ */ h.jsx("span", { className: "stat-value", children: p })
            ] }),
          ...
          f.length > 0 && /* @__PURE__ */ h.jsxs("div", { className: "sidebar-section", children: [
            /* @__PURE__ */ h.jsxs("h3", { children: [
              /* @__PURE__ */ h.jsx(gn, { size: 14, style: { display: "inline-block", marginRight: "6px", verticalAlign: "middle" } }),
              "Document Outline"
            ] }),
            /* @__PURE__ */ h.jsx("div", { className: "document-outline", "data-testid": "outline", children: f.map((c) => {
              const l = c.level === 1 ? co : c.level === 2 ? uo : po;
              return /* @__PURE__ */ h.jsxs(
                "div",
                {
...
const Ee = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && Ee(e.parentElement) : !1, yt = ({
  ...
  const c = he(() => Kt(p), [p]), l = f / 100, b = L((y, d) => {
    if (!y) return !1;
...
const Tt = ({
  ...
  const l = L((y) => {
    ...
    y.key === "Escape" && o.current && b(), o.current && !p.current && Pa(y, e, o.current, f.current);
  }, [e, b]), M = L(() => {
...
const bt = ({
  ...
  const [o, i] = de({ top: 0, left: 0 }), [g, f] = de(!1), [p, c] = de("top"), [l, b] = de(a), T = J(null), v = J(null), _ = ke(), N = (k) => {
    if (!k)
      return;
  ...
  const m = L(() => {
    ...
    if (K) {
      ...
      Q = "top", ee = 10;
    ae = k.left + k.width / 2 - F.width / 2;
    const E = window.innerWidth, u = window.innerHeight;
    let A = Math.max(10, Math.min(ae, E - F.width - 10)), R = Math.max(10, Math.min(ee, u - F.height - 10));
...
const _a = 50, tt = 50, wa = 50, Sa = 100, Ra = 300, vt = ft(({
  ...
  const c = tn(), l = ke(), { pageSize: b, pageMargins: T, continuousContent: v, pageBoundaries: _, activePage: N, zoomLevel: D, canUndo: M, canRedo: y } = c, d = J(null), m = J(null), { currentFormat: O, formatText: G, updateCurrentFormatFromSelection: V } = sr(), [ie, re] = de(!1), [ne, k] = de(null), [F, te] = de(!0), K = J(null), {
  ...
  } = Rr(b, m, D, T), z = he(() => gt(b), [b]), [H, C] = de(!1), j = J(null), U = J(!1), $ = J(!1), oe = J(!1), P = J(v);
  se(() => {
    if (m.current) {
      if (!oe.current) {
  ...
  const ye = L(() => {
    ...
    w < 0 || w >= _.length || ($.current = !0, l.setActivePage(w), ae(w, d), setTimeout(() => {
      $.current = !1;
    }, Ra), t && t(w));
  }, [l, ae, t, _.length]), _t = L(() => {
    const w = _.length + 1;
    S(w) && (U.current = !0, setTimeout(() => {
      U.current && ye();
    }, 100)), r && r();
  }, [_.length, S, l, ae, r]), Pn = L(() => {
