import Ke, { createContext as pr, useContext as gr, useReducer as hr, useMemo as ge, useState as re, useCallback as N, useRef as Q, useEffect as oe, forwardRef as kt, createElement as yt, memo as mr, useLayoutEffect as bn, useImperativeHandle as yr } from "react";
...
function Tr() {
  return Qt || (Qt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function r(f) {
      ...
      if (k) {
        k = console;
        var H = k.error, D = typeof Symbol == "function" && Symbol.toStringTag && f[Symbol.toStringTag] || f.constructor.name || "Object";
        return H.call(
          k,
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    function u(f) {
      p(f) ? f._store && (f._store.validated = 1) : typeof f == "object" && f !== null && f.$$typeof === z && (f._payload.status === "fulfilled" ? p(f._payload.value) && f._payload.value._store && (f._payload.value._store.validated = 1) : f._store && (f._store.validated = 1));
    }
    function p(f) {
      return typeof f == "object" && f !== null && f.$$typeof === y;
    }
    var b = Ke, y = Symbol.for("react.transitional.element"), T = Symbol.for("react.portal"), A = Symbol.for("react.fragment"), $ = Symbol.for("react.strict_mode"), L = Symbol.for("react.profiler"), P = Symbol.for("react.consumer"), h = Symbol.for("react.context"), g = Symbol.for("react.forward_ref"), v = Symbol.for("react.suspense"), I = Symbol.for("react.suspense_list"), R = Symbol.for("react.memo"), z = Symbol.for("react.lazy"), W = Symbol.for("react.activity"), U = Symbol.for("react.client.reference"), B = b.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, x = Object.prototype.hasOwnProperty, O = Array.isArray, C = console.createTask ? console.createTask : function() {
      return null;
    };
    b = {
    ...
    var _, Y = {}, ee = b.react_stack_bottom_frame.bind(
      b,
      o
    )(), se = C(n(o)), E = {};
    ke.Fragment = A, ke.jsx = function(f, k, H) {
...
var en;
function wr() {
  return en || (en = 1, process.env.NODE_ENV === "production" ? ze.exports = vr() : ze.exports = Tr()), ze.exports;
}
var m = wr();
const bt = 100, vt = 50, Tt = 200, tn = 5, wt = (e) => e < Tt, Et = (e) => e > vt, Er = 96, ye = (e) => Math.round(e * Er), Ze = {
  NORMAL: {
    name: "Normal",
    label: 'Normal (1")',
    top: 1,
...
}, Pa = (e) => Object.keys(Ye).includes(e), Ma = () => Object.keys(Ye), Le = wn, xe = "<p><br></p>", Rr = "continuous", _e = (e, t = Le) => ({
  id: _t(),
  index: e,
  size: t,
  content: xe,
  images: [],
  isBreakPoint: !1
}), qe = (e) => typeof e != "string" || e.trim() === "" ? xe : e, En = (e, t = Le) => (e.length > 0 ? e : [_e(0, t)]).map((n, a) => ({
  id: n.id || _t(),
  index: a,
  size: n.size || t,
  ...
  const t = (/* @__PURE__ */ new Date()).toISOString(), r = e.pageSize || Le, n = En(e.pages || [_e(0, r)], r);
  return {
    id: _t(),
  ...
  switch (t.type) {
    case Z.INITIALIZE_DOCUMENT: {
      const { initialContent: n = xe, pageSize: a = Le } = t.payload || {}, o = { ..._e(0, a), content: qe(n) };
      return xt({
        title: e.title,
        pageSize: a,
        pages: [o]
    ...
    case Z.UPDATE_PAGES: {
      const n = Array.isArray(t.payload) ? { pages: t.payload } : t.payload || {}, a = En(n.pages || [], e.pageSize), o = Array.isArray(n.pageBreaks) ? n.pageBreaks : $e(a);
      return {
        ...e,
        pages: a,
    ...
    case Z.ADD_PAGE_BREAK: {
      ...
      if (n === "end")
        ...
        if (a === 0 && d.length === 0)
          ...
          const l = d[a], c = document.createElement("page-break");
    ...
    case Z.SET_EDITOR_MODE: {
      ...
      return n === "continuous" ? a = e.pages.map((i) => i.content).filter((i) => i && i !== xe).join(`
`) || xe : e.continuousContent && e.continuousContent !== xe && (o = [{ ..._e(0, e.pageSize), content: e.continuousContent }]), {
        ...e,
        editorMode: n,
        continuousContent: a,
        pages: o,
    ...
    case Z.SET_ZOOM_LEVEL: {
      const n = t.payload;
      return n < vt || n > Tt ? (console.warn(`Invalid zoom level: ${n}. Must be between ${vt} and ${Tt}.`), e) : n === e.zoomLevel ? e : {
        ...e,
        zoomLevel: n,
        updatedAt: r
      };
    ...
    case Z.UNDO: {
      ...
      let o = e;
      return n.inverseOperation && (o = Ct(e, n.inverseOperation)), {
        ...o,
        undoStack: a,
    ...
    case Z.REDO: {
      ...
      let o = e;
      return n.operation && (o = Ct(e, n.operation)), {
        ...o,
  ...
  return /* @__PURE__ */ m.jsx(xn.Provider, { value: o, children: e });
}, Cn = () => {
  const e = gr(xn);
  if (!e)
...
function Or() {
  if (nn) return te;
  nn = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, r = e ? Symbol.for("react.portal") : 60106, n = e ? Symbol.for("react.fragment") : 60107, a = e ? Symbol.for("react.strict_mode") : 60108, o = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, i = e ? Symbol.for("react.context") : 60110, d = e ? Symbol.for("react.async_mode") : 60111, l = e ? Symbol.for("react.concurrent_mode") : 60111, c = e ? Symbol.for("react.forward_ref") : 60112, u = e ? Symbol.for("react.suspense") : 60113, p = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, y = e ? Symbol.for("react.lazy") : 60116, T = e ? Symbol.for("react.block") : 60121, A = e ? Symbol.for("react.fundamental") : 60117, $ = e ? Symbol.for("react.responder") : 60118, L = e ? Symbol.for("react.scope") : 60119;
  function P(g) {
  ...
  return te.AsyncMode = d, te.ConcurrentMode = l, te.ContextConsumer = i, te.ContextProvider = s, te.Element = t, te.ForwardRef = c, te.Fragment = n, te.Lazy = y, te.Memo = b, te.Portal = r, te.Profiler = o, te.StrictMode = a, te.Suspense = u, te.isAsyncMode = function(g) {
    return h(g) || P(g) === d;
  }, te.isConcurrentMode = h, te.isContextConsumer = function(g) {
    return P(g) === i;
    ...
    return typeof g == "string" || typeof g == "function" || g === n || g === l || g === o || g === a || g === u || g === p || typeof g == "object" && g !== null && (g.$$typeof === y || g.$$typeof === b || g.$$typeof === s || g.$$typeof === i || g.$$typeof === c || g.$$typeof === A || g.$$typeof === $ || g.$$typeof === L || g.$$typeof === T);
  }, te.typeOf = P, te;
}
var ne = {};
/** @license React v16.13.1
...
function kr() {
  return rn || (rn = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function P(j) {
      ...
      j === n || j === l || j === o || j === a || j === u || j === p || typeof j == "object" && j !== null && (j.$$typeof === y || j.$$typeof === b || j.$$typeof === s || j.$$typeof === i || j.$$typeof === c || j.$$typeof === A || j.$$typeof === $ || j.$$typeof === L || j.$$typeof === T);
    }
    function h(j) {
    ...
    var g = d, v = l, I = i, R = s, z = t, W = c, U = n, B = y, x = b, O = r, C = o, _ = a, Y = u, ee = !1;
    function se(j) {
      return ee || (ee = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), E(j) || h(j) === d;
    }
    function E(j) {
      return h(j) === l;
    }
    ...
    ne.AsyncMode = g, ne.ConcurrentMode = v, ne.ContextConsumer = I, ne.ContextProvider = R, ne.Element = z, ne.ForwardRef = W, ne.Fragment = U, ne.Lazy = B, ne.Memo = x, ne.Portal = O, ne.Profiler = C, ne.StrictMode = _, ne.Suspense = Y, ne.isAsyncMode = se, ne.isConcurrentMode = E, ne.isContextConsumer = f, ne.isContextProvider = k, ne.isElement = H, ne.isForwardRef = D, ne.isFragment = q, ne.isLazy = G, ne.isMemo = M, ne.isPortal = V, ne.isProfiler = J, ne.isStrictMode = X, ne.isSuspense = ie, ne.isValidElementType = P, ne.typeOf = h;
  })()), ne;
}
var on;
function Rn() {
  return on || (on = 1, process.env.NODE_ENV === "production" ? Ue.exports = Or() : Ue.exports = kr()), Ue.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function _r() {
  ...
  function a() {
    try {
      ...
      var d = Object.getOwnPropertyNames(s).map(function(c) {
        return s[c];
      });
  ...
  return lt = a() ? Object.assign : function(o, s) {
    for (var i, d = n(o), l, c = 1; c < arguments.length; c++) {
...
function Nr() {
  ...
  if (process.env.NODE_ENV !== "production") {
    var t = /* @__PURE__ */ Nt(), r = {}, n = /* @__PURE__ */ Sn();
    e = function(o) {
      var s = "Warning: " + o;
        ...
        if (n(o, c)) {
          ...
          try {
            if (typeof o[c] != "function") {
              var p = Error(
                (d || "React class") + ": " + i + " type `" + c + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof o[c] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`."
              );
              throw p.name = "Invariant Violation", p;
            }
            u = o[c](s, c, d, i, null, t);
          } catch (y) {
            u = y;
          }
          if (u && !(u instanceof Error) && e(
            (d || "React class") + ": type specification of " + i + " `" + c + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + typeof u + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."
          ), u instanceof Error && !(u.message in r)) {
            r[u.message] = !0;
            var b = l ? l() : "";
            e(
              "Failed " + i + " type: " + u.message + (b ?? "")
            );
          }
        }
    }
...
function Pr() {
  if (un) return pt;
  un = 1;
  var e = Rn(), t = _r(), r = /* @__PURE__ */ Nt(), n = /* @__PURE__ */ Sn(), a = /* @__PURE__ */ Nr(), o = function() {
  };
  ...
  return pt = function(i, d) {
    ...
    function A(E) {
      ...
      function H(q, G, M, V, J, X, ie) {
        ...
        return G[M] == null ? q ? G[M] === null ? new T("The " + J + " `" + X + "` is marked as required " + ("in `" + V + "`, but its value is `null`.")) : new T("The " + J + " `" + X + "` is marked as required in " + ("`" + V + "`, but its value is `undefined`.")) : null : E(G, M, V, J, X);
      }
      var D = H.bind(null, !1);
      return D.isRequired = H.bind(null, !0), D;
    }
    function $(E) {
      function f(k, H, D, q, G, M) {
        var V = k[H], J = _(V);
        if (J !== E) {
          var X = Y(V);
          return new T(
    ...
    function P(E) {
      function f(k, H, D, q, G) {
        if (typeof E != "function")
          return new T("Property `" + G + "` of component `" + D + "` has invalid PropType notation inside arrayOf.");
        var M = k[H];
        if (!Array.isArray(M)) {
          var V = _(M);
          return new T("Invalid " + q + " `" + G + "` of type " + ("`" + V + "` supplied to `" + D + "`, expected an array."));
        }
    ...
    function h() {
      function E(f, k, H, D, q) {
        var G = f[k];
        if (!i(G)) {
          var M = _(G);
          return new T("Invalid " + D + " `" + q + "` of type " + ("`" + M + "` supplied to `" + H + "`, expected a single ReactElement."));
        }
        return null;
      }
      return A(E);
    ...
    function g() {
      function E(f, k, H, D, q) {
        ...
        if (!e.isValidElementType(G)) {
          var M = _(G);
          return new T("Invalid " + D + " `" + q + "` of type " + ("`" + M + "` supplied to `" + H + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return A(E);
    ...
    function v(E) {
      function f(k, H, D, q, G) {
        if (!(k[H] instanceof E)) {
          var M = E.name || p, V = se(k[H]);
          return new T("Invalid " + q + " `" + G + "` of type " + ("`" + V + "` supplied to `" + D + "`, expected ") + ("instance of `" + M + "`."));
        }
        return null;
      }
      return A(f);
    ...
    function I(E) {
      ...
      function f(k, H, D, q, G) {
        ...
        return new T("Invalid " + q + " `" + G + "` of value `" + String(M) + "` " + ("supplied to `" + D + "`, expected one of " + J + "."));
      }
      return A(f);
    }
    function R(E) {
      function f(k, H, D, q, G) {
        if (typeof E != "function")
          return new T("Property `" + G + "` of component `" + D + "` has invalid PropType notation inside objectOf.");
        var M = k[H], V = _(M);
        if (V !== "object")
          return new T("Invalid " + q + " `" + G + "` of type " + ("`" + V + "` supplied to `" + D + "`, expected an object."));
        for (var J in M)
          if (n(M, J)) {
            var X = E(M, J, D, q, G + "." + J, r);
            if (X instanceof Error)
    ...
    function z(E) {
      ...
      for (var f = 0; f < E.length; f++) {
        ...
        if (typeof k != "function")
          return o(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ee(k) + " at index " + f + "."
          ), s;
      }
      function H(D, q, G, M, V) {
        ...
        return new T("Invalid " + M + " `" + V + "` supplied to " + ("`" + G + "`" + ue + "."));
      }
      return A(H);
    }
    function W() {
      function E(f, k, H, D, q) {
        return O(f[k]) ? null : new T("Invalid " + D + " `" + q + "` supplied to " + ("`" + H + "`, expected a ReactNode."));
      }
      return A(E);
    }
    function U(E, f, k, H, D) {
      return new T(
        (E || "React class") + ": " + f + " type `" + k + "." + H + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + D + "`."
      );
    }
    function B(E) {
      function f(k, H, D, q, G) {
        var M = k[H], V = _(M);
        if (V !== "object")
          return new T("Invalid " + q + " `" + G + "` of type `" + V + "` " + ("supplied to `" + D + "`, expected `object`."));
        for (var J in E) {
          var X = E[J];
...
function Lr() {
  ...
  if (fn = 1, process.env.NODE_ENV !== "production") {
    var e = Rn(), t = !0;
    Fe.exports = /* @__PURE__ */ Pr()(e.isElement, t);
  } else
    Fe.exports = /* @__PURE__ */ Mr()();
  return Fe.exports;
}
var Ir = /* @__PURE__ */ Lr();
const w = /* @__PURE__ */ br(Ir), On = {
  ...
  // 72 pt ≈ 96 px
], Xe = "16px", Dr = (e) => Math.round(e * 96 / 72), jr = (e) => Math.round(e * 72 / 96 * 2) / 2, Ia = (e) => {
  ...
  const [e, t] = re(pn), r = Te(), n = N((b, y, T = null) => {
    try {
      ...
      try {
        ...
        return P.appendChild(h), $.insertNode(P), $.selectNodeContents(P), A.removeAllRanges(), A.addRange($), t((g) => ({ ...g, [b]: y })), !0;
      } catch {
        if (T) {
          const P = b === "fontSize" ? Br[y] || "3" : y;
          return document.execCommand(T, !1, P), t((h) => ({ ...h, [b]: y })), !0;
        }
        return !1;
      }
    } catch (A) {
      return console.warn(`[useFormatting] Style application failed for ${b}:`, A), !1;
    }
  }, []), a = N((b) => n("fontFamily", b, "fontName"), [n]), o = N((b) => n("fontSize", b, "fontSize"), [n]), s = N((b) => n("color", b, "foreColor"), [n]), i = N((b) => {
    t((y) => ({
      ...y,
      alignLeft: b === "left",
    ...
    try {
      ...
      if (!y || y.rangeCount === 0)
        return !1;
      const T = y.getRangeAt(0), A = T.toString(), L = {
        justifyLeft: "left",
      ...
      if (!L)
        return !1;
      if (!A) {
        const h = T.startContainer, g = h.nodeType === Node.TEXT_NODE ? h.parentElement : h, v = Ne(g) || Ur();
        return v && (v.style.textAlign = L, i(L)), !0;
      }
      const P = Fr(T);
      if (P.length === 0) {
        const h = document.createElement("p");
        h.style.textAlign = L;
        const g = T.extractContents();
        h.appendChild(g), T.insertNode(h), T.selectNodeContents(h), y.removeAllRanges(), y.addRange(T);
      } else
        P.forEach((h) => {
          h.style.textAlign = L;
        });
    ...
    try {
      ...
      if (!y || y.rangeCount === 0)
        return !1;
      const T = y.getRangeAt(0), A = document.createElement("div");
      if (A.innerHTML = b, Array.from(A.children).some(
        (L) => ["TABLE", "UL", "OL", "BLOCKQUOTE", "PRE", "DIV", "H1", "H2", "H3", "H4", "H5", "H6"].includes(L.tagName)
      )) {
        const L = T.startContainer, P = L.nodeType === Node.TEXT_NODE ? L.parentElement : L, h = Ne(P);
        if (h && ["P", "H1", "H2", "H3", "H4", "H5", "H6"].includes(h.tagName)) {
          const g = h.tagName.toLowerCase();
          if (T.startOffset === 0 && (L === h || L.nodeType === Node.TEXT_NODE && L === h.firstChild))
            h.parentNode.insertBefore(A, h);
          else if (T.startOffset === L.textContent?.length && L === h.lastChild && T.endOffset === L.textContent?.length) {
            const R = h.nextSibling;
            R ? h.parentNode.insertBefore(A, R) : h.parentNode.appendChild(A);
          } else {
            const R = T.extractContents(), z = document.createTextNode(""), W = document.createElement(g);
            W.appendChild(z), W.appendChild(R);
            const U = h.parentNode;
            U.insertBefore(A, h.nextSibling), U.insertBefore(W, A.nextSibling), !h.textContent.trim() && h.children.length === 0 && U.removeChild(h);
          }
        } else
          T.insertNode(A);
        T.setStartAfter(A), T.setEndAfter(A), y.removeAllRanges(), y.addRange(T);
      } else
      ...
      try {
        return document.execCommand("insertHTML", !1, b), !0;
      } catch (T) {
    ...
    try {
      ...
      switch (document.execCommand(b, !1, y) || console.warn(`[useFormatting] Command "${b}" failed`), b) {
        case "bold":
        case "italic":
        case "underline":
        case "strikethrough":
      ...
      console.warn(`[useFormatting] Error executing command "${b}":`, T);
    }
  }, [o, a, d, l, r]), u = N(() => {
    try {
      ...
      if (!b || b.rangeCount === 0)
        return;
      const y = b.getRangeAt(0), T = y.toString();
      let A = Xe, $ = "Arial", L = "#000000", P = "p", h = "left";
      if (T) {
        const v = y.startContainer, I = v.nodeType === Node.TEXT_NODE ? v.parentElement : v;
        if (I) {
          const R = window.getComputedStyle(I), z = R.fontSize, W = R.fontFamily;
          z && z.endsWith("px") && (A = z), W && W !== "serif" && ($ = W.split(",")[0].replace(/['"]/g, "").trim());
          const U = R.color;
...
const ve = 'page-break, [data-page-break="true"]', Wr = (e, t = {}) => {
  if (!e || typeof document > "u")
    return [];
  const r = t.pageSize || "A4", n = Me(r), a = e.querySelectorAll(ve), o = [];
  o.push({
    id: "page-0",
    pageNumber: 1,
    top: 0,
  ...
  const n = Me(e), a = xr(r), o = n.height - a, s = t / 100;
  return o / s;
}, qr = (e, t) => {
  if (!e || !t)
    return 0;
  ...
  if (!e)
    return !1;
  try {
    const d = kn(r, n, a) * (t - 1), l = Array.from(e.children);
    let c = 0, u = null;
    ...
    if (u) {
      ...
      if (b.innerHTML = "<br>", e.appendChild(b), o) {
        const y = e.innerHTML;
        o(y);
      }
      return s && setTimeout(() => {
  ...
  try {
    const d = Array.from(e.querySelectorAll(ve));
    if (t > d.length)
    ...
    if (p && p.parentNode && p.remove(), u.forEach((y) => {
      y.parentNode && y.remove();
    }), e.querySelectorAll(ve).forEach((y, T) => {
      y.setAttribute("data-page-number", String(T + 2));
    }), c && o && setTimeout(() => {
      o(0);
    }, 50), n) {
      const y = e.innerHTML;
  ...
  try {
    ...
    const d = kn(t, r, n);
    let l = gn(e), c = !1, u = 0;
    for (let p = 0; p < l.length && u < hn; p++) {
      const b = l[p], y = to(b, d);
      if (y && y.overflowIndex > 0) {
        let T = 0;
        for (let P = 0; P < b.length; P++) {
          const h = b[P];
          h && h.getBoundingClientRect && (T += _n(h));
        }
        if (T - d < eo)
          continue;
        const $ = p + 2;
        Zr(y.overflowElement, $) && (c = !0, u++, l = gn(e));
      }
    }
    if (c) {
      if (a) {
  ...
  const i = o.toString().replace(/<[^>]*>/g, " ").replace(/&nbsp;/g, " ").replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&quot;/g, '"').replace(/&#39;/g, "'").replace(/\s+/g, " ").trim(), d = i.length, l = (i.match(/\n/g) || []).length + 1;
  return {
    page: n,
    line: l,
    charOffset: d
  ...
  const a = Te(), o = Q(null), s = Q(null), i = Q(e), d = Q(r), l = Q(n), c = Q(!1);
  oe(() => {
    i.current = e;
  }, [e]), oe(() => {
    d.current = r;
  ...
  const u = N((v = {}) => t?.current ? Wr(t.current, v) : [], [t]), p = N((v = {}) => {
    const I = u(v);
    return a.updatePageBoundaries(I), I;
  }, [u, a]), b = N((v = {}) => {
    const I = typeof v.delay == "number" ? v.delay : co;
    ao(p, o, v, I);
  }, [p]), y = N(() => {
    t?.current && no(
      t.current,
    ...
    ro(y, s, v);
  }, [y]), A = N((v) => !v?.current || !t?.current ? 0 : qr(v.current, t.current), [t]), $ = N((v) => {
    t?.current && Nn(t.current, v);
  }, [t]), L = N((v, I) => {
    if (!I?.current || !t?.current) {
      console.warn("[scrollToPage] Missing refs");
      return;
    }
    so(I.current, t.current, v, $);
  }, [t, $]), P = N(async (v) => t?.current ? Yr(
    t.current,
    v,
    i.current,
    d.current,
    ...
    $,
    y
  ) : !1, [t, u, a, p, $, y]), g = N((v) => t?.current ? Xr(
    v,
    t.current,
    a.updateContinuousContent,
    p,
  ...
  oe(() => {
    const l = (c) => {
      if (c.ctrlKey || c.metaKey) {
        ["+", "=", "-", "_", "0", "z", "y"].includes(c.key) && c.preventDefault();
        const u = document.activeElement === i.current, p = document.activeElement === d.current, b = document.activeElement?.tagName === "INPUT" || document.activeElement?.tagName === "TEXTAREA" || document.activeElement?.isContentEditable === !1;
        if (u || p || !b)
          switch (c.key) {
            case "+":
            case "=":
...
function ja({
  ...
  switch (e) {
    case F.TOP_LEFT:
      c = Math.max(i.minWidth, o - d), u = Math.max(i.minHeight, s - l);
      break;
    case F.TOP_RIGHT:
      c = Math.max(i.minWidth, o + d), u = Math.max(i.minHeight, s - l);
      break;
  ...
  if (i.preserveAspectRatio && i.aspectRatio) {
    ...
    [
      ...
      F.BOTTOM_LEFT,
      F.BOTTOM_RIGHT
    ].includes(e) ? c / p > u ? u = Math.max(i.minHeight, c / p) : c = Math.max(i.minWidth, u * p) : [F.TOP, F.BOTTOM].includes(e) ? c = u * p : [F.LEFT, F.RIGHT].includes(e) && (u = c / p);
  }
...
function bo(e) {
  return new Promise((t, r) => {
    ...
    a.onload = async (o) => {
      ...
      try {
        const l = await Ie(), c = `editor-image-${yo()}`, p = l.transaction([de], "readwrite").objectStore(de), b = {
          key: c,
          dataUrl: s,
          size: d,
          type: e.type,
...
function Pe(e) {
  ...
  for (let n = 0; n < r.length; n++) {
    ...
    if (a.nodeType === Node.TEXT_NODE) {
      ...
      const o = a, s = o.tagName, i = s.toLowerCase(), d = Ln(o);
      if (s === "DIV") {
        const l = Pe(o);
        ...
        const l = Pe(o);
        t.push(`<blockquote${d}>${l}</blockquote>`);
      } else if (s === "PRE")
        t.push(o.outerHTML);
...
const Ys = [
  ...
  const a = An(), { pages: o, activePage: s, continuousContent: i } = a, { wordCount: d, outline: l } = ge(() => {
    ...
    return o.forEach((b, y) => {
      u += Ks(b.content), p.push(...yn(b.content, y + 1, `page-${y}-`));
        ...
        /* @__PURE__ */ m.jsxs("div", { className: "sidebar-header", children: [
          ...
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              children: e ? /* @__PURE__ */ m.jsx(Zo, { size: 16 }) : /* @__PURE__ */ m.jsx(qo, { size: 16 })
            }
          )
        ] }),
        !e && /* @__PURE__ */ m.jsxs("div", { className: "sidebar-content", children: [
          /* @__PURE__ */ m.jsxs("div", { className: "sidebar-section", children: [
            ...
            /* @__PURE__ */ m.jsxs("div", { className: "stat-item", "data-testid": "word-count", children: [
              /* @__PURE__ */ m.jsxs("div", { className: "stat-label", children: [
                /* @__PURE__ */ m.jsx(Jo, { size: 14 }),
                /* @__PURE__ */ m.jsx("span", { children: "Words:" })
              ] }),
              /* @__PURE__ */ m.jsx("span", { className: "stat-value", children: d.toLocaleString() })
            ] }),
            /* @__PURE__ */ m.jsxs("div", { className: "stat-item", children: [
              /* @__PURE__ */ m.jsxs("div", { className: "stat-label", children: [
          ...
          l.length > 0 && /* @__PURE__ */ m.jsxs("div", { className: "sidebar-section", children: [
            /* @__PURE__ */ m.jsxs("h3", { children: [
              /* @__PURE__ */ m.jsx(Hn, { size: 14, style: { display: "inline-block", marginRight: "6px", verticalAlign: "middle" } }),
              "Document Outline"
            ] }),
            /* @__PURE__ */ m.jsx("div", { className: "document-outline", "data-testid": "outline", children: l.map((u) => {
              const p = u.level === 1 ? es : u.level === 2 ? ns : os;
              return /* @__PURE__ */ m.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ m.jsx(p, { size: 12, className: "outline-icon" }),
...
const we = new Js("Editor"), Dn = /* @__PURE__ */ new Set(["P", "DIV", "H1", "H2", "H3", "H4", "H5", "H6", "LI", "BLOCKQUOTE", "PRE", "TABLE"]), jn = 32;
function Bn(e, t) {
  if (!e) return;
...
function ta() {
  ...
  return n ? (n.querySelectorAll("p, div, h1, h2, h3, h4, h5, h6, li, blockquote, pre, table").forEach((s) => {
    ...
    if (document.createRange().selectNode(i), t.intersectsNode(i)) {
      ...
      for (; l && l !== n; ) {
        if (l.tagName && Dn.has(l.tagName.toUpperCase())) {
          r.add(l);
          break;
        }
        l = l.parentElement;
...
function ra(e) {
  ...
  return r && r.rangeCount > 0 && n && !n.collapsed && St(t) || t || document.execCommand("insertHTML", !1, "&nbsp;&nbsp;&nbsp;&nbsp;"), !0;
}
  ...
  return /* @__PURE__ */ m.jsxs("div", { className: "color-picker-dropdown", ref: o, children: [
    /* @__PURE__ */ m.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ m.jsx(ws, { size: 14, style: { color: e === "#FFFFFF" ? "#000" : "#FFF" } })
      }
    ),
...
const oa = [
...
], aa = '<table border="1"><tr><th>Header 1</th><th>Header 2</th></tr><tr><td>Cell 3</td><td>Cell 4</td></tr></table>', It = ({
  currentFormat: e,
  onFormatText: t,
  onAddPageBreak: r,
  onInsertImage: n,
  ...
  const s = async (c) => {
    try {
      ...
      we.info("Starting image upload", { fileName: c.name, fileSize: c.size });
      const p = await bo(c);
      we.info("Image saved to IndexedDB", { key: p });
      const b = await vo(p);
      if (we.info("Image retrieved from IndexedDB", { key: p, hasUrl: !!b }), b && n) {
        const T = `<img src="${b}" data-key="${p}" alt="Inserted image" />`;
        we.info("Calling onInsertImage with HTML", { imageHtml: T.substring(0, 100) }), n(T), we.info("Image inserted", { key: p });
      } else
        we.warn("Image not inserted: missing imageUrl or onInsertImage callback", {
          hasUrl: !!b,
          hasCallback: !!n
        });
      const y = document.getElementById("image-upload");
      y && (y.value = "");
    } catch (u) {
      we.error("Error uploading image", u);
    }
  }, i = (c, u, p, b) => /* @__PURE__ */ m.jsx(
    "button",
    {
      onClick: () => t(c),
      className: e[u] ? "active" : "",
      title: b,
      children: /* @__PURE__ */ m.jsx(p, { size: 16 })
    },
    c
  ), d = (c, u, p, b = !1) => /* @__PURE__ */ m.jsx(
    "button",
    {
      onClick: c,
      disabled: b,
  ...
  return /* @__PURE__ */ m.jsxs("div", { className: "editor-toolbar", children: [
    ...
    l(),
    i("bold", "bold", Uo, "Bold"),
    i("italic", "italic", us, "Italic"),
    i("underline", "underline", $s, "Underline"),
    i("strikethrough", "strikethrough", Ns, "Strikethrough"),
    l(),
    i("justifyLeft", "alignLeft", Lt, "Align Left"),
    i("justifyCenter", "alignCenter", Pt, "Align Center"),
    i("justifyRight", "alignRight", Mt, "Align Right"),
    i("justifyFull", "alignJustify", Ds, "Justify"),
    l(),
    /* @__PURE__ */ m.jsx(
      "select",
      {
        ...
        title: "Font Family",
        children: oa.map(({ value: c, label: u }) => /* @__PURE__ */ m.jsx("option", { value: c, children: u }, c))
      }
    ),
    /* @__PURE__ */ m.jsx(
      "select",
    ...
    /* @__PURE__ */ m.jsx(
      "select",
      {
        ...
        title: "Heading Level",
        children: sa.map(({ value: c, label: u }) => /* @__PURE__ */ m.jsx("option", { value: c, children: u }, c))
      }
    ),
    l(),
    d(() => t("insertUnorderedList"), Hn, "Bullet List"),
    d(() => t("insertOrderedList"), bs, "Numbered List"),
    l(),
    /* @__PURE__ */ m.jsx(
      "button",
      {
        onClick: () => {
          St(!1) || document.execCommand("insertHTML", !1, "&nbsp;&nbsp;&nbsp;&nbsp;");
        },
        title: "Increase Indent (Tab)",
        children: /* @__PURE__ */ m.jsx(ms, { size: 16 })
      }
    ),
    /* @__PURE__ */ m.jsx(
      "button",
    ...
    d(() => t("insertHTML", aa), Ms, "Insert Table"),
    r && d(r, Ve, "Insert Page Break"),
    l(),
    /* @__PURE__ */ m.jsx(
      "input",
      {
...
const Ee = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && Ee(e.parentElement) : !1, Ht = ({
  dimensions: e,
  editorRef: t,
  onInput: r,
  onContentChange: n,
  ...
  const u = ge(() => Tn(c), [c]), p = l / 100, b = N((h, g) => {
    if (!h) return !1;
    const v = h.getBoundingClientRect(), I = g - v.top;
    return I < u.top || I > v.height - u.bottom;
  }, [u.top, u.bottom]), y = N((h, g) => {
    g.preventDefault();
    const v = h.getBoundingClientRect(), I = g.clientX - v.left, R = g.clientY - v.top, z = v.width - 40, W = -12, U = v.width - 20;
    I >= z && I <= U && R >= W && R <= 8 && d && d(h);
  }, [d]), T = N((h) => {
    h.preventDefault();
    const g = t.current.getBoundingClientRect();
    if (h.clientY - g.top < u.top) {
      const I = t.current.firstElementChild;
      if (I && I.tagName !== "PAGE-BREAK") {
        const R = document.createRange(), z = window.getSelection();
        R.setStart(I, 0), R.collapse(!0), z.removeAllRanges(), z.addRange(R);
      }
    } else {
      const I = t.current.lastElementChild;
      if (I && I.tagName !== "PAGE-BREAK") {
        const R = document.createRange(), z = window.getSelection();
        R.selectNodeContents(I), R.collapse(!1), z.removeAllRanges(), z.addRange(R);
      }
    }
  }, [t, u.top]), A = N((h) => {
    const g = window.getSelection();
    if (!g || g.rangeCount === 0) return;
    const v = g.getRangeAt(0), { startContainer: I, endContainer: R } = v;
    if ((Ee(I) || Ee(R)) && (h.key.length === 1 || h.key === "Enter" || h.key === " "))
      return h.preventDefault(), !1;
    if (ra(h))
      return n && n(), !1;
    if ((h.key === "Backspace" || h.key === "Delete") && (Ee(I) || Ee(R)))
      return h.preventDefault(), !1;
    a && a(h);
  }, [a, n]), $ = N((h) => {
    if (!t.current) return;
    ...
    const g = window.getSelection();
    if (!g || g.rangeCount === 0) return;
    const v = g.getRangeAt(0), { startContainer: I } = v;
    if (Ee(I))
      return h.preventDefault(), !1;
  }, []), P = N((h) => {
    const g = ca(h);
...
const da = mr(Ht), Dt = ({
  ...
  const T = Math.max(e?.length || 0, 1), A = (g) => {
    i && i(g);
  }, $ = () => {
    d && d();
  }, L = (g) => {
  ...
  return /* @__PURE__ */ m.jsxs("div", { className: "page-manager", children: [
    /* @__PURE__ */ m.jsxs("div", { className: "page-settings-group", children: [
      /* @__PURE__ */ m.jsxs("div", { className: "page-settings-header", children: [
        /* @__PURE__ */ m.jsx(ks, { size: 14, style: { marginRight: "4px", verticalAlign: "middle" } }),
        "Page Settings"
      ] }),
        ...
        /* @__PURE__ */ m.jsxs("div", { className: "page-setting-item", children: [
          ...
          /* @__PURE__ */ m.jsx(
            "select",
            {
              ...
              children: Cr().map((g) => /* @__PURE__ */ m.jsx("option", { value: g, children: Ar(g) }, g))
            }
          )
        ] })
      ] })
    ...
    /* @__PURE__ */ m.jsxs("div", { className: "zoom-controls-compact", children: [
      /* @__PURE__ */ m.jsx(
        "button",
        {
          ...
          "aria-label": "Zoom out",
          title: "Zoom out (Ctrl + -)",
          children: /* @__PURE__ */ m.jsx(Vs, { size: 12 })
        }
      ),
    ...
    /* @__PURE__ */ m.jsx("div", { className: "page-list", children: e.map((g, v) => /* @__PURE__ */ m.jsxs("div", { className: "page-item", children: [
      /* @__PURE__ */ m.jsxs(
        "button",
        {
          type: "button",
      ...
      T > 1 && /* @__PURE__ */ m.jsx(
        "button",
        {
          ...
          onClick: (I) => {
            I.stopPropagation(), L(v);
          },
          "aria-label": `Delete page ${v + 1}`,
          title: "Delete this page and its content",
          children: /* @__PURE__ */ m.jsx(qs, { size: 14 })
        }
      )
    ] }, g.id || `page-${v}`)) }),
    /* @__PURE__ */ m.jsxs(
...
function ma(e, t, r, n) {
  const { ctrlKey: a, metaKey: o, shiftKey: s, key: i } = e, d = a || o, l = r.offsetWidth, c = r.offsetHeight, p = {
    // Increase width
    ">": d && s ? () => ({
    ...
    // Reset to default
    r: d && !s ? () => ({ width: 300, height: 200 }) : null
  }[i];
  if (p) {
    e.preventDefault();
    const b = p();
...
const jt = ({
  ...
  const o = Q(null), s = Q(null), i = Q(null), d = Q(null), l = Q(a), c = Q(!1), u = Te();
  oe(() => {
    l.current = a;
  }, [a]);
  const p = N((h) => {
    ...
    const g = po(h, l.current);
    g && (o.current = g, s.current = h, document.body.appendChild(g), g.querySelectorAll(".resize-handler").forEach((I) => {
      I.addEventListener("mousedown", y);
    }), r && r(h));
  }, [r]), b = N(() => {
    s.current && (s.current.classList.remove("selected"), s.current = null), o.current && (ht(o.current), o.current = null), i.current = null, d.current = null, c.current = !1, n && n();
  }, [n]), y = N((h) => {
    if (h.preventDefault(), h.stopPropagation(), !s.current) return;
    const g = h.currentTarget.dataset.handler, v = s.current.getBoundingClientRect(), I = window.pageYOffset || document.documentElement.scrollTop, R = window.pageXOffset || document.documentElement.scrollLeft;
    i.current = {
      x: h.clientX,
      y: h.clientY,
      ...
      offsetX: h.clientX - v.left - R,
      offsetY: h.clientY - v.top - I
    }, d.current = g, c.current = !0, document.body.classList.add("resize-in-progress"), document.body.style.cursor = pa(g), document.addEventListener("mousemove", T), document.addEventListener("mouseup", A);
  }, []), T = N((h) => {
    if (!c.current || !s.current || !i.current || !d.current) return;
    h.preventDefault(), h.stopPropagation();
    const { x: g, y: v, width: I, height: R } = i.current, z = d.current, W = h.clientX, U = h.clientY, B = ga({
      handler: z,
      startX: g,
      startY: v,
      currentX: W,
    ...
    $n(s.current, B), o.current && At(o.current, s.current);
  }, []), A = N((h) => {
    if (c.current) {
      if (h.preventDefault(), h.stopPropagation(), s.current && i.current) {
        ...
        (g.width !== v.width || g.height !== v.height) && u.recordOperation(
          { type: "IMAGE_RESIZE", payload: { element: s.current, state: v } },
          { type: "IMAGE_RESIZE", payload: { element: s.current, state: g } }
        );
      }
      if (i.current = null, d.current = null, c.current = !1, document.removeEventListener("mousemove", T), document.removeEventListener("mouseup", A), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = "", s.current) {
    ...
    o.current && !o.current.contains(h.target) && b();
    const g = h.target;
    if (be(g)) {
      if (g === s.current)
        return;
    ...
    if ((h.key === "Delete" || h.key === "Backspace") && s.current && !c.current) {
      ...
      const g = s.current;
      if (g.parentNode) {
        g.parentNode.removeChild(g), b();
        const v = new Event("input", { bubbles: !0, cancelable: !0 });
        e.current.dispatchEvent(v);
      }
    }
    h.key === "Escape" && s.current && b(), s.current && !c.current && ma(h, e, s.current, l.current);
  }, [e, b]), P = N(() => {
  ...
  return oe(() => {
    ...
    return g && (g.addEventListener("scroll", P), window.addEventListener("scroll", P)), () => {
      g && g.removeEventListener("scroll", P), window.removeEventListener("scroll", P);
    };
  }, [e, P]), oe(() => {
    if (!e.current) return;
    const h = e.current;
    return h.addEventListener("click", $), h.addEventListener("keydown", L), window.addEventListener("resize", P), () => {
      h.removeEventListener("click", $), h.removeEventListener("keydown", L), window.removeEventListener("resize", P), c.current && (document.removeEventListener("mousemove", T), document.removeEventListener("mouseup", A), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = ""), o.current && ht(o.current);
    };
  }, [e, $, L, P, T, A]), oe(() => {
    if (!e.current) return;
    const h = new MutationObserver((g) => {
      g.forEach((v) => {
        v.type === "childList" && (v.removedNodes.forEach((I) => {
          I.nodeType === Node.ELEMENT_NODE && be(I) && I === s.current && b();
          ...
          R.length > 0 && setTimeout(() => p(R[0]), 50);
        }));
      });
    });
...
const Bt = ({
  ...
  const [s, i] = re({ top: 0, left: 0 }), [d, l] = re(!1), [c, u] = re("top"), [p, b] = re(o), y = Q(null), T = Q(null), A = Te(), $ = (x) => {
    if (!x)
      return;
  ...
  const v = N(() => {
    ...
    const x = e.getBoundingClientRect(), O = y.current.getBoundingClientRect(), C = window.visualViewport ? window.visualViewport : {
    ...
    let k = Math.max(10, Math.min(se, E - O.width - 10)), H = Math.max(10, Math.min(ee, f - O.height - 10));
    i({ top: H, left: k }), u(Y), l(!0);
  }, [e]);
  bn(() => {
    v();
    const x = () => {
    ...
    const x = (O) => {
      y.current && !y.current.contains(O.target) && O.target !== e && a();
    };
  ...
  const I = {
    ...
    if (e && I[x]) {
      const O = L(e), C = h, _ = I[x];
      e.style.float = _.float, e.style.margin = _.margin, e.style.display = _.display, g(x), $(e);
      const Y = L(e);
      A.recordOperation(
        ...
        children: [
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              children: p ? /* @__PURE__ */ m.jsx(Ss, { size: 14 }) : /* @__PURE__ */ m.jsx(as, { size: 14 })
            }
          ),
          /* @__PURE__ */ m.jsx(
            "button",
...
function fe(e) {
  ...
  if (s.length >= n)
    for (let d = 0; d < n; d++) {
      const l = s[d], c = l.style.width ? parseInt(l.style.width, 10) : l.offsetWidth;
      a.push(c || 100);
    }
  else if (r.length > 0) {
    const d = r[0];
    for (let l = 0; l < d.cells.length; l++) {
      const c = d.cells[l];
...
function ya({
  ...
  const o = {
    ...
    d >= 0 && d < i.length && (i[d] = Math.max(c, Math.min(u, i[d] + l)));
  };
  switch (e) {
    case ce.COLUMN:
...
function Ce(e, t, r) {
  if (!le(e)) return;
  me(e);
  const { columnWidths: n, rowHeights: a, tableWidth: o, tableHeight: s } = t, i = n ? n.reduce((l, c) => l + c, 0) : 0, d = a ? a.reduce((l, c) => l + c, 0) : 0;
  if (o !== void 0 ? e.style.width = `${o}px` : i > 0 && (e.style.width = `${i}px`), s !== void 0 ? e.style.height = `${s}px` : d > 0 && (e.style.height = `${d}px`), n && n.length > 0) {
    e.style.tableLayout = "fixed";
    const l = e.querySelector("colgroup");
    l && l.querySelectorAll("col").forEach((u, p) => {
      p < n.length && (u.style.width = `${n[p]}px`);
    }), e.style.width = `${i}px`;
  }
...
function Gn(e, t, r, n, a) {
  if (a && a.rows.length > 0) {
    const s = a.rows[0];
    if (s.cells.length > t) {
      const d = s.cells[t].getBoundingClientRect(), l = a.getBoundingClientRect(), c = d.right - l.left - 2;
...
function Zn(e, t, r, n, a) {
  if (a && a.rows.length > t) {
    const s = a.rows[t];
    if (s.cells.length > 0) {
      const d = s.cells[0].getBoundingClientRect(), l = a.getBoundingClientRect(), c = d.bottom - l.top - 2;
...
const zt = ({
  ...
  const o = Q(null), s = Q(null), i = Q(null), d = Q(null), l = Q(null), c = Q(a), u = Q(!1), [p, b] = re(null), y = Te();
  oe(() => {
    c.current = a;
  }, [a]);
  const T = N(() => {
    s.current && (s.current.classList.remove("selected"), s.current = null), o.current && (We(o.current), o.current = null), b(null), i.current = null, d.current = null, l.current = null, u.current = !1, n && n();
  }, [n]), A = N((R) => {
    if (R.preventDefault(), R.stopPropagation(), !s.current) return;
    const z = R.currentTarget, W = z.dataset.type, U = parseInt(z.dataset.index, 10);
    ...
    i.current = {
      ...
      y: R.clientY,
      structure: { ...B }
    }, d.current = W, l.current = U, u.current = !0, document.body.classList.add("table-resize-in-progress");
    const x = {
    ...
    document.body.style.cursor = x[W] || "default", document.addEventListener("mousemove", P), document.addEventListener("mouseup", h);
  }, []), $ = N((R) => {
    const z = ba(R, c.current);
    return z && (o.current = z, s.current = R, document.body.appendChild(z), z.querySelectorAll(".table-resize-handler").forEach((U) => {
      U.addEventListener("mousedown", A);
    })), z;
  }, [A]), L = N((R) => {
    if (!le(R)) return;
    o.current && (We(o.current), o.current = null), R.classList.add("selected"), $(R) && (b(R), r && r(R));
  }, [r, $]), P = N((R) => {
    if (!u.current || !s.current || !i.current || !d.current) return;
    R.preventDefault(), R.stopPropagation();
    const { x: z, y: W, structure: U } = i.current, B = d.current, x = l.current, O = R.clientX, C = R.clientY;
    let _ = 0;
    switch (B) {
      case ce.COLUMN:
        _ = O - z;
    ...
    Ce(s.current, Y), o.current && Ot(o.current, s.current);
  }, []), h = N((R) => {
    if (u.current) {
      if (R.preventDefault(), R.stopPropagation(), s.current && i.current) {
        ...
        (z.structure.width !== W.structure.width || z.structure.height !== W.structure.height || JSON.stringify(z.structure.columnWidths) !== JSON.stringify(W.structure.columnWidths) || JSON.stringify(z.structure.rowHeights) !== JSON.stringify(W.structure.rowHeights)) && y.recordOperation(
          { type: "TABLE_RESIZE", payload: { element: s.current, state: W } },
          { type: "TABLE_RESIZE", payload: { element: s.current, state: z } }
        );
      }
      if (i.current = null, d.current = null, l.current = null, u.current = !1, document.removeEventListener("mousemove", P), document.removeEventListener("mouseup", h), document.body.classList.remove("table-resize-in-progress"), document.body.style.cursor = "", s.current) {
        const z = new Event("input", { bubbles: !0, cancelable: !0 });
        s.current.dispatchEvent(z), t && t(s.current, fe(s.current));
      }
    }
  }, [t, y]), g = N((R) => {
    o.current && !o.current.contains(R.target) && T();
    ...
    if (R.key === "Delete" && s.current && !u.current) {
      ...
      const z = s.current;
      if (z.parentNode) {
        z.parentNode.removeChild(z), T();
        const W = new Event("input", { bubbles: !0, cancelable: !0 });
        e.current.dispatchEvent(W);
      }
    }
    R.key === "Escape" && s.current && T();
  }, [e, T]), I = N(() => {
    o.current && s.current && Ot(o.current, s.current);
  }, []);
  return oe(() => {
    if (!e.current) return;
    const z = e.current.closest(".editor-viewport");
    return z && (z.addEventListener("scroll", I), window.addEventListener("scroll", I)), () => {
      z && z.removeEventListener("scroll", I), window.removeEventListener("scroll", I);
    };
  }, [e, I]), oe(() => {
    if (!e.current) return;
    const R = e.current;
    return R.addEventListener("click", g), R.addEventListener("keydown", v), window.addEventListener("resize", I), () => {
      R.removeEventListener("click", g), R.removeEventListener("keydown", v), window.removeEventListener("resize", I), u.current && (document.removeEventListener("mousemove", P), document.removeEventListener("mouseup", h), document.body.classList.remove("table-resize-in-progress"), document.body.style.cursor = ""), o.current && We(o.current);
    };
  }, [e, g, v, I, P, h]), oe(() => {
    if (!e.current) return;
    const R = new MutationObserver((z) => {
      z.forEach((W) => {
        W.type === "childList" && (W.removedNodes.forEach((U) => {
          U.nodeType === Node.ELEMENT_NODE && le(U) && U === p && T();
    ...
    const R = new MutationObserver((z) => {
      z.some((U) => {
        if (U.type === "childList") {
          ...
          return !0;
        return !1;
      }) && o.current && s.current && (We(o.current), o.current = null, $(s.current));
    });
    return R.observe(p, {
      childList: !0,
      subtree: !0,
...
const $t = ({
  ...
  const [s, i] = re({ top: 0, left: 0 }), [d, l] = re(!1), [c, u] = re("top"), p = Q(null), b = Q(null), y = Te(), T = (C) => {
    if (!C)
      return;
  ...
  const h = N(() => {
    ...
    const C = e.getBoundingClientRect(), _ = p.current.getBoundingClientRect(), Y = window.visualViewport ? window.visualViewport : {
      width: window.innerWidth,
      height: window.innerHeight
    ...
    let D = Math.max(10, Math.min(f, k - _.width - 10)), q = Math.max(10, Math.min(E, H - _.height - 10));
    i({ top: q, left: D }), u(se), l(!0);
  }, [e]);
  bn(() => {
    h();
    const C = () => {
    ...
    const C = (_) => {
      p.current && !p.current.contains(_.target) && _.target !== e && !e.contains(_.target) && r();
    };
  ...
  const g = {
    ...
    if (e && g[C]) {
      const _ = A(e), Y = L, ee = g[C];
      e.style.float = ee.float, e.style.margin = ee.margin, e.style.marginLeft = ee.marginLeft, e.style.marginRight = ee.marginRight, P(C), T(e);
      const se = A(e);
      y.recordOperation(
    ...
    if (C) {
      if (console.log("Row inserted successfully, updating content"), o && o.current) {
        ...
        console.log("Updated content length:", _.length), y.updateContinuousContent(_);
      } else
          ...
          n != null && /* @__PURE__ */ m.jsxs(m.Fragment, { children: [
            ...
            /* @__PURE__ */ m.jsx(
              "button",
              {
                ...
                disabled: n == null,
                children: /* @__PURE__ */ m.jsx($o, { size: 14 })
              }
            ),
            /* @__PURE__ */ m.jsx(
              "button",
...
const Ft = ({
  ...
  const [r, n] = re(/* @__PURE__ */ new Set()), [a, o] = re(null), [s, i] = re(null), [d, l] = re(null), [c, u] = re(!1), [p, b] = re(!1), [y, T] = re(null), [A, $] = re(null);
  Te(), Q(null);
  const L = Q(null), P = N(() => {
    n(/* @__PURE__ */ new Set()), o(null), i(null), l(null), T(null), $(null), u(!1), b(!1), document.querySelectorAll(".table-cell-selected, .table-row-selected, .table-col-selected").forEach((B) => {
    ...
    const x = Array.from(B), O = x[0], C = h(O);
    ...
    const O = g(B);
    n(B), o(O.mode), i(O.rowIndex), l(O.colIndex), $(x), v(O.mode, O.rowIndex, O.colIndex, B, x);
    const C = O.mode ? {
      mode: O.mode,
      cells: B,
      rowIndex: O.rowIndex,
    ...
    if (!x) return;
    const O = h(x);
    O && (u(!0), T(x), $(O.table), b(!1));
  }, [h]), z = N((B) => {
    if (!c || !y) return;
    const x = B.target.closest("td, th");
    if (!x || !A || !A.contains(x)) return;
    b(!0), B.preventDefault();
    const O = h(y), C = h(x);
...
const Aa = 50, mt = 50, Ra = 50, Sa = 100, Oa = 300, Ut = kt(({
  ...
  const u = An(), p = Te(), { pageSize: b, pageMargins: y, continuousContent: T, pageBoundaries: A, activePage: $, zoomLevel: L, canUndo: P, canRedo: h } = u, g = Q(null), v = Q(null), { currentFormat: I, formatText: R, updateCurrentFormatFromSelection: z } = zr(), [W, U] = re(!1), [B, x] = re(null), [O, C] = re(!0), [_, Y] = re(!1), [ee, se] = re(null), [E, f] = re(null), [k, H] = re(null), {
  ...
  } = lo(b, v, L, y), j = ge(() => Me(b), [b]), [ue, Ae] = re(!1), pe = Q(null), He = Q(!1), De = Q(!1), je = Q(!1), Be = Q(T), Qe = N(() => {
    He.current = !1;
  ...
  oe(() => {
    ...
    v.current.innerHTML = T, je.current = !0, Be.current = T;
    const S = setTimeout(() => {
      M();
    }, Aa);
    ...
    if (!v.current || !je.current) return;
    if (v.current.innerHTML !== T) {
      v.current.innerHTML = T;
      const ae = setTimeout(() => {
        M(), He.current && Qe();
      }, mt);
      return Be.current = T, () => clearTimeout(ae);
    }
  }, [T, M, Qe]), oe(() => {
    s && je.current && s(T);
  }, [T, s]);
  const { restoreCursorPosition: et, hasActiveCursorSelection: tt } = fo({
    updateCurrentFormatFromSelection: z,
    editorRef: v
  }), Xn = N((S) => {
    S !== T && p.updateContinuousContent(S), v.current && v.current.innerHTML !== S && (v.current.innerHTML = S), Be.current = S, setTimeout(() => {
      M();
    }, mt);
  }, [T, p, M]), nt = N((S) => {
    if (!v.current || !S) return;
    tt() || et(), document.execCommand("insertHTML", !1, S);
    const ae = v.current.innerHTML;
     ...
     */
    getHTMLContent: () => v.current ? v.current.innerHTML : T,
    /**
     * Get the plain text content (HTML stripped)
     * @returns {string} Plain text content
     */
    getPlainText: () => (v.current ? v.current.innerHTML : T).replace(/<[^>]*>/g, " ").replace(/&nbsp;/g, " ").replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&quot;/g, '"').replace(/&#39;/g, "'").replace(/\s+/g, " ").trim(),
    /**
     * Get the current cursor position in the editor
     * @returns {Object|null} An object with page number, line number, and character offset, or null if no selection
     */
    getCursorPosition: () => v.current ? io(v.current) : null,
    /**
     ...
     */
    setPageSize: (S) => {
      p.updatePageSize(S), M({ pageSize: S });
    },
    /**
     ...
     */
    setPageMargins: (S) => {
      p.updatePageMargins(S), M({ pageMargins: S });
    },
    /**
  ...
  const rt = N(() => {
    if (!v.current) return;
    let S = v.current.innerHTML;
    S = Ge(S), S !== v.current.innerHTML && (v.current.innerHTML = S);
    const ae = T;
    if (ae !== S) {
      const it = {
    ...
    p.updateContinuousContent(S), D(), V(200);
    const Se = q(g);
    Se !== $ && p.setActivePage(Se);
  }, [p, D, q, $, V, g, v, T]), Jn = N((S) => {
    rt();
  }, [rt]), qt = N((S) => {
    p.updatePageSize(S), M({ pageSize: S }), a && a(S);
  }, [p, M, a]), Gt = N((S) => {
    p.updatePageMargins(S), M({ pageMargins: S }), o && o(S);
  }, [p, M, o]), Zt = N((S) => {
    S < 0 || S >= A.length || (De.current = !0, p.setActivePage(S), G(S, g), setTimeout(() => {
      De.current = !1;
    }, Oa), t && t(S));
  }, [p, G, t, A.length]), Yt = N(() => {
    const S = A.length + 1;
    ie(S) && (He.current = !0, setTimeout(() => {
      He.current && Qe();
    }, 100)), r && r();
  }, [A.length, ie, p, G, r]), Qn = N(() => {
    const S = window.getSelection();
    if (S && S.rangeCount > 0) {
      if (!v?.current) return;
      const it = `<page-break data-page-break="true" contenteditable="false" data-page-number="${v.current.querySelectorAll('page-break, [data-page-break="true"]').length + 2}"></page-break><p><br></p>`;
  ...
  }, [A.length, J, p, n]), nr = ge(() => ({
    handleZoomIn: () => p.zoomIn(),
    handleZoomOut: () => p.zoomOut(),
    handleZoomReset: () => p.resetZoom(),
    handleUndo: () => p.undo(),
    handleRedo: () => p.redo()
  }), [p]), { handleZoomIn: ot, handleZoomOut: st, handleZoomReset: at, handleUndo: rr, handleRedo: or } = nr;
  uo(
    { handleZoomIn: ot, handleZoomOut: st, handleZoomReset: at, handleUndo: rr, handleRedo: or },
    { editorRef: v, containerRef: g }
  );
  const sr = N(() => {
    !g.current || !v.current || De.current || (pe.current && clearTimeout(pe.current), pe.current = setTimeout(() => {
      if (De.current) {
        pe.current = null;
        return;
      }
      const S = q(g);
      S !== $ && S >= 0 && p.setActivePage(S), pe.current = null;
    }, Sa));
  }, [q, $, p]), ar = ge(() => {
    if (!T) return 0;
    const ae = T.replace(/<[^>]*>/g, " ").match(new RegExp("\\p{L}+", "gu"));
    return ae ? ae.length : 0;
  }, [T]), ir = A.length || 1, cr = N((S) => {
    U(!0), x(S);
  }, []), Kt = N(() => {
    U(!1), x(null);
  }, []), lr = N((S, ae) => {
  }, []), ur = N((S) => {
    S && S.mode === "row" ? (f(S.rowIndex), H(null)) : S && S.mode === "column" ? (H(S.colIndex), f(null)) : (f(null), H(null));
  }, []), dr = N((S) => {
    Y(!0), se(S);
  }, []), Xt = N(() => {
    Y(!1), se(null);
...
export {
  ...
  bo as saveImage,
  At as updateResizeOverlay,
  Ot as updateTableResizeOverlay,
