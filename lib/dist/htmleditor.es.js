import qe, { createContext as On, useContext as Cn, useReducer as Mn, useMemo as ve, useState as de, useCallback as I, useRef as J, useEffect as ie, forwardRef as ft, createElement as nt, memo as Nn, useLayoutEffect as In, useImperativeHandle as Ln } from "react";
...
function Hn() {
  return Ct || (Ct = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function p(u, A, R, S, z, H) {
      ...
      if (O.call(A, "key")) {
        C = e(u);
        var j = Object.keys(A).filter(function(U) {
          return U !== "key";
        });
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    var b = qe, T = Symbol.for("react.transitional.element"), v = Symbol.for("react.portal"), _ = Symbol.for("react.fragment"), L = Symbol.for("react.strict_mode"), D = Symbol.for("react.profiler"), N = Symbol.for("react.consumer"), y = Symbol.for("react.context"), d = Symbol.for("react.forward_ref"), h = Symbol.for("react.suspense"), k = Symbol.for("react.suspense_list"), $ = Symbol.for("react.memo"), V = Symbol.for("react.lazy"), se = Symbol.for("react.activity"), re = Symbol.for("react.client.reference"), ne = b.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, O = Object.prototype.hasOwnProperty, G = Array.isArray, te = console.createTask ? console.createTask : function() {
      return null;
    };
    b = {
    ...
    var K, Q = {}, ee = b.react_stack_bottom_frame.bind(
      b,
      a
    )(), ae = te(n(a)), E = {};
...
var Mt;
function zn() {
  return Mt || (Mt = 1, process.env.NODE_ENV === "production" ? Le.exports = Bn() : Le.exports = Hn()), Le.exports;
}
var m = zn();
const rt = 100, ot = 50, at = 200, Nt = 5, it = (e) => e < at, st = (e) => e > ot, $n = 96, De = (e) => Math.round(e * $n), Ue = {
  NORMAL: {
    name: "Normal",
    label: 'Normal (1")',
    top: 1,
...
}, Sa = (e) => Object.keys(ue).includes(e), Ra = () => Object.keys(ue), Re = Xt, be = "<p><br></p>", qn = "continuous", we = (e, t = Re) => ({
  id: pt(),
  index: e,
  size: t,
  content: be,
  images: [],
  isBreakPoint: !1
}), ze = (e) => typeof e != "string" || e.trim() === "" ? be : e, Jt = (e, t = Re) => (e.length > 0 ? e : [we(0, t)]).map((n, i) => ({
  id: n.id || pt(),
  index: i,
  size: n.size || t,
  ...
  switch (t.type) {
    case B.INITIALIZE_DOCUMENT: {
      const { initialContent: n = be, pageSize: i = Re } = t.payload || {}, a = { ...we(0, i), content: ze(n) };
      return ct({
        title: e.title,
        pageSize: i,
        pages: [a]
    ...
    case B.UPDATE_PAGES: {
      const n = Array.isArray(t.payload) ? { pages: t.payload } : t.payload || {}, i = Jt(n.pages || [], e.pageSize), a = Array.isArray(n.pageBreaks) ? n.pageBreaks : je(i);
      return {
        ...e,
        pages: i,
    ...
    case B.ADD_PAGE_BREAK: {
      ...
      if (n === "end")
        ...
        const s = o.substring(0, n), g = o.substring(n);
        o = s + a + g;
        ...
        if (i === 0 && g.length === 0)
          ...
          const f = g[i], p = document.createElement("page-break");
          ...
          c.innerHTML = "<br>", f.parentNode.insertBefore(p, f.nextSibling), p.parentNode.insertBefore(c, p.nextSibling), o = s.innerHTML;
        } else
          o = o + a + "<p><br></p>";
      }
      return {
    ...
    case B.SET_EDITOR_MODE: {
      ...
      return n === "continuous" ? i = e.pages.map((s) => s.content).filter((s) => s && s !== be).join(`
`) || be : e.continuousContent && e.continuousContent !== be && (a = [{ ...we(0, e.pageSize), content: e.continuousContent }]), {
...
}, Qt = On(null), ka = ({ children: e, initialState: t = {} }) => {
  const [r, n] = Mn(lt, ct(t)), i = ve(() => ({
  ...
  return /* @__PURE__ */ m.jsx(Qt.Provider, { value: a, children: e });
}, en = () => {
  const e = Cn(Qt);
  if (!e)
...
function Zn() {
  if (It) return Z;
  It = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, r = e ? Symbol.for("react.portal") : 60106, n = e ? Symbol.for("react.fragment") : 60107, i = e ? Symbol.for("react.strict_mode") : 60108, a = e ? Symbol.for("react.profiler") : 60114, o = e ? Symbol.for("react.provider") : 60109, s = e ? Symbol.for("react.context") : 60110, g = e ? Symbol.for("react.async_mode") : 60111, f = e ? Symbol.for("react.concurrent_mode") : 60111, p = e ? Symbol.for("react.forward_ref") : 60112, c = e ? Symbol.for("react.suspense") : 60113, l = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, T = e ? Symbol.for("react.lazy") : 60116, v = e ? Symbol.for("react.block") : 60121, _ = e ? Symbol.for("react.fundamental") : 60117, L = e ? Symbol.for("react.responder") : 60118, D = e ? Symbol.for("react.scope") : 60119;
  function N(d) {
  ...
  return Z.AsyncMode = g, Z.ConcurrentMode = f, Z.ContextConsumer = s, Z.ContextProvider = o, Z.Element = t, Z.ForwardRef = p, Z.Fragment = n, Z.Lazy = T, Z.Memo = b, Z.Portal = r, Z.Profiler = a, Z.StrictMode = i, Z.Suspense = c, Z.isAsyncMode = function(d) {
    return y(d) || N(d) === g;
    ...
    return typeof d == "string" || typeof d == "function" || d === n || d === f || d === a || d === i || d === c || d === l || typeof d == "object" && d !== null && (d.$$typeof === T || d.$$typeof === b || d.$$typeof === o || d.$$typeof === s || d.$$typeof === p || d.$$typeof === _ || d.$$typeof === L || d.$$typeof === D || d.$$typeof === v);
  }, Z.typeOf = N, Z;
}
var Y = {};
/** @license React v16.13.1
...
function Yn() {
  return Lt || (Lt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function N(P) {
      ...
      P === n || P === f || P === a || P === i || P === c || P === l || typeof P == "object" && P !== null && (P.$$typeof === T || P.$$typeof === b || P.$$typeof === o || P.$$typeof === s || P.$$typeof === p || P.$$typeof === _ || P.$$typeof === L || P.$$typeof === D || P.$$typeof === v);
    }
    function y(P) {
    ...
    var d = g, h = f, k = s, $ = o, V = t, se = p, re = n, ne = T, O = b, G = r, te = a, K = i, Q = c, ee = !1;
    function ae(P) {
    ...
    Y.AsyncMode = d, Y.ConcurrentMode = h, Y.ContextConsumer = k, Y.ContextProvider = $, Y.Element = V, Y.ForwardRef = se, Y.Fragment = re, Y.Lazy = ne, Y.Memo = O, Y.Portal = G, Y.Profiler = te, Y.StrictMode = K, Y.Suspense = Q, Y.isAsyncMode = ae, Y.isConcurrentMode = E, Y.isContextConsumer = u, Y.isContextProvider = A, Y.isElement = R, Y.isForwardRef = S, Y.isFragment = z, Y.isLazy = H, Y.isMemo = C, Y.isPortal = j, Y.isProfiler = F, Y.isStrictMode = U, Y.isSuspense = oe, Y.isValidElementType = N, Y.typeOf = y;
  })()), Y;
}
var Dt;
function nn() {
  return Dt || (Dt = 1, process.env.NODE_ENV === "production" ? He.exports = Zn() : He.exports = Yn()), He.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Vn() {
  ...
  return Ye = i() ? Object.assign : function(a, o) {
    for (var s, g = n(a), f, p = 1; p < arguments.length; p++) {
      ...
      for (var p in a)
        if (n(a, p)) {
          ...
          try {
            ...
            c = a[p](o, p, g, s, null, t);
          } catch (T) {
            c = T;
          }
          if (c && !(c instanceof Error) && e(
            (g || "React class") + ": type specification of " + s + " `" + p + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + typeof c + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."
...
function Xn() {
  if ($t) return Je;
  $t = 1;
  var e = nn(), t = Vn(), r = /* @__PURE__ */ ht(), n = /* @__PURE__ */ rn(), i = /* @__PURE__ */ Kn(), a = function() {
  };
  ...
  return Je = function(s, g) {
    ...
    function _(E) {
      ...
      function R(z, H, C, j, F, U, oe) {
        ...
        return H[C] == null ? z ? H[C] === null ? new v("The " + F + " `" + U + "` is marked as required " + ("in `" + j + "`, but its value is `null`.")) : new v("The " + F + " `" + U + "` is marked as required in " + ("`" + j + "`, but its value is `undefined`.")) : null : E(H, C, j, F, U);
      }
      var S = R.bind(null, !1);
    ...
    function L(E) {
      function u(A, R, S, z, H, C) {
        ...
        if (F !== E) {
          var U = Q(j);
          return new v(
            "Invalid " + z + " `" + H + "` of type " + ("`" + U + "` supplied to `" + S + "`, expected ") + ("`" + E + "`."),
            { expectedType: E }
          );
        }
        return null;
    ...
    function k(E) {
      ...
      function u(A, R, S, z, H) {
        for (var C = A[R], j = 0; j < E.length; j++)
          if (T(C, E[j]))
            return null;
        var F = JSON.stringify(E, function(oe, P) {
          var ce = Q(P);
          return ce === "symbol" ? String(P) : P;
        });
        return new v("Invalid " + z + " `" + H + "` of value `" + String(C) + "` " + ("supplied to `" + S + "`, expected one of " + F + "."));
      }
      return _(u);
    }
    function $(E) {
    ...
    function V(E) {
      ...
      function R(S, z, H, C, j) {
        for (var F = [], U = 0; U < E.length; U++) {
          var oe = E[U], P = oe(S, z, H, C, j, r);
          if (P == null)
            return null;
          P.data && n(P.data, "expectedType") && F.push(P.data.expectedType);
        }
    ...
    function se() {
      function E(u, A, R, S, z) {
        return G(u[A]) ? null : new v("Invalid " + S + " `" + z + "` supplied to " + ("`" + R + "`, expected a ReactNode."));
      }
      return _(E);
    }
    ...
    function ne(E) {
      function u(A, R, S, z, H) {
        ...
        for (var F in E) {
          var U = E[F];
          if (typeof U != "function")
            return re(S, z, H, F, Q(U));
          var oe = U(C, F, S, z, H + "." + F, r);
          if (oe)
            return oe;
        }
        return null;
    ...
    function O(E) {
      function u(A, R, S, z, H) {
        ...
        for (var U in F) {
          var oe = E[U];
          if (n(E, U) && typeof oe != "function")
            return re(S, z, H, U, Q(oe));
          if (!oe)
            return new v(
              "Invalid " + z + " `" + H + "` key `" + U + "` supplied to `" + S + "`.\nBad object: " + JSON.stringify(A[R], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(E), null, "  ")
            );
          var P = oe(C, U, S, z, H + "." + U, r);
          if (P)
            return P;
        }
        return null;
...
const x = /* @__PURE__ */ jn(er), on = {
  ...
  // 72 pt ≈ 96 px
], We = "16px", nr = (e) => Math.round(e * 96 / 72), rr = (e) => Math.round(e * 72 / 96 * 2) / 2, Oa = (e) => {
  ...
  const [e, t] = de(Gt), r = ke(), n = I((c, l, b = null) => {
    try {
      ...
      try {
        ...
        return L.appendChild(D), v.insertNode(L), v.selectNodeContents(L), T.removeAllRanges(), T.addRange(v), t((N) => ({ ...N, [c]: l })), !0;
      } catch {
        if (b) {
          const L = c === "fontSize" ? or[l] || "3" : l;
          return document.execCommand(b, !1, L), t((D) => ({ ...D, [c]: l })), !0;
        }
        return !1;
      }
    } catch (T) {
  ...
  }, []), i = I((c) => n("fontFamily", c, "fontName"), [n]), a = I((c) => n("fontSize", c, "fontSize"), [n]), o = I((c) => {
    t((l) => ({
      ...l,
      alignLeft: c === "left",
    ...
    try {
      ...
      if (!l || l.rangeCount === 0)
        return !1;
      const b = l.getRangeAt(0), T = b.toString(), _ = {
        justifyLeft: "left",
      ...
      if (!_)
        return !1;
      if (!T) {
        const D = b.startContainer, N = D.nodeType === Node.TEXT_NODE ? D.parentElement : D, y = Fe(N) || sr();
      ...
      if (L.length === 0) {
        ...
        D.style.textAlign = _;
        const N = b.extractContents();
        D.appendChild(N), b.insertNode(D), b.selectNodeContents(D), l.removeAllRanges(), l.addRange(b);
      } else
        L.forEach((D) => {
          D.style.textAlign = _;
        });
    ...
    try {
      ...
      if (!c || c.rangeCount === 0)
        return;
      const l = c.getRangeAt(0), b = l.toString();
      let T = We, v = "Arial", _ = "p", L = "left";
      if (b) {
        const N = l.startContainer, y = N.nodeType === Node.TEXT_NODE ? N.parentElement : N;
        if (y) {
          const d = window.getComputedStyle(y), h = d.fontSize, k = d.fontFamily;
          h && h.endsWith("px") && (T = h), k && k !== "serif" && (v = k.split(",")[0].replace(/['"]/g, "").trim());
          const $ = Fe(y);
          if ($) {
            const V = $.tagName?.toLowerCase();
            ["h1", "h2", "h3", "h4", "h5", "h6", "p"].includes(V) && (_ = V);
            const re = window.getComputedStyle($).textAlign;
            ["left", "center", "right", "justify"].includes(re) && (L = re);
          }
        }
      }
      const D = {
...
function ir(e) {
  const t = [], r = e.startContainer, n = e.endContainer, i = Fe(
...
const me = 'page-break, [data-page-break="true"]', an = (e) => ue[e] || ue.A4, cr = (e, t = {}) => {
  if (!e || typeof document > "u")
    return [];
  const r = t.pageSize || "A4", n = an(r), i = e.querySelectorAll(me), a = [];
  a.push({
    id: "page-0",
    pageNumber: 1,
    top: 0,
  ...
  return i.forEach((g, f) => {
    const c = g.getBoundingClientRect().top - o.top + s;
    a.push({
      id: `page-${f + 1}`,
      pageNumber: f + 2,
      top: c,
  ...
  const n = an(e), i = Un(r), a = n.height - i, o = t / 100;
  return a / o;
}, lr = (e, t) => {
  if (!e || !t)
    return 0;
  try {
    const r = t.querySelectorAll(me);
    if (r.length === 0)
      return 0;
  ...
  if (!e)
    return !1;
  try {
    const g = sn(r, n, i) * (t - 1), f = Array.from(e.children);
    let p = 0, c = null;
  ...
  try {
    const g = Array.from(e.querySelectorAll(me));
    if (t > g.length)
    ...
    if (l && l.parentNode && l.remove(), c.forEach((T) => {
      T.parentNode && T.remove();
    }), e.querySelectorAll(me).forEach((T, v) => {
  ...
  if (e)
    try {
      e.querySelectorAll(me).forEach((r, n) => {
    ...
    for (let l = 0; l < f.length && c < Wt; l++) {
      ...
      if (T && T.overflowIndex > 0) {
        ...
        if (v - g < Er)
          continue;
        const L = l + 2;
        dr(T.overflowElement, L) && (p = !0, c++, f = qt(e));
      }
    }
    if (p) {
      if (i) {
  ...
  if (e) {
    ...
    try {
      ...
      if (t === 0)
        ...
        const a = e.querySelectorAll(me)[t - 1];
  ...
  try {
    ...
    if (r === 0)
      ...
      const o = t.querySelectorAll(me)[r - 1];
      if (o)
        i = o;
      else {
  ...
  const s = a.toString().replace(/<[^>]*>/g, " ").replace(/&nbsp;/g, " ").replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&quot;/g, '"').replace(/&#39;/g, "'").replace(/\s+/g, " ").trim(), g = s.length, f = (s.match(/\n/g) || []).length + 1;
  return {
    page: n,
    line: f,
    charOffset: g
  };
}, wr = 300, Sr = (e, t, r = 100, n = "NARROW") => {
  const i = ke(), a = J(null), o = J(null), s = J(e), g = J(r), f = J(n), p = J(!1);
  ie(() => {
    s.current = e;
  }, [e]), ie(() => {
    g.current = r;
  ...
  const c = I((h = {}) => t?.current ? cr(t.current, h) : [], [t]), l = I((h = {}) => {
    const k = c(h);
    return i.updatePageBoundaries(k), k;
  }, [c, i]), b = I(async (h) => {
    if (!t?.current)
      return !1;
    const k = s.current || "A4", $ = g.current || 100, V = f.current || "NARROW";
    return fr(
      t.current,
      h,
      k,
    ...
    if (!t?.current)
      return;
    const h = s.current || "A4", k = g.current || 100, $ = f.current || "NARROW";
    Tr(
      t.current,
      h,
      k,
    ...
    const k = typeof h.delay == "number" ? h.delay : wr;
    Pr(l, a, h, k);
  }, [l]), L = I((h) => !h?.current || !t?.current ? 0 : lr(h.current, t.current), [t]), D = I((h) => {
    t?.current && ln(t.current, h);
  }, [t]), N = I((h, k) => {
    if (!k?.current || !t?.current) {
      console.warn("[scrollToPage] Missing refs");
      return;
    }
    Ar(k.current, t.current, h, D);
  }, [t, D]), y = I((h) => t?.current ? pr(
    t.current,
    h,
    c,
    i.updateContinuousContent,
    ...
    D,
    T
  ) : !1, [t, c, i, l, D, T]), d = I((h) => t?.current ? hr(
    h,
    t.current,
    i.updateContinuousContent,
    l,
...
function Na({
  ...
  switch (e) {
    case M.TOP_LEFT:
      p = Math.max(s.minWidth, a - g), c = Math.max(s.minHeight, o - f);
      break;
    case M.TOP_RIGHT:
      p = Math.max(s.minWidth, a + g), c = Math.max(s.minHeight, o - f);
      break;
  ...
  if (s.preserveAspectRatio && s.aspectRatio) {
    ...
    [
      ...
      M.BOTTOM_LEFT,
      M.BOTTOM_RIGHT
    ].includes(e) ? p / l > c ? c = Math.max(s.minHeight, p / l) : p = Math.max(s.minWidth, c * l) : [M.TOP, M.BOTTOM].includes(e) ? p = c * l : [M.LEFT, M.RIGHT].includes(e) && (c = p / l);
  }
  return s.maxWidth && p > s.maxWidth && (p = s.maxWidth, s.preserveAspectRatio && s.aspectRatio && (c = p / (a / o))), s.maxHeight && c > s.maxHeight && (c = s.maxHeight, s.preserveAspectRatio && s.aspectRatio && (p = c * (a / o))), p = Math.max(s.minWidth, p), c = Math.max(s.minHeight, c), {
    width: Math.round(p),
    height: Math.round(c)
  };
}
...
function La(e, { width: t, height: r }) {
  he(e) && (e.tagName === "IMG" ? (e.style.width = `${t}px`, e.style.height = `${r}px`, e.width = t, e.height = r) : e.tagName === "DIV" && (e.style.width = `${t}px`, e.style.height = `${r}px`));
}
function Rr(e, t = xe) {
  if (!he(e)) return null;
  ...
  return r.style.top = `${n.top}px`, r.style.left = `${n.left}px`, r.style.width = `${n.width}px`, r.style.height = `${n.height}px`, Object.values(M).forEach((a) => {
    const o = document.createElement("div");
    o.className = `resize-handler resize-handler-${a}`, o.dataset.handler = a, o.style.position = "absolute", o.style.width = "10px", o.style.height = "10px", o.style.backgroundColor = "#007bff", o.style.border = "2px solid white", o.style.borderRadius = "50%", o.style.boxShadow = "0 0 3px rgba(0,0,0,0.3)", o.style.cursor = kr(a), o.style.pointerEvents = "all", un(o, a, n.width, n.height), r.appendChild(o);
  }), r;
}
function kr(e) {
  switch (e) {
...
function ut(e, t) {
  ...
  e.style.top = `${r.top}px`, e.style.left = `${r.left}px`, e.style.width = `${r.width}px`, e.style.height = `${r.height}px`, e.querySelectorAll(".resize-handler").forEach((i) => {
    ...
    un(i, a, r.width, r.height);
  });
}
function et(e) {
  e && e.parentNode && e.parentNode.removeChild(e);
}
const Or = "html-editor-storage", Cr = 1, fe = "images";
function Mr() {
...
function Nr(e) {
  return new Promise((t, r) => {
    ...
    i.onload = async (a) => {
      ...
      try {
        const f = await Oe(), p = `editor-image-${Mr()}`, l = f.transaction([fe], "readwrite").objectStore(fe), b = {
          key: p,
          dataUrl: o,
          size: g,
          type: e.type,
...
function Se(e) {
  ...
  for (let n = 0; n < r.length; n++) {
    ...
    if (i.nodeType === Node.TEXT_NODE) {
      ...
      const a = i, o = a.tagName, s = o.toLowerCase(), g = dn(a);
      if (o === "DIV") {
        const f = Se(a);
 ...
 */
const Ur = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Fr = (e) => e.replace(
  /^([A-Z])|[\s-_]+(\w)/g,
  (t, r, n) => n ? n.toUpperCase() : r.toLowerCase()
), Zt = (e) => {
  const t = Fr(e);
  return t.charAt(0).toUpperCase() + t.slice(1);
}, fn = (...e) => e.filter((t, r, n) => !!t && t.trim() !== "" && n.indexOf(t) === r).join(" ").trim(), Gr = (e) => {
  for (const t in e)
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Vr = [["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }]], Kr = q("chevron-left", Vr);
/**
 * @license lucide-react v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Xr = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]], Jr = q("chevron-right", Xr);
/**
 * @license lucide-react v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Qo = [
  ...
  ["line", { x1: "21", x2: "16.65", y1: "21", y2: "16.65", key: "13gj7c" }],
  ["line", { x1: "8", x2: "14", y1: "11", y2: "11", key: "durymu" }]
], ea = q("zoom-out", Qo), Yt = (e, t, r = "") => {
  if (!e) return [];
  const n = document.createElement("div");
  n.innerHTML = e;
  const i = n.querySelectorAll("h1, h2, h3, h4, h5, h6");
  return Array.from(i).map((a, o) => {
    const s = parseInt(a.tagName.charAt(1)), g = a.textContent.trim();
    return g ? {
      id: `${r}heading-${o}`,
      level: s,
      text: g,
...
}, na = ({ isCollapsed: e, onToggle: t, wordCount: r, pageCount: n }) => {
  const i = tn(), { pages: a, activePage: o, continuousContent: s } = i, [g, f] = de(0), [p, c] = de([]);
  ie(() => {
    if (r !== void 0 && n !== void 0) {
      f(r), c(Yt(s, 1, "continuous-"));
      return;
    }
    let b = 0;
    const T = [];
    a.forEach((v, _) => {
      b += ta(v.content), T.push(...Yt(v.content, _ + 1, `page-${_}-`));
    }), f(b), c(T);
  }, [a, r, n, s]);
      ...
      children: [
        /* @__PURE__ */ m.jsxs("div", { className: "sidebar-header", children: [
          ...
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              children: e ? /* @__PURE__ */ m.jsx(Jr, { size: 16 }) : /* @__PURE__ */ m.jsx(Kr, { size: 16 })
            }
          )
        ] }),
        !e && /* @__PURE__ */ m.jsxs("div", { className: "sidebar-content", children: [
          /* @__PURE__ */ m.jsxs("div", { className: "sidebar-section", children: [
            ...
            /* @__PURE__ */ m.jsxs("div", { className: "stat-item", children: [
              /* @__PURE__ */ m.jsxs("div", { className: "stat-label", children: [
                /* @__PURE__ */ m.jsx(Ge, { size: 14 }),
                /* @__PURE__ */ m.jsx("span", { children: "Active Page:" })
              ] }),
              /* @__PURE__ */ m.jsx("span", { className: "stat-value", children: o + 1 })
            ] })
          ] }),
          p.length > 0 && /* @__PURE__ */ m.jsxs("div", { className: "sidebar-section", children: [
            /* @__PURE__ */ m.jsxs("h3", { children: [
              /* @__PURE__ */ m.jsx(pn, { size: 14, style: { display: "inline-block", marginRight: "6px", verticalAlign: "middle" } }),
              "Document Outline"
            ] }),
            /* @__PURE__ */ m.jsx("div", { className: "document-outline", "data-testid": "outline", children: p.map((b) => {
              const T = b.level === 1 ? ao : b.level === 2 ? so : lo;
              return /* @__PURE__ */ m.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ m.jsx(T, { size: 12, className: "outline-icon" }),
                    /* @__PURE__ */ m.jsx("span", { className: "outline-text", children: b.text }),
...
const Vt = new ra("Editor"), yn = /* @__PURE__ */ new Set(["P", "DIV", "H1", "H2", "H3", "H4", "H5", "H6", "LI", "BLOCKQUOTE", "PRE", "TABLE"]), En = 32;
function bn(e, t) {
  if (!e) return;
...
function ia() {
  ...
  return n ? (n.querySelectorAll("p, div, h1, h2, h3, h4, h5, h6, li, blockquote, pre, table").forEach((o) => {
    ...
    if (document.createRange().selectNode(s), t.intersectsNode(s)) {
      ...
      for (; f && f !== n; ) {
        if (f.tagName && yn.has(f.tagName.toUpperCase())) {
          r.add(f);
          break;
        }
        f = f.parentElement;
...
function dt(e = !1) {
  ...
  try {
    const o = document.createRange(), s = (c) => c.nodeType === Node.TEXT_NODE ? c : document.createTreeWalker(
      ...
      let b = null, T = l.nextNode();
      for (; T; )
        b = T, T = l.nextNode();
      return b;
    }, f = s(i);
    f ? o.setStart(f, 0) : o.setStart(i, 0);
    const p = g(a);
...
const la = [
...
], da = '<table border="1"><tr><td>Cell 1</td><td>Cell 2</td></tr><tr><td>Cell 3</td><td>Cell 4</td></tr></table>', mt = ({
  currentFormat: e,
  onFormatText: t,
  onAddPageBreak: r,
  canUndo: n = !1,
  ...
  const a = async (f) => {
    try {
      ...
      const c = await Nr(f), l = await Ir(c);
      if (l) {
        const T = `<img src="${l}" data-key="${c}" alt="Inserted image" />`;
        document.execCommand("insertHTML", !1, T), Vt.info("Image inserted", { key: c });
      }
  ...
  return /* @__PURE__ */ m.jsxs("div", { className: "editor-toolbar", children: [
    ...
    g(),
    o("bold", "bold", Yr, "Bold"),
    o("italic", "italic", mo, "Italic"),
    o("underline", "underline", Wo, "Underline"),
    o("strikethrough", "strikethrough", Lo, "Strikethrough"),
    g(),
    o("justifyLeft", "alignLeft", mn, "Align Left"),
    o("justifyCenter", "alignCenter", gn, "Align Center"),
    o("justifyRight", "alignRight", hn, "Align Right"),
    o("justifyFull", "alignJustify", $o, "Justify"),
    g(),
    /* @__PURE__ */ m.jsx(
      "select",
      {
        ...
        title: "Font Family",
        children: la.map(({ value: f, label: p }) => /* @__PURE__ */ m.jsx("option", { value: f, children: p }, f))
      }
    ),
    /* @__PURE__ */ m.jsx(
      "select",
      {
        ...
        value: e.fontSize || We,
        title: "Font Size",
        children: tr.map(({ value: f, label: p }) => /* @__PURE__ */ m.jsx("option", { value: f, children: p }, f))
      }
    ),
    /* @__PURE__ */ m.jsx(
      "select",
      {
        ...
        title: "Heading Level",
        children: ua.map(({ value: f, label: p }) => /* @__PURE__ */ m.jsx("option", { value: f, children: p }, f))
      }
    ),
    g(),
    s(() => t("insertUnorderedList"), pn, "Bullet List"),
    s(() => t("insertOrderedList"), Po, "Numbered List"),
    g(),
    /* @__PURE__ */ m.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ m.jsx(xo, { size: 16 })
      }
    ),
    /* @__PURE__ */ m.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ m.jsx(To, { size: 16 })
      }
    ),
    g(),
    /* @__PURE__ */ m.jsx(
      "button",
      {
        ...
        title: "Insert Link",
        children: /* @__PURE__ */ m.jsx(Eo, { size: 16 })
      }
    ),
    s(() => t("insertHTML", da), jo, "Insert Table"),
    r && s(r, Ge, "Insert Page Break"),
    g(),
    /* @__PURE__ */ m.jsx(
      "input",
      {
    ...
    /* @__PURE__ */ m.jsx(
      "button",
      {
        ...
        title: "Insert Image",
        children: /* @__PURE__ */ m.jsx(go, { size: 16 })
      }
    )
  ] });
};
...
function pa(e) {
  ...
  return r ? (t.getData("text/html") ? r = fa(r) : r = ga(r), document.execCommand("insertHTML", !1, r), r) : null;
}
function ga(e) {
  if (!e) return "";
  const t = e.split(/\n\s*\n/).filter((r) => r.trim());
  return t.length === 0 ? "<p><br></p>" : t.map((r) => {
    const n = r.split(`
`).filter((a) => a.trim());
    return n.length === 0 ? "<p><br></p>" : `<p>${n.map((a) => ha(a.trim())).join("<br>")}</p>`;
  }).join("");
}
function ha(e) {
  const t = document.createElement("div");
...
const Ee = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && Ee(e.parentElement) : !1, yt = ({
  dimensions: e,
  editorRef: t,
  onInput: r,
  onContentChange: n,
  ...
  const c = ve(() => Kt(p), [p]), l = f / 100, b = I((y, d) => {
    if (!y) return !1;
    const h = y.getBoundingClientRect(), k = d - h.top;
    return k < c.top || k > h.height - c.bottom;
  }, [c.top, c.bottom]), T = I((y, d) => {
    d.preventDefault();
    const h = y.getBoundingClientRect(), k = d.clientX - h.left, $ = d.clientY - h.top, V = h.width - 40, se = -12, re = h.width - 20;
    k >= V && k <= re && $ >= se && $ <= 8 && g && g(y);
  }, [g]), v = I((y) => {
    y.preventDefault();
    ...
    if (y.clientY - d.top < c.top) {
      ...
      if (k && k.tagName !== "PAGE-BREAK") {
        const $ = document.createRange(), V = window.getSelection();
        $.setStart(k, 0), $.collapse(!0), V.removeAllRanges(), V.addRange($);
      }
    } else {
      const k = t.current.lastElementChild;
      if (k && k.tagName !== "PAGE-BREAK") {
        const $ = document.createRange(), V = window.getSelection();
        $.selectNodeContents(k), $.collapse(!1), V.removeAllRanges(), V.addRange($);
      }
    }
  }, [t, c.top]), _ = I((y) => {
    const d = window.getSelection();
    if (!d || d.rangeCount === 0) return;
    const h = d.getRangeAt(0), { startContainer: k, endContainer: $ } = h;
    if ((Ee(k) || Ee($)) && (y.key.length === 1 || y.key === "Enter" || y.key === " "))
      return y.preventDefault(), !1;
    if (ca(y))
      return n && n(), !1;
    if ((y.key === "Backspace" || y.key === "Delete") && (Ee(k) || Ee($)))
      return y.preventDefault(), !1;
    i && i(y);
  }, [i, n]), L = I((y) => {
    if (!t.current) return;
    ...
    const d = window.getSelection();
    if (!d || d.rangeCount === 0) return;
    const h = d.getRangeAt(0), { startContainer: k } = h;
    if (Ee(k))
      return y.preventDefault(), !1;
  }, []), N = I((y) => {
    const d = pa(y);
  ...
  return /* @__PURE__ */ m.jsxs("div", { className: "page-manager", children: [
    /* @__PURE__ */ m.jsxs("div", { className: "page-settings-group", children: [
      /* @__PURE__ */ m.jsxs("div", { className: "page-settings-header", children: [
        /* @__PURE__ */ m.jsx(No, { size: 14, style: { marginRight: "4px", verticalAlign: "middle" } }),
        "Page Settings"
      ] }),
        ...
        /* @__PURE__ */ m.jsxs("div", { className: "page-setting-item", children: [
          ...
          /* @__PURE__ */ m.jsx(
            "select",
            {
              ...
              children: Fn().map((d) => /* @__PURE__ */ m.jsx("option", { value: d, children: Gn(d) }, d))
            }
          )
        ] })
      ] })
    ...
    /* @__PURE__ */ m.jsxs("div", { className: "zoom-controls-compact", children: [
      /* @__PURE__ */ m.jsx(
        "button",
        {
          ...
          "aria-label": "Zoom out",
          title: "Zoom out (Ctrl + -)",
          children: /* @__PURE__ */ m.jsx(ea, { size: 12 })
        }
      ),
      ...
      /* @__PURE__ */ m.jsx(
        "button",
        {
          ...
          "aria-label": "Zoom in",
          title: "Zoom in (Ctrl + +)",
          children: /* @__PURE__ */ m.jsx(Jo, { size: 12 })
        }
      ),
      /* @__PURE__ */ m.jsx(
        "button",
    ...
    /* @__PURE__ */ m.jsx("div", { className: "page-list", children: e.map((d, h) => /* @__PURE__ */ m.jsxs("div", { className: "page-item", children: [
      /* @__PURE__ */ m.jsxs(
        "button",
        {
          type: "button",
...
function Tn(e, { width: t, height: r }) {
  he(e) && (e.tagName === "IMG" ? (e.style.width = `${t}px`, e.style.height = `${r}px`, e.width = t, e.height = r) : e.tagName === "DIV" && (e.style.width = `${t}px`, e.style.height = `${r}px`));
}
function Ta(e, t, r) {
  Tn(t, r);
...
function va(e, t, r, n) {
  const { ctrlKey: i, metaKey: a, shiftKey: o, key: s } = e, g = i || a, f = r.offsetWidth, p = r.offsetHeight, l = {
    // Increase width
    ">": g && o ? () => ({
...
const bt = ({
  ...
  const a = J(null), o = J(null), s = J(null), g = J(null), f = J(i), p = J(!1), c = ke();
  ie(() => {
    f.current = i;
  }, [i]);
  const l = I((y) => {
    ...
    const d = Rr(y, f.current);
    d && (a.current = d, o.current = y, document.body.appendChild(d), d.querySelectorAll(".resize-handler").forEach((k) => {
      k.addEventListener("mousedown", T);
    }), r && r(y));
  }, [r]), b = I(() => {
    o.current && (o.current.classList.remove("selected"), o.current = null), a.current && (et(a.current), a.current = null), s.current = null, g.current = null, p.current = !1, n && n();
  }, [n]), T = I((y) => {
    if (y.preventDefault(), y.stopPropagation(), !o.current) return;
    const d = y.currentTarget.dataset.handler, h = o.current.getBoundingClientRect(), k = window.pageYOffset || document.documentElement.scrollTop, $ = window.pageXOffset || document.documentElement.scrollLeft;
    s.current = {
      x: y.clientX,
      y: y.clientY,
      ...
      offsetX: y.clientX - h.left - $,
      offsetY: y.clientY - h.top - k
    }, g.current = d, p.current = !0, document.body.classList.add("resize-in-progress"), document.body.style.cursor = Ea(d), document.addEventListener("mousemove", v), document.addEventListener("mouseup", _);
  }, []), v = I((y) => {
    if (!p.current || !o.current || !s.current || !g.current) return;
    y.preventDefault(), y.stopPropagation();
    const { x: d, y: h, width: k, height: $ } = s.current, V = g.current, se = y.clientX, re = y.clientY, ne = ba({
      handler: V,
      startX: d,
      startY: h,
      currentX: se,
    ...
    Tn(o.current, ne), a.current && ut(a.current, o.current);
  }, []), _ = I((y) => {
    if (p.current) {
      if (y.preventDefault(), y.stopPropagation(), o.current && s.current) {
        ...
        (d.width !== h.width || d.height !== h.height) && c.recordOperation(
          { type: "IMAGE_RESIZE", payload: { element: o.current, state: h } },
          { type: "IMAGE_RESIZE", payload: { element: o.current, state: d } }
        );
      }
      if (s.current = null, g.current = null, p.current = !1, document.removeEventListener("mousemove", v), document.removeEventListener("mouseup", _), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = "", o.current) {
    ...
    a.current && !a.current.contains(y.target) && b();
    const d = y.target;
    if (he(d)) {
      if (d === o.current)
        return;
    ...
    y.key === "Escape" && o.current && b(), o.current && !p.current && va(y, e, o.current, f.current);
  }, [e, b]), N = I(() => {
  ...
  return ie(() => {
    ...
    return d && (d.addEventListener("scroll", N), window.addEventListener("scroll", N)), () => {
      d && d.removeEventListener("scroll", N), window.removeEventListener("scroll", N);
    };
  }, [e, N]), ie(() => {
    if (!e.current) return;
    const y = e.current;
    return y.addEventListener("click", L), y.addEventListener("keydown", D), window.addEventListener("resize", N), () => {
      y.removeEventListener("click", L), y.removeEventListener("keydown", D), window.removeEventListener("resize", N), p.current && (document.removeEventListener("mousemove", v), document.removeEventListener("mouseup", _), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = ""), a.current && et(a.current);
    };
  }, [e, L, D, N, v, _]), ie(() => {
    if (!e.current) return;
    const y = new MutationObserver((d) => {
      d.forEach((h) => {
        h.type === "childList" && (h.removedNodes.forEach((k) => {
          k.nodeType === Node.ELEMENT_NODE && he(k) && k === o.current && b();
        }), h.addedNodes.forEach((k) => {
          if (k.nodeType !== Node.ELEMENT_NODE) return;
          if (he(k)) {
            setTimeout(() => l(k), 50);
            return;
          }
          const $ = k.querySelectorAll?.("img") || [];
          $.length > 0 && setTimeout(() => l($[0]), 50);
        }));
      });
    });
...
const Tt = ({
  ...
  const [o, s] = de({ top: 0, left: 0 }), [g, f] = de(!1), [p, c] = de("top"), [l, b] = de(a), T = J(null), v = J(null), _ = ke(), L = (O) => {
    if (!O)
      return;
    ...
    return {
      float: G.float || "none",
      margin: O.style.margin || "",
      display: G.display || "inline",
      width: O.style.width || O.width || "",
      height: O.style.height || O.height || "",
      aspectRatio: l
    };
  }, N = I(() => {
    if (!e) return "left";
    const O = window.getComputedStyle(e);
    return O.float === "right" ? "right" : O.float === "left" ? "left" : O.display === "block" && O.margin.includes("auto") ? "center" : "left";
  }, [e]), [y, d] = de("left");
  ie(() => {
    e && d(N());
  }, [e, N]);
  const h = I(() => {
    ...
    const O = e.getBoundingClientRect(), G = T.current.getBoundingClientRect(), te = window.visualViewport ? window.visualViewport : {
      width: window.innerWidth,
      height: window.innerHeight
    }, K = O.bottom >= 0 && O.top <= te.height && O.right >= 0 && O.left <= te.width;
    let Q = "top", ee = 0, ae = 0;
    if (K) {
      const S = O.top - G.height - 10, z = te.height - O.bottom - G.height - 10;
      z > S && z > 0 ? (Q = "bottom", ee = O.bottom + 10) : (Q = "top", ee = O.top - G.height - 10);
    } else
      Q = "top", ee = 10;
    ae = O.left + O.width / 2 - G.width / 2;
    const E = window.innerWidth, u = window.innerHeight;
    let A = Math.max(10, Math.min(ae, E - G.width - 10)), R = Math.max(10, Math.min(ee, u - G.height - 10));
    s({ top: R, left: A }), c(Q), f(!0);
  }, [e]);
  In(() => {
    h();
    const O = () => {
    ...
    return G && G.addEventListener("scroll", O), window.addEventListener("scroll", O), window.addEventListener("resize", O), () => {
      G && G.removeEventListener("scroll", O), window.removeEventListener("scroll", O), window.removeEventListener("resize", O), f(!1);
    };
  }, [e, h]), ie(() => {
    const O = (G) => {
      T.current && !T.current.contains(G.target) && G.target !== e && i();
    };
  ...
  const k = {
    ...
    if (e && k[O]) {
      const G = D(e), te = y, K = k[O];
      e.style.float = K.float, e.style.margin = K.margin, e.style.display = K.display, d(O), L(e);
      const Q = D(e);
      _.recordOperation(
        { type: "IMAGE_ALIGN", payload: { element: e, alignment: O, state: Q } },
    ...
    if (e && e.parentNode) {
      ...
      _.recordOperation(
        ...
        { type: "IMAGE_REINSERT", payload: { state: O } }
      ), e.parentNode.removeChild(e), n && n(), i();
    }
  }, se = () => {
    const O = l, G = !l;
    b(G), _.recordOperation(
    ...
    ...re,
    background: O ? "#007bff" : "transparent",
    color: O ? "#fff" : "#333"
  });
        ...
        children: [
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              children: l ? /* @__PURE__ */ m.jsx(Co, { size: 14 }) : /* @__PURE__ */ m.jsx(fo, { size: 14 })
            }
          ),
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              title: "Align Left",
              style: ne(y === "left"),
              children: /* @__PURE__ */ m.jsx(mn, { size: 14 })
            }
          ),
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              title: "Align Center",
              style: ne(y === "center"),
              children: /* @__PURE__ */ m.jsx(gn, { size: 14 })
            }
          ),
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              title: "Align Right",
              style: ne(y === "right"),
              children: /* @__PURE__ */ m.jsx(hn, { size: 14 })
            }
          ),
          /* @__PURE__ */ m.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ m.jsx(Go, { size: 14 })
            }
          )
        ]
      }
...
const xa = 50, tt = 50, Aa = 50, vt = ft(({
  ...
  const c = tn(), l = ke(), { pageSize: b, pageMargins: T, continuousContent: v, pageBoundaries: _, activePage: L, zoomLevel: D, canUndo: N, canRedo: y } = c, d = J(null), h = J(null), { currentFormat: k, formatText: $, updateCurrentFormatFromSelection: V } = ar(), [se, re] = de(!1), [ne, O] = de(null), [G, te] = de(!0), K = J(null), {
  ...
  } = Sr(b, h, D, T), z = ve(() => gt(b), [b]), [H, C] = de(!1), j = J(null), F = J(!1), U = J(!1), oe = J(!1), P = J(v);
  ie(() => {
    if (h.current) {
      if (!oe.current) {
        h.current.innerHTML = v, oe.current = !0, P.current = v;
        const w = setTimeout(() => {
          E();
        }, xa);
  ...
  const ce = ve(() => ({
     ...
     */
    getCursorPosition: () => h.current ? _r(h.current) : null,
    /**
    ...
    setContent: (w) => {
      const W = $e(w);
      W !== v && l.updateContinuousContent(W), h.current && h.current.innerHTML !== W && (h.current.innerHTML = W), P.current = W, h.current && setTimeout(() => {
        E();
      }, tt);
    },
    /**
     ...
     */
    insertContent: (w) => {
      if (!h.current || !w) return;
      const W = $e(w), X = window.getSelection();
      let le = !1;
      if (X && X.rangeCount > 0) {
        const Ze = X.getRangeAt(0);
        h.current.contains(Ze.commonAncestorContainer) && (le = !0);
      }
      if (!le && K.current)
        try {
      ...
      const ge = h.current.innerHTML;
      l.updateContinuousContent(ge), P.current = ge, setTimeout(() => {
        E(), u(200);
      }, tt);
    }
  }), [v, l, E, h, K, Q]);
  Ln(p, () => ce, [ce]), ie(() => {
    ...
    const W = () => {
      if (setTimeout(V, 10), K.current && h.current)
        try {
          const X = window.getSelection();
          X.removeAllRanges(), X.addRange(K.current);
        } catch (X) {
    ...
    return h.current && h.current.addEventListener("focus", W), () => {
      document.removeEventListener("selectionchange", w), h.current && h.current.removeEventListener("focus", W);
    };
  }, [V]);
  const ye = I(() => {
    F.current = !1;
    ...
    if (!h.current) return;
    let w = h.current.innerHTML;
    w = $e(w), w !== h.current.innerHTML && (h.current.innerHTML = w);
    const W = v;
    if (W !== w) {
      const le = {
      ...
      l.recordOperation(le, ge);
    }
    l.updateContinuousContent(w), Q(), u(200);
    const X = ee(d);
    X !== L && l.setActivePage(X);
  }, [l, Q, ee, L, u, d, h, v]), xn = I((w) => {
    Te();
  }, [Te]), xt = I((w) => {
    l.updatePageSize(w), E({ pageSize: w }), i && i(w);
  }, [l, E, i]), At = I((w) => {
    l.updatePageMargins(w), E({ pageMargins: w }), a && a(w);
  }, [l, E, a]), Pt = I((w) => {
    w < 0 || w >= _.length || (U.current = !0, l.setActivePage(w), ae(w, d), setTimeout(() => {
      U.current = !1;
    }, NAVIGATION_LOCK_TIMEOUT), t && t(w));
  }, [l, ae, t, _.length]), _t = I(() => {
    const w = _.length + 1;
    S(w) && (F.current = !0, setTimeout(() => {
      F.current && ye();
    }, 100)), r && r();
  }, [_.length, S, l, ae, r]), An = I(() => {
  ...
  ie(() => {
    const w = (W) => {
      if (W.ctrlKey || W.metaKey) {
        ...
        const X = document.activeElement === h.current, le = document.activeElement === d.current, ge = document.activeElement?.tagName === "INPUT" || document.activeElement?.tagName === "TEXTAREA" || document.activeElement?.isContentEditable === !1;
        if (X || le || !ge)
          switch (W.key) {
            case "+":
            case "=":
  ...
  const _n = I(() => {
    !d.current || !h.current || U.current || (j.current && clearTimeout(j.current), j.current = setTimeout(() => {
      if (U.current) {
        j.current = null;
        return;
      }
      const w = ee(d);
      w !== L && w >= 0 && l.setActivePage(w), j.current = null;
    }, SCROLL_DEBOUNCE));
  }, [ee, L, l]), wn = ve(() => {
    if (!v) return 0;
    const W = v.replace(/<[^>]*>/g, " ").match(new RegExp("\\p{L}+", "gu"));
    return W ? W.length : 0;
  }, [v]), Sn = _.length || 1, Rn = I((w) => {
    re(!0), O(w);
  }, []), kt = I(() => {
    re(!1), O(null);
  }, []), kn = I((w, W) => {
  ...
  return ie(() => () => {
    ...
    /* @__PURE__ */ m.jsxs("div", { className: "editor-container", children: [
      ...
      f && /* @__PURE__ */ m.jsx("div", { className: "page-manager-sidebar", children: e ? qe.cloneElement(e, {
        onNavigate: Pt,
        onAddPage: _t,
        onDeletePage: wt,
        onPageSizeChange: xt,
