...
}, ka = (e) => Object.keys(ve).includes(e), Oa = () => Object.keys(ve), Re = Xt, Ee = "<p><br></p>", qn = "continuous", Se = (e, t = Re) => ({
  id: pt(),
  index: e,
  size: t,
  content: Ee,
...
}, Qt = On(null), Ca = ({ children: e, initialState: t = {} }) => {
...
const x = /* @__PURE__ */ jn(er), on = {
  ...
  // 72 pt ≈ 96 px
], We = "16px", nr = (e) => Math.round(e * 96 / 72), rr = (e) => Math.round(e * 72 / 96 * 2) / 2, Ma = (e) => {
...
const xa = 50, tt = 50, Aa = 50, Pa = 100, _a = 300, vt = ft(({
