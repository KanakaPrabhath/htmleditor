...
function Bn() {
  return Ot || (Ot = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function r(c) {
      ...
      if (R) {
        R = console;
        var C = R.error, I = typeof Symbol == "function" && Symbol.toStringTag && c[Symbol.toStringTag] || c.constructor.name || "Object";
        return C.call(
          R,
    ...
    function f(c, R, C, I, Y, W) {
      ...
      if (q.call(R, "key")) {
        ...
        I = 0 < F.length ? "{key: someKey, " + F.join(": ..., ") + ": ...}" : "{key: someKey}", E[j + I] || (F = 0 < F.length ? "{" + F.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (j = null, C !== void 0 && (r(C), j = "" + C), o(R) && (r(R.key), j = "" + R.key), "key" in R) {
        C = {};
        for (var V in R)
          V !== "key" && (C[V] = R[V]);
      } else C = R;
    ...
    var A = qe, P = Symbol.for("react.transitional.element"), v = Symbol.for("react.portal"), M = Symbol.for("react.fragment"), b = Symbol.for("react.strict_mode"), w = Symbol.for("react.profiler"), O = Symbol.for("react.consumer"), _ = Symbol.for("react.context"), u = Symbol.for("react.forward_ref"), m = Symbol.for("react.suspense"), g = Symbol.for("react.suspense_list"), T = Symbol.for("react.memo"), N = Symbol.for("react.lazy"), U = Symbol.for("react.activity"), D = Symbol.for("react.client.reference"), z = A.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, q = Object.prototype.hasOwnProperty, H = Array.isArray, oe = console.createTask ? console.createTask : function() {
      return null;
    };
    A = {
    ...
    var Q, Z = {}, G = A.react_stack_bottom_frame.bind(
      A,
      a
    )(), ae = oe(n(a)), E = {};
    _e.Fragment = M, _e.jsx = function(c, R, C) {
...
`) || Te : e.continuousContent && e.continuousContent !== Te && (a = [{ ...we(0, e.pageSize), content: e.continuousContent }]), {
  ...
  const [r, n] = Cn(lt, ct(t)), i = Se(() => ({
    initializeDocument: (o) => n({ type: $.INITIALIZE_DOCUMENT, payload: o }),
    updateTitle: (o) => n({ type: $.UPDATE_TITLE, payload: o }),
    updatePageContent: (o) => n({ type: $.UPDATE_PAGE_CONTENT, payload: o }),
    updatePages: (o) => n({ type: $.UPDATE_PAGES, payload: o }),
    addPage: (o) => n({ type: $.ADD_PAGE, payload: o }),
    deletePage: (o) => n({ type: $.DELETE_PAGE, payload: o }),
    setActivePage: (o) => n({ type: $.SET_ACTIVE_PAGE, payload: o }),
    updatePageSize: (o) => n({ type: $.UPDATE_PAGE_SIZE, payload: o }),
    resetDocument: () => n({ type: $.RESET_DOCUMENT }),
    updateContinuousContent: (o) => n({ type: $.UPDATE_CONTINUOUS_CONTENT, payload: o }),
    updatePageBoundaries: (o) => n({ type: $.UPDATE_PAGE_BOUNDARIES, payload: o }),
    addPageBreak: (o) => n({ type: $.ADD_PAGE_BREAK, payload: o }),
    removePageBreak: (o) => n({ type: $.REMOVE_PAGE_BREAK, payload: o }),
    setEditorMode: (o) => n({ type: $.SET_EDITOR_MODE, payload: o }),
    insertPageAt: (o) => n({ type: $.INSERT_PAGE_AT, payload: o }),
    movePageTo: (o) => n({ type: $.MOVE_PAGE_TO, payload: o }),
    duplicatePage: (o) => n({ type: $.DUPLICATE_PAGE, payload: o }),
    setZoomLevel: (o) => n({ type: $.SET_ZOOM_LEVEL, payload: o }),
    zoomIn: () => n({ type: $.ZOOM_IN }),
    zoomOut: () => n({ type: $.ZOOM_OUT }),
    resetZoom: () => n({ type: $.RESET_ZOOM }),
    updatePageMargins: (o) => n({ type: $.UPDATE_PAGE_MARGINS, payload: o }),
    // Undo/Redo actions
    ...
    undo: () => n({ type: $.UNDO }),
    redo: () => n({ type: $.REDO }),
    clearUndoRedo: () => n({ type: $.CLEAR_UNDO_REDO })
  }), []), a = Se(() => ({
    state: r,
    actions: i,
    dispatch: n
...
function qn() {
  ...
  return ee.AsyncMode = h, ee.ConcurrentMode = l, ee.ContextConsumer = s, ee.ContextProvider = o, ee.Element = t, ee.ForwardRef = f, ee.Fragment = n, ee.Lazy = P, ee.Memo = A, ee.Portal = r, ee.Profiler = a, ee.StrictMode = i, ee.Suspense = p, ee.isAsyncMode = function(u) {
    return _(u) || O(u) === h;
    ...
    return typeof u == "string" || typeof u == "function" || u === n || u === l || u === a || u === i || u === p || u === d || typeof u == "object" && u !== null && (u.$$typeof === P || u.$$typeof === A || u.$$typeof === o || u.$$typeof === s || u.$$typeof === f || u.$$typeof === M || u.$$typeof === b || u.$$typeof === w || u.$$typeof === v);
  }, ee.typeOf = O, ee;
}
var te = {};
/** @license React v16.13.1
...
function Zn() {
  return Nt || (Nt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function O(k) {
      ...
      k === n || k === l || k === a || k === i || k === p || k === d || typeof k == "object" && k !== null && (k.$$typeof === P || k.$$typeof === A || k.$$typeof === o || k.$$typeof === s || k.$$typeof === f || k.$$typeof === M || k.$$typeof === b || k.$$typeof === w || k.$$typeof === v);
    }
    function _(k) {
    ...
    var u = h, m = l, g = s, T = o, N = t, U = f, D = n, z = P, q = A, H = r, oe = a, Q = i, Z = p, G = !1;
    function ae(k) {
      return G || (G = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), E(k) || _(k) === h;
    }
    function E(k) {
      return _(k) === l;
    }
    ...
    te.AsyncMode = u, te.ConcurrentMode = m, te.ContextConsumer = g, te.ContextProvider = T, te.Element = N, te.ForwardRef = U, te.Fragment = D, te.Lazy = z, te.Memo = q, te.Portal = H, te.Profiler = oe, te.StrictMode = Q, te.Suspense = Z, te.isAsyncMode = ae, te.isConcurrentMode = E, te.isContextConsumer = c, te.isContextProvider = R, te.isElement = C, te.isForwardRef = I, te.isFragment = Y, te.isLazy = W, te.isMemo = j, te.isPortal = F, te.isProfiler = V, te.isStrictMode = K, te.isSuspense = ie, te.isValidElementType = O, te.typeOf = _;
  })()), te;
}
var It;
function nn() {
  ...
  return Qe = function(s, h) {
    ...
    function M(E) {
      ...
      function C(Y, W, j, F, V, K, ie) {
        ...
        return W[j] == null ? Y ? W[j] === null ? new v("The " + V + " `" + K + "` is marked as required " + ("in `" + F + "`, but its value is `null`.")) : new v("The " + V + " `" + K + "` is marked as required in " + ("`" + F + "`, but its value is `undefined`.")) : null : E(W, j, F, V, K);
      }
      var I = C.bind(null, !1);
      return I.isRequired = C.bind(null, !0), I;
    }
    function b(E) {
      function c(R, C, I, Y, W, j) {
        var F = R[C], V = Q(F);
        if (V !== E) {
          var K = Z(F);
          return new v(
    ...
    function _() {
      function E(c, R, C, I, Y) {
        var W = c[R];
        if (!s(W)) {
          var j = Q(W);
          return new v("Invalid " + I + " `" + Y + "` of type " + ("`" + j + "` supplied to `" + C + "`, expected a single ReactElement."));
        }
        return null;
      }
      return M(E);
    ...
    function u() {
      function E(c, R, C, I, Y) {
        ...
        if (!e.isValidElementType(W)) {
          var j = Q(W);
          return new v("Invalid " + I + " `" + Y + "` of type " + ("`" + j + "` supplied to `" + C + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return M(E);
    ...
    function m(E) {
      function c(R, C, I, Y, W) {
        if (!(R[C] instanceof E)) {
          var j = E.name || d, F = ae(R[C]);
          return new v("Invalid " + Y + " `" + W + "` of type " + ("`" + F + "` supplied to `" + I + "`, expected ") + ("instance of `" + j + "`."));
        }
        return null;
      }
      return M(c);
    ...
    function g(E) {
      ...
      function c(R, C, I, Y, W) {
        for (var j = R[C], F = 0; F < E.length; F++)
          if (P(j, E[F]))
            return null;
        var V = JSON.stringify(E, function(ie, k) {
          var ce = Z(k);
          return ce === "symbol" ? String(k) : k;
        });
        return new v("Invalid " + Y + " `" + W + "` of value `" + String(j) + "` " + ("supplied to `" + I + "`, expected one of " + V + "."));
      }
      return M(c);
    }
    function T(E) {
    ...
    function N(E) {
      ...
      for (var c = 0; c < E.length; c++) {
        ...
        if (typeof R != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + G(R) + " at index " + c + "."
          ), o;
      }
      function C(I, Y, W, j, F) {
        for (var V = [], K = 0; K < E.length; K++) {
          var ie = E[K], k = ie(I, Y, W, j, F, r);
          if (k == null)
            return null;
          k.data && n(k.data, "expectedType") && V.push(k.data.expectedType);
        }
        var ce = V.length > 0 ? ", expected one of type [" + V.join(", ") + "]" : "";
        return new v("Invalid " + j + " `" + F + "` supplied to " + ("`" + W + "`" + ce + "."));
      }
      return M(C);
    }
    function U() {
      function E(c, R, C, I, Y) {
        return H(c[R]) ? null : new v("Invalid " + I + " `" + Y + "` supplied to " + ("`" + C + "`, expected a ReactNode."));
      }
      return M(E);
    }
    function D(E, c, R, C, I) {
      return new v(
        (E || "React class") + ": " + c + " type `" + R + "." + C + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + I + "`."
      );
    }
    function z(E) {
      function c(R, C, I, Y, W) {
        ...
        for (var V in E) {
          ...
          if (typeof K != "function")
            return D(I, Y, W, V, Z(K));
          var ie = K(j, V, I, Y, W + "." + V, r);
          if (ie)
            return ie;
        }
        return null;
...
function Ca({
  ...
  if (s.preserveAspectRatio && s.aspectRatio) {
    ...
    [
      ...
      S.BOTTOM_LEFT,
      S.BOTTOM_RIGHT
    ].includes(e) ? f / d > p ? p = Math.max(s.minHeight, f / d) : f = Math.max(s.minWidth, p * d) : [S.TOP, S.BOTTOM].includes(e) ? f = p * d : [S.LEFT, S.RIGHT].includes(e) && (p = f / d);
  }
...
function an(e, t = he) {
  ...
  return r.style.top = `${n.top}px`, r.style.left = `${n.left}px`, r.style.width = `${n.width}px`, r.style.height = `${n.height}px`, Object.values(S).forEach((a) => {
...
const or = {
  ...
  const [e, t] = de(Ft), r = ke(), n = B((b) => {
    try {
      ...
      try {
        ...
        return u.appendChild(m), O.insertNode(u), O.selectNodeContents(u), w.removeAllRanges(), w.addRange(O), t((g) => ({ ...g, fontFamily: b })), !0;
      } catch {
        return document.execCommand("fontName", !1, b), t((m) => ({ ...m, fontFamily: b })), !0;
      }
    } catch (w) {
      return console.warn("[useFormatting] Font family change failed:", w), !1;
    }
  }, []), i = B((b) => {
    try {
      const w = window.getSelection();
      ...
      try {
        ...
        u.style.fontSize = b;
        const m = O.extractContents();
        return u.appendChild(m), O.insertNode(u), O.selectNodeContents(u), w.removeAllRanges(), w.addRange(O), t((g) => ({ ...g, fontSize: b })), !0;
      } catch {
        const m = or[b] || "3";
        return document.execCommand("fontSize", !1, m), t((g) => ({ ...g, fontSize: b })), !0;
      }
    } catch (w) {
      return console.warn("[useFormatting] Font size change failed:", w), !1;
    }
  }, []), a = B((b) => {
    try {
      const w = window.getSelection();
      if (!w || w.rangeCount === 0)
        return !1;
      const O = w.getRangeAt(0), _ = O.toString(), m = {
        justifyLeft: "left",
      ...
      if (!m)
        return !1;
      if (!_) {
        const T = O.startContainer, N = T.nodeType === Node.TEXT_NODE ? T.parentElement : T, U = Ge(N) || sr();
        return U && (U.style.textAlign = m, o(m)), !0;
      }
      const g = ir(O);
      if (g.length === 0) {
        ...
        T.appendChild(N), O.insertNode(T), O.selectNodeContents(T), w.removeAllRanges(), w.addRange(O);
      } else
        g.forEach((T) => {
          T.style.textAlign = m;
        });
      ...
      return console.warn("[useFormatting] Text alignment failed:", w), !1;
    }
  }, []), o = B((b) => {
    t((w) => ({
      ...w,
    ...
    try {
      ...
      switch (document.execCommand(b, !1, w) || console.warn(`[useFormatting] Command "${b}" failed`), b) {
        case "bold":
        case "italic":
        case "underline":
        case "strikethrough":
  ...
  B((b) => {
    ...
    const w = an(b);
    w && (h.current = w, l.current = b, document.body.appendChild(w), t((O) => ({
      ...O,
      imageSelected: !0,
  ...
  const v = B(() => {
    try {
      ...
      if (!b || b.rangeCount === 0)
        return;
      const w = b.getRangeAt(0), O = w.toString();
      let _ = Ze, u = "Arial", m = "p", g = "left";
      if (O) {
        const N = w.startContainer, U = N.nodeType === Node.TEXT_NODE ? N.parentElement : N;
        if (U) {
          const D = window.getComputedStyle(U), z = D.fontSize, q = D.fontFamily;
          z && z.endsWith("px") && (_ = z), q && q !== "serif" && (u = q.split(",")[0].replace(/['"]/g, "").trim());
          const H = Ge(U);
          if (H) {
            const oe = H.tagName?.toLowerCase();
            ["h1", "h2", "h3", "h4", "h5", "h6", "p"].includes(oe) && (m = oe);
            const Z = window.getComputedStyle(H).textAlign;
            ["left", "center", "right", "justify"].includes(Z) && (g = Z);
          }
        }
      }
      const T = {
...
const ye = 'page-break, [data-page-break="true"]', cn = (e) => ue[e] || ue.A4, dr = (e, t = {}) => {
  ...
  try {
    ...
    for (let d = 0; d < l.length; d++) {
      const A = l[d];
      if (A.tagName === "PAGE-BREAK" || A.getAttribute("data-page-break") === "true")
        continue;
      const P = pr(A);
      if (f + P > h) {
        p = A;
    ...
    if (p) {
      ...
      if (A.innerHTML = "<br>", e.appendChild(A), a) {
        const P = e.innerHTML;
        a(P);
      }
      return o && setTimeout(() => {
  ...
  try {
    ...
    if (d && d.parentNode && d.remove(), p.forEach((P) => {
      P.parentNode && P.remove();
    }), e.querySelectorAll(ye).forEach((P, v) => {
      P.setAttribute("data-page-number", String(v + 2));
    }), f && a && setTimeout(() => {
      a(0);
    }, 50), n) {
      const P = e.innerHTML;
  ...
  try {
    ...
    for (let d = 0; d < l.length && p < Gt; d++) {
      const A = l[d], P = xr(A, h);
      if (P && P.overflowIndex > 0) {
        let v = 0;
        for (let O = 0; O < A.length; O++) {
          const _ = A[O];
          _ && _.getBoundingClientRect && (v += un(_));
        }
        if (v - h < vr)
          continue;
        const b = d + 2;
        gr(P.overflowElement, b) && (f = !0, p++, l = Ut(e));
      }
    }
    if (f) {
      if (i) {
  ...
  const p = B((m = {}) => t?.current ? dr(t.current, m) : [], [t]), d = B((m = {}) => {
    ...
    Rr(d, a, m, g);
  }, [d]), b = B((m) => !m?.current || !t?.current ? 0 : fr(m.current, t.current), [t]), w = B((m) => {
    ...
    wr(g.current, t.current, m, w);
  }, [t, w]), _ = B((m) => t?.current ? mr(
    t.current,
    m,
    p,
    i.updateContinuousContent,
    ...
    w,
    P
  ) : !1, [t, p, i, d, w, P]), u = B((m) => t?.current ? Er(
    m,
    t.current,
    i.updateContinuousContent,
    d,
...
function Ir(e) {
  return new Promise((t, r) => {
    ...
    i.onload = async (a) => {
      ...
      try {
        const l = await Ce(), f = `editor-image-${Nr()}`, d = l.transaction([fe], "readwrite").objectStore(fe), A = {
          key: f,
          dataUrl: o,
          size: h,
          type: e.type,
...
const ea = [
  ...
  se(() => {
    ...
    const P = [];
    a.forEach((v, M) => {
      A += na(v.content), P.push(...qt(v.content, M + 1, `page-${M}-`));
    }), l(A), p(P);
  }, [a, r, n, s]);
      ...
      children: [
        ...
        !e && /* @__PURE__ */ y.jsxs("div", { className: "sidebar-content", children: [
          ...
          f.length > 0 && /* @__PURE__ */ y.jsxs("div", { className: "sidebar-section", children: [
            ...
            /* @__PURE__ */ y.jsx("div", { className: "document-outline", "data-testid": "outline", children: f.map((A) => {
              const P = A.level === 1 ? io : A.level === 2 ? co : uo;
              return /* @__PURE__ */ y.jsxs(
                "div",
                {
                  className: `outline-item outline-level-${A.level}`,
                  style: { marginLeft: `${(A.level - 1) * 12}px` },
                  children: [
                    /* @__PURE__ */ y.jsx(P, { size: 12, className: "outline-icon" }),
                    /* @__PURE__ */ y.jsx("span", { className: "outline-text", children: A.text }),
...
const ua = [
  ...
  const a = async (l) => {
    try {
      ...
      if (d) {
        const P = `<img src="${d}" data-key="${p}" alt="Inserted image" />`;
        document.execCommand("insertHTML", !1, P), Zt.info("Image inserted", { key: p });
      }
      const A = document.getElementById("image-upload");
      A && (A.value = "");
    } catch (f) {
...
const Ee = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && Ee(e.parentElement) : !1, mt = ({
  ...
  const p = Se(() => Kt(f), [f]), d = l / 100, A = B((_, u) => {
    if (!_) return !1;
    const m = _.getBoundingClientRect(), g = u - m.top;
    return g < p.top || g > m.height - p.bottom;
  }, [p.top, p.bottom]), P = B((_, u) => {
    u.preventDefault();
    const m = _.getBoundingClientRect(), g = u.clientX - m.left, T = u.clientY - m.top, N = m.width - 40, U = -12, D = m.width - 20;
    g >= N && g <= D && T >= U && T <= 8 && h && h(_);
  }, [h]), v = B((_) => {
    _.preventDefault();
...
const ya = Mn(mt), yt = ({
  ...
  const v = Math.max(e?.length || 0, 1), M = (u) => {
    s && s(u);
  }, b = () => {
    h && h();
  }, w = (u) => {
  ...
  return /* @__PURE__ */ y.jsxs("div", { className: "page-manager", children: [
    ...
    /* @__PURE__ */ y.jsx("div", { className: "page-list", children: (e && e.length > 0 ? e : [{ id: "page-0", pageNumber: 1 }]).map((u, m) => /* @__PURE__ */ y.jsxs("div", { className: "page-item", children: [
      /* @__PURE__ */ y.jsxs(
        "button",
        {
          type: "button",
...
const Ea = qe.memo(yt), Et = ({
  ...
  const d = B((g) => {
    ...
    T && (a.current = T, o.current = g, document.body.appendChild(T), T.querySelectorAll(".resize-handler").forEach((U) => {
    ...
    const T = g.currentTarget.dataset.handler, N = o.current.getBoundingClientRect(), U = window.pageYOffset || document.documentElement.scrollTop, D = window.pageXOffset || document.documentElement.scrollLeft;
    s.current = {
      x: g.clientX,
      y: g.clientY,
      ...
      offsetX: g.clientX - N.left - D,
      offsetY: g.clientY - N.top - U
    }, h.current = T, f.current = !0, document.body.classList.add("resize-in-progress"), document.body.style.cursor = _(T), document.addEventListener("mousemove", v), document.addEventListener("mouseup", M);
  }, []), v = B((g) => {
    if (!f.current || !o.current || !s.current || !h.current) return;
    g.preventDefault(), g.stopPropagation();
    const { x: T, y: N, width: U, height: D } = s.current, z = h.current, q = g.clientX, H = g.clientY, oe = u({
      handler: z,
      startX: T,
      startY: N,
      currentX: q,
    ...
    m(o.current, oe), a.current && Ue(a.current, o.current);
  }, []), M = B((g) => {
    if (f.current) {
      ...
      if (s.current = null, h.current = null, f.current = !1, document.removeEventListener("mousemove", v), document.removeEventListener("mouseup", M), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = "", o.current) {
    ...
    a.current && !a.current.contains(g.target) && A();
    const T = g.target;
    if (pe(T)) {
      if (T === o.current)
        return;
    ...
    if ((g.key === "Delete" || g.key === "Backspace") && o.current && !f.current) {
      ...
      const T = o.current;
      if (T.parentNode) {
        T.parentNode.removeChild(T), A();
        const N = new Event("input", { bubbles: !0, cancelable: !0 });
        e.current.dispatchEvent(N);
      }
    }
    if (g.key === "Escape" && o.current && A(), o.current && !f.current) {
  ...
  se(() => {
    ...
    if (!e.current) return;
    const g = e.current;
    g.addEventListener("click", b), g.addEventListener("keydown", w);
    const T = g.closest(".editor-viewport");
    return T && T.addEventListener("scroll", O), window.addEventListener("resize", O), () => {
      g.removeEventListener("click", b), g.removeEventListener("keydown", w), T && T.removeEventListener("scroll", O), window.removeEventListener("resize", O), f.current && (document.removeEventListener("mousemove", v), document.removeEventListener("mouseup", M), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = ""), a.current && ve(a.current);
    };
  }, [e, b, w, O, v, M]), se(() => {
    if (!e.current) return;
    const g = new MutationObserver((T) => {
      T.forEach((N) => {
        N.type === "childList" && (N.removedNodes.length > 0 && N.removedNodes.forEach((U) => {
          U.nodeType === Node.ELEMENT_NODE && pe(U) && U === o.current && A();
        }), N.addedNodes.length > 0 && N.addedNodes.forEach((U) => {
          if (U.nodeType === Node.ELEMENT_NODE)
            if (pe(U))
              ...
              const D = U.querySelectorAll ? U.querySelectorAll("img") : [];
              D.length > 0 && setTimeout(() => {
                d(D[0]);
              }, 50);
            }
        }));
  ...
  function u({
    ...
    switch (g) {
      case S.TOP_LEFT:
        Z = Math.max(H.minWidth, z - oe), G = Math.max(H.minHeight, q - Q);
        break;
      case S.TOP_RIGHT:
        Z = Math.max(H.minWidth, z + oe), G = Math.max(H.minHeight, q - Q);
        break;
      ...
      case S.BOTTOM_RIGHT:
        ...
        break;
      case S.TOP:
        G = Math.max(H.minHeight, q - Q);
        break;
      case S.BOTTOM:
        G = Math.max(H.minHeight, q + Q);
        break;
      case S.LEFT:
        Z = Math.max(H.minWidth, z - oe);
        break;
      case S.RIGHT:
        Z = Math.max(H.minWidth, z + oe);
        break;
      default:
        return { width: Z, height: G };
    }
    if (H.preserveAspectRatio && H.aspectRatio) {
      ...
      [
        ...
        S.BOTTOM_LEFT,
        S.BOTTOM_RIGHT
      ].includes(g) ? Z / ae > G ? G = Math.max(H.minHeight, Z / ae) : Z = Math.max(H.minWidth, G * ae) : [S.TOP, S.BOTTOM].includes(g) ? Z = G * ae : [S.LEFT, S.RIGHT].includes(g) && (G = Z / ae);
    }
    return H.maxWidth && Z > H.maxWidth && (Z = H.maxWidth, H.preserveAspectRatio && H.aspectRatio && (G = Z / (z / q))), H.maxHeight && G > H.maxHeight && (G = H.maxHeight, H.preserveAspectRatio && H.aspectRatio && (Z = G * (z / q))), Z = Math.max(H.minWidth, Z), G = Math.max(H.minHeight, G), {
      width: Math.round(Z),
      height: Math.round(G)
    };
  }
...
const Tt = ({
  ...
  const [o, s] = de({ top: 0, left: 0 }), [h, l] = de(!1), [f, p] = de("top"), [d, A] = de(a), P = re(null), v = re(null), M = ke(), b = (D) => {
    if (!D)
      return;
    ...
    if (!D) return null;
    const z = window.getComputedStyle(D);
    return {
      float: z.float || "none",
      margin: D.style.margin || "",
      display: z.display || "inline",
      width: D.style.width || D.width || "",
      height: D.style.height || D.height || "",
      aspectRatio: d
    };
  }, O = () => {
    if (!e) return "left";
    const D = window.getComputedStyle(e);
    return D.float || D.display === "block" ? "left" : D.display === "flex" && D.justifyContent === "center" ? "center" : D.float === "right" ? "right" : "left";
  }, [_, u] = de(O());
  se(() => () => {
  }, [e]), se(() => {
    if (e) {
      let D = e.closest(".editor-viewport") || e.closest(".continuous-scroll");
      D && (v.current = D);
    }
  }, [e]), Nn(() => {
    if (!e || !P.current) return;
    const D = () => {
      const q = e.getBoundingClientRect(), H = P.current.getBoundingClientRect();
      v.current;
      const oe = window.visualViewport ? window.visualViewport : {
        width: window.innerWidth,
        height: window.innerHeight
      }, Q = q.bottom >= 0 && q.top <= oe.height && q.right >= 0 && q.left <= oe.width;
      let Z = "top", G = 0, ae = 0;
      if (Q) {
        const I = q.top - H.height - 10, Y = oe.height - q.bottom - H.height - 10;
        Y > I && Y > 0 ? (Z = "bottom", G = q.bottom + 10) : (Z = "top", G = q.top - H.height - 10);
      } else
        Z = "top", G = 10;
      ae = q.left + q.width / 2 - H.width / 2;
      const E = window.innerWidth, c = window.innerHeight;
      let R = ae, C = G;
      ae < 10 ? R = 10 : ae + H.width > E - 10 && (R = E - H.width - 10), G < 10 ? C = 10 : G + H.height > c - 10 && (C = c - H.height - 10), s({
        top: C,
        left: R
      }), p(Z), l(!0);
    };
    ...
    return v.current && v.current.addEventListener("scroll", z), window.addEventListener("scroll", z), window.addEventListener("resize", z), () => {
      v.current && v.current.removeEventListener("scroll", z), window.removeEventListener("scroll", z), window.removeEventListener("resize", z), l(!1);
    };
  }, [e]), se(() => {
    const D = (z) => {
      P.current && !P.current.contains(z.target) && z.target !== e && i();
    };
  ...
  const m = () => {
    if (e) {
      const D = w(e);
      e.style.float = "left", e.style.margin = "0 10px 10px 0", e.style.display = "block", u("left"), b(e);
      const z = w(e);
      M.recordOperation(
        { type: "IMAGE_ALIGN", payload: { element: e, alignment: "left", state: z } },
        { type: "IMAGE_ALIGN", payload: { element: e, alignment: O(), state: D } }
      ), t && t("left");
    }
  }, g = () => {
    if (e) {
      const D = w(e);
      e.style.float = "none", e.style.margin = "10px auto", e.style.display = "block", u("center"), b(e);
      const z = w(e);
      M.recordOperation(
    ...
    if (e) {
      const D = w(e);
      e.style.float = "right", e.style.margin = "0 0 10px 10px", e.style.display = "block", u("right"), b(e);
      const z = w(e);
      M.recordOperation(
    ...
    if (e && e.parentNode) {
      ...
      M.recordOperation(
        ...
        { type: "IMAGE_REINSERT", payload: { state: D } }
      ), e.parentNode.removeChild(e), n && n(), i();
    }
  }, U = () => {
    const D = d, z = !d;
    A(z), M.recordOperation(
...
const Ta = 50, tt = 50, Yt = 50, ba = 100, va = 500, Vt = "UPDATE_CONTINUOUS_CONTENT", bt = dt(({
  ...
  const p = tn(), d = ke(), { pageSize: A, pageMargins: P, continuousContent: v, pageBoundaries: M, activePage: b, zoomLevel: w, canUndo: O, canRedo: _ } = p, u = re(null), m = re(null), { currentFormat: g, formatText: T, updateCurrentFormatFromSelection: N } = ar(), [U, D] = de(!1), [z, q] = de(null), [H, oe] = de(!0), Q = re(null), {
  ...
  } = kr(A, m, w, P), Y = Se(() => pt(A), [A]), [W, j] = de(!1), F = re(null), V = re(!1), K = re(!1), ie = re(!1), k = re(v);
  se(() => {
    if (m.current) {
      if (!ie.current) {
        m.current.innerHTML = v, ie.current = !0, k.current = v;
        const L = setTimeout(() => {
          E();
        }, Ta);
      ...
      if (k.current !== v) {
        if (m.current.innerHTML !== v) {
          ...
          const J = setTimeout(() => {
            if (E(), V.current) {
              V.current = !1;
              const ne = Math.max(0, M.length - 1);
              d.setActivePage(ne), setTimeout(() => {
                ae(ne, u);
              }, Yt);
            }
          }, tt);
          return k.current = v, () => clearTimeout(J);
        }
        k.current = v;
      }
    }
  }, [v, E, M.length, d, ae]), se(() => {
    o && ie.current && o(v);
  }, [v, o]), In(f, () => ({
    /**
    ...
    setContent: (L) => {
      const J = $e(L);
      J !== v && d.updateContinuousContent(J), m.current && m.current.innerHTML !== J && (m.current.innerHTML = J), k.current = J, m.current && setTimeout(() => {
        E();
      }, tt);
    },
    /**
    ...
    insertContent: (L) => {
      ...
      const J = $e(L), ne = window.getSelection();
      let le = !1;
      ...
      d.updateContinuousContent(me), k.current = me, setTimeout(() => {
        E(), c(200);
      }, tt);
    }
  }), [v, d, E, m, Q, Z]), se(() => {
    const L = () => {
      if (N(), m.current) {
        ...
        if (ne.rangeCount > 0) {
          ...
          le.collapsed && m.current.contains(le.commonAncestorContainer) && (Q.current = le.cloneRange());
        }
      }
    };
    document.addEventListener("selectionchange", L);
    const J = () => {
      if (setTimeout(N, 10), Q.current && m.current)
        try {
          const ne = window.getSelection();
          ne.removeAllRanges(), ne.addRange(Q.current);
        } catch (ne) {
    ...
    return m.current && m.current.addEventListener("focus", J), () => {
      document.removeEventListener("selectionchange", L), m.current && m.current.removeEventListener("focus", J);
    };
  }, [N]);
  const ce = B(() => {
    if (!m.current) return;
    let L = m.current.innerHTML;
    L = $e(L), L !== m.current.innerHTML && (m.current.innerHTML = L);
    const J = v;
    if (J !== L) {
      const le = {
        type: Vt,
    ...
    d.updateContinuousContent(L), Z(), c(200);
    const ne = G(u);
    ne !== b && d.setActivePage(ne);
  }, [d, Z, G, b, c, u, m, v]), be = B((L) => {
    ce();
  }, [ce]), xe = B((L) => {
    d.updatePageSize(L), E({ pageSize: L }), i && i(L);
  }, [d, E, i]), vt = B((L) => {
    d.updatePageMargins(L), E({ pageMargins: L }), a && a(L);
  }, [d, E, a]), xt = B((L) => {
    L < 0 || L >= M.length || (K.current = !0, d.setActivePage(L), ae(L, u), setTimeout(() => {
      K.current = !1;
    }, va), t && t(L));
  }, [d, ae, t, M.length]), At = B(() => {
    const L = M.length + 1;
  ...
  const Pn = B(() => {
    !u.current || !m.current || K.current || (F.current && clearTimeout(F.current), F.current = setTimeout(() => {
      if (K.current) {
        F.current = null;
        return;
      }
      const L = G(u);
      L !== b && L >= 0 && d.setActivePage(L), F.current = null;
    }, ba));
  }, [G, b, d]), _n = Se(() => {
    if (!v) return 0;
    const J = v.replace(/<[^>]*>/g, " ").match(new RegExp("\\p{L}+", "gu"));
    return J ? J.length : 0;
  }, [v]), wn = M.length || 1, Rn = B((L) => {
    D(!0), q(L);
  }, []), Rt = B(() => {
    D(!1), q(null);
  }, []), Sn = B((L, J) => {
    ...
    /* @__PURE__ */ y.jsxs("div", { className: "editor-container", children: [
      ...
      U && z && /* @__PURE__ */ y.jsx(
        Tt,
        {
          ...
          onDelete: () => {
            if (z) {
              const L = z.getAttribute("data-key");
              L && Dr(L).catch((J) => {
