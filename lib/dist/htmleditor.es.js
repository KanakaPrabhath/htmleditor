import qe, { createContext as On, useContext as Cn, useReducer as Mn, useMemo as be, useState as ue, useCallback as L, useRef as J, useEffect as ae, forwardRef as ft, createElement as nt, memo as Nn, useLayoutEffect as In, useImperativeHandle as Ln } from "react";
...
function Hn() {
  return Ct || (Ct = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function r(u) {
      ...
      if (A) {
        A = console;
        var R = A.error, w = typeof Symbol == "function" && Symbol.toStringTag && u[Symbol.toStringTag] || u.constructor.name || "Object";
        return R.call(
          A,
    ...
    function p(u, A, R, w, z, H) {
      ...
      if (k.call(A, "key")) {
        ...
        w = 0 < j.length ? "{key: someKey, " + j.join(": ..., ") + ": ...}" : "{key: someKey}", E[C + w] || (j = 0 < j.length ? "{" + j.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    var b = qe, T = Symbol.for("react.transitional.element"), v = Symbol.for("react.portal"), _ = Symbol.for("react.fragment"), M = Symbol.for("react.strict_mode"), D = Symbol.for("react.profiler"), N = Symbol.for("react.consumer"), y = Symbol.for("react.context"), d = Symbol.for("react.forward_ref"), m = Symbol.for("react.suspense"), O = Symbol.for("react.suspense_list"), G = Symbol.for("react.memo"), V = Symbol.for("react.lazy"), ie = Symbol.for("react.activity"), re = Symbol.for("react.client.reference"), ne = b.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, k = Object.prototype.hasOwnProperty, F = Array.isArray, te = console.createTask ? console.createTask : function() {
      return null;
    };
    b = {
    ...
    _e.Fragment = _, _e.jsx = function(u, A, R) {
      var w = 1e4 > ne.recentlyCreatedOwnerStacks++;
      return p(
        u,
        A,
        R,
...
var h = zn();
const rt = 100, ot = 50, at = 200, Nt = 5, st = (e) => e < at, it = (e) => e > ot, $n = 96, De = (e) => Math.round(e * $n), Ue = {
  NORMAL: {
    name: "Normal",
    label: 'Normal (1")',
    top: 1,
...
}, wa = (e) => Object.keys(ve).includes(e), Ra = () => Object.keys(ve), Re = Xt, Ee = "<p><br></p>", qn = "continuous", Se = (e, t = Re) => ({
  id: pt(),
  index: e,
  size: t,
  content: Ee,
  images: [],
  isBreakPoint: !1
}), ze = (e) => typeof e != "string" || e.trim() === "" ? Ee : e, Jt = (e, t = Re) => (e.length > 0 ? e : [Se(0, t)]).map((n, s) => ({
  id: n.id || pt(),
  index: s,
  size: n.size || t,
  ...
  const t = (/* @__PURE__ */ new Date()).toISOString(), r = e.pageSize || Re, n = Jt(e.pages || [Se(0, r)], r);
  return {
    id: pt(),
  ...
  switch (t.type) {
    case B.INITIALIZE_DOCUMENT: {
      const { initialContent: n = Ee, pageSize: s = Re } = t.payload || {}, a = { ...Se(0, s), content: ze(n) };
      return ct({
        title: e.title,
        pageSize: s,
        pages: [a]
...
`) || Ee : e.continuousContent && e.continuousContent !== Ee && (a = [{ ...Se(0, e.pageSize), content: e.continuousContent }]), {
        ...e,
        editorMode: n,
        continuousContent: s,
        pages: a,
...
function Zn() {
  ...
  return Z.AsyncMode = g, Z.ConcurrentMode = f, Z.ContextConsumer = i, Z.ContextProvider = o, Z.Element = t, Z.ForwardRef = p, Z.Fragment = n, Z.Lazy = T, Z.Memo = b, Z.Portal = r, Z.Profiler = a, Z.StrictMode = s, Z.Suspense = c, Z.isAsyncMode = function(d) {
    return y(d) || N(d) === g;
    ...
    return typeof d == "string" || typeof d == "function" || d === n || d === f || d === a || d === s || d === c || d === l || typeof d == "object" && d !== null && (d.$$typeof === T || d.$$typeof === b || d.$$typeof === o || d.$$typeof === i || d.$$typeof === p || d.$$typeof === _ || d.$$typeof === M || d.$$typeof === D || d.$$typeof === v);
  }, Z.typeOf = N, Z;
}
var Y = {};
/** @license React v16.13.1
...
function Yn() {
  return Lt || (Lt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function N(P) {
      ...
      P === n || P === f || P === a || P === s || P === c || P === l || typeof P == "object" && P !== null && (P.$$typeof === T || P.$$typeof === b || P.$$typeof === o || P.$$typeof === i || P.$$typeof === p || P.$$typeof === _ || P.$$typeof === M || P.$$typeof === D || P.$$typeof === v);
    }
    function y(P) {
    ...
    var d = g, m = f, O = i, G = o, V = t, ie = p, re = n, ne = T, k = b, F = r, te = a, K = s, Q = c, ee = !1;
    function se(P) {
...
function Xn() {
  if ($t) return Je;
  $t = 1;
  var e = nn(), t = Vn(), r = /* @__PURE__ */ ht(), n = /* @__PURE__ */ rn(), s = /* @__PURE__ */ Kn(), a = function() {
  };
  ...
  return Je = function(i, g) {
    ...
    function M(E) {
      function u(A, R, w, z, H, C) {
        var j = A[R], U = K(j);
        if (U !== E) {
          var $ = Q(j);
          return new v(
            "Invalid " + z + " `" + H + "` of type " + ("`" + $ + "` supplied to `" + w + "`, expected ") + ("`" + E + "`."),
            { expectedType: E }
          );
        }
        return null;
    ...
    function N(E) {
      function u(A, R, w, z, H) {
        if (typeof E != "function")
          return new v("Property `" + H + "` of component `" + w + "` has invalid PropType notation inside arrayOf.");
        var C = A[R];
        if (!Array.isArray(C)) {
          var j = K(C);
          return new v("Invalid " + z + " `" + H + "` of type " + ("`" + j + "` supplied to `" + w + "`, expected an array."));
        }
    ...
    function y() {
      function E(u, A, R, w, z) {
        var H = u[A];
        if (!i(H)) {
          var C = K(H);
          return new v("Invalid " + w + " `" + z + "` of type " + ("`" + C + "` supplied to `" + R + "`, expected a single ReactElement."));
        }
        return null;
      }
      return _(E);
    ...
    function d() {
      function E(u, A, R, w, z) {
        ...
        if (!e.isValidElementType(H)) {
          var C = K(H);
          return new v("Invalid " + w + " `" + z + "` of type " + ("`" + C + "` supplied to `" + R + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return _(E);
    ...
    function m(E) {
      function u(A, R, w, z, H) {
        if (!(A[R] instanceof E)) {
          ...
          return new v("Invalid " + z + " `" + H + "` of type " + ("`" + j + "` supplied to `" + w + "`, expected ") + ("instance of `" + C + "`."));
        }
        return null;
      }
      return _(u);
    ...
    function O(E) {
      ...
      function u(A, R, w, z, H) {
        ...
        return new v("Invalid " + z + " `" + H + "` of value `" + String(C) + "` " + ("supplied to `" + w + "`, expected one of " + U + "."));
      }
      return _(u);
    }
    function G(E) {
      function u(A, R, w, z, H) {
        if (typeof E != "function")
          return new v("Property `" + H + "` of component `" + w + "` has invalid PropType notation inside objectOf.");
        var C = A[R], j = K(C);
        if (j !== "object")
          return new v("Invalid " + z + " `" + H + "` of type " + ("`" + j + "` supplied to `" + w + "`, expected an object."));
        for (var U in C)
          if (n(C, U)) {
            var $ = E(C, U, w, z, H + "." + U, r);
            if ($ instanceof Error)
    ...
    function V(E) {
      ...
      function R(w, z, H, C, j) {
        for (var U = [], $ = 0; $ < E.length; $++) {
          var oe = E[$], P = oe(w, z, H, C, j, r);
          if (P == null)
            return null;
    ...
    function ie() {
      function E(u, A, R, w, z) {
        return F(u[A]) ? null : new v("Invalid " + w + " `" + z + "` supplied to " + ("`" + R + "`, expected a ReactNode."));
      }
      return _(E);
    }
    function re(E, u, A, R, w) {
      return new v(
        (E || "React class") + ": " + u + " type `" + A + "." + R + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + w + "`."
      );
    }
    function ne(E) {
      function u(A, R, w, z, H) {
        var C = A[R], j = K(C);
        if (j !== "object")
          return new v("Invalid " + z + " `" + H + "` of type `" + j + "` " + ("supplied to `" + w + "`, expected `object`."));
        for (var U in E) {
          var $ = E[U];
          if (typeof $ != "function")
            return re(w, z, H, U, Q($));
          var oe = $(C, U, w, z, H + "." + U, r);
          if (oe)
            return oe;
        }
        return null;
      ...
      function u(A, R, w, z, H) {
        ...
        for (var $ in U) {
          ...
          if (n(E, $) && typeof oe != "function")
            return re(w, z, H, $, Q(oe));
          if (!oe)
            return new v(
              "Invalid " + z + " `" + H + "` key `" + $ + "` supplied to `" + w + "`.\nBad object: " + JSON.stringify(A[R], null, "  ") + `
...
const x = /* @__PURE__ */ jn(er), on = {
  ...
  const [e, t] = ue(Gt), r = ke(), n = L((c, l, b = null) => {
    try {
    ...
    try {
      ...
      if (!_)
        return !1;
      if (!T) {
        const D = b.startContainer, N = D.nodeType === Node.TEXT_NODE ? D.parentElement : D, y = Fe(N) || ir();
...
const he = 'page-break, [data-page-break="true"]', an = (e) => ve[e] || ve.A4, cr = (e, t = {}) => {
  ...
  const n = an(e), s = Un(r), a = n.height - s, o = t / 100;
  return a / o;
}, lr = (e, t) => {
  if (!e || !t)
    return 0;
  ...
  try {
    ...
    }), e.querySelectorAll(he).forEach((T, v) => {
  ...
  const c = L((m = {}) => t?.current ? cr(t.current, m) : [], [t]), l = L((m = {}) => {
    ...
    M,
    T
  ) : !1, [t, c, s, l, M, T]), d = L((m) => t?.current ? hr(
    m,
    t.current,
    s.updateContinuousContent,
    l,
...
const Or = "html-editor-storage", Cr = 1, de = "images";
function Mr() {
...
function Nr(e) {
  return new Promise((t, r) => {
    ...
    s.onload = async (a) => {
      ...
      try {
        const f = await Oe(), p = `editor-image-${Mr()}`, l = f.transaction([de], "readwrite").objectStore(de), b = {
          key: p,
          dataUrl: o,
          size: g,
          type: e.type,
...
function $e(e) {
  ...
  if (!t)
    return "<p><br></p>";
  const r = document.createElement("div");
  return r.innerHTML = t, we(r) || "<p><br></p>";
}
function Hr(e) {
        ...
        !e && /* @__PURE__ */ h.jsxs("div", { className: "sidebar-content", children: [
          ...
          p.length > 0 && /* @__PURE__ */ h.jsxs("div", { className: "sidebar-section", children: [
            ...
            /* @__PURE__ */ h.jsx("div", { className: "document-outline", "data-testid": "outline", children: p.map((b) => {
              const T = b.level === 1 ? ao : b.level === 2 ? io : lo;
              return /* @__PURE__ */ h.jsxs(
                "div",
                {
...
const la = [
  ...
  return /* @__PURE__ */ h.jsxs("div", { className: "editor-toolbar", children: [
    ...
    i(() => t("insertOrderedList"), Po, "Numbered List"),
    g(),
    /* @__PURE__ */ h.jsx(
      "button",
      {
    ...
    i(() => t("insertHTML", da), jo, "Insert Table"),
...
const ye = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && ye(e.parentElement) : !1, yt = ({
  ...
  const c = be(() => Kt(p), [p]), l = f / 100, b = L((y, d) => {
    if (!y) return !1;
...
const bt = ({
  ...
  const l = L((y) => {
    ...
    const { x: d, y: m, width: O, height: G } = i.current, V = g.current, ie = y.clientX, re = y.clientY, ne = ba({
      handler: V,
      startX: d,
      startY: m,
      currentX: ie,
    ...
    const y = new MutationObserver((d) => {
      d.forEach((m) => {
        m.type === "childList" && (m.removedNodes.forEach((O) => {
          O.nodeType === Node.ELEMENT_NODE && ge(O) && O === o.current && b();
...
const Tt = ({
  ...
  const [o, i] = ue({ top: 0, left: 0 }), [g, f] = ue(!1), [p, c] = ue("top"), [l, b] = ue(a), T = J(null), v = J(null), _ = ke(), M = (k) => {
    if (!k)
      return;
  ...
  const m = L(() => {
    ...
    let Q = "top", ee = 0, se = 0;
    if (K) {
      const w = k.top - F.height - 10, z = te.height - k.bottom - F.height - 10;
      z > w && z > 0 ? (Q = "bottom", ee = k.bottom + 10) : (Q = "top", ee = k.top - F.height - 10);
    } else
      Q = "top", ee = 10;
  ...
  In(() => {
    ...
    const k = (F) => {
      T.current && !T.current.contains(F.target) && F.target !== e && s();
    };
...
const xa = 50, tt = 50, Aa = 50, vt = ft(({
  ...
  const c = tn(), l = ke(), { pageSize: b, pageMargins: T, continuousContent: v, pageBoundaries: _, activePage: M, zoomLevel: D, canUndo: N, canRedo: y } = c, d = J(null), m = J(null), { currentFormat: O, formatText: G, updateCurrentFormatFromSelection: V } = ar(), [ie, re] = ue(!1), [ne, k] = ue(null), [F, te] = ue(!0), K = J(null), {
  ...
  } = wr(b, m, D, T), z = be(() => gt(b), [b]), [H, C] = ue(!1), j = J(null), U = J(!1), $ = J(!1), oe = J(!1), P = J(v);
  ae(() => {
    if (m.current) {
      if (!oe.current) {
  ...
  const ce = be(() => ({
    ...
    insertContent: (S) => {
      ...
      const W = $e(S), X = window.getSelection();
      let le = !1;
      if (X && X.rangeCount > 0) {
  ...
  Ln(p, () => ce, [ce]), ae(() => {
    ...
    return m.current && m.current.addEventListener("focus", W), () => {
      document.removeEventListener("selectionchange", S), m.current && m.current.removeEventListener("focus", W);
    };
  }, [V]);
  const me = L(() => {
    U.current = !1;
    const S = Math.max(0, _.length - 1);
    l.setActivePage(S), setTimeout(() => {
      se(S, d);
    }, Aa);
  }, [_.length, l, se]), Te = L(() => {
    if (!m.current) return;
    let S = m.current.innerHTML;
    S = $e(S), S !== m.current.innerHTML && (m.current.innerHTML = S);
    const W = v;
    if (W !== S) {
      const le = {
    ...
    l.updateContinuousContent(S), Q(), u(200);
    const X = ee(d);
    X !== M && l.setActivePage(X);
  }, [l, Q, ee, M, u, d, m, v]), xn = L((S) => {
    Te();
  }, [Te]), xt = L((S) => {
    l.updatePageSize(S), E({ pageSize: S }), s && s(S);
  }, [l, E, s]), At = L((S) => {
    l.updatePageMargins(S), E({ pageMargins: S }), a && a(S);
  }, [l, E, a]), Pt = L((S) => {
    S < 0 || S >= _.length || ($.current = !0, l.setActivePage(S), se(S, d), setTimeout(() => {
      $.current = !1;
    }, NAVIGATION_LOCK_TIMEOUT), t && t(S));
  }, [l, se, t, _.length]), _t = L(() => {
    const S = _.length + 1;
    w(S) && (U.current = !0, setTimeout(() => {
      U.current && me();
    }, 100)), r && r();
  }, [_.length, w, l, se, r]), An = L(() => {
  ...
  const _n = L(() => {
    !d.current || !m.current || $.current || (j.current && clearTimeout(j.current), j.current = setTimeout(() => {
      ...
      const S = ee(d);
      S !== M && S >= 0 && l.setActivePage(S), j.current = null;
    }, SCROLL_DEBOUNCE));
  }, [ee, M, l]), Sn = be(() => {
    if (!v) return 0;
    const W = v.replace(/<[^>]*>/g, " ").match(new RegExp("\\p{L}+", "gu"));
    return W ? W.length : 0;
  }, [v]), wn = _.length || 1, Rn = L((S) => {
    re(!0), k(S);
  }, []), kt = L(() => {
    re(!1), k(null);
  }, []), kn = L((S, W) => {
    ...
    /* @__PURE__ */ h.jsxs("div", { className: "editor-container", children: [
      ...
      ie && ne && /* @__PURE__ */ h.jsx(
        Tt,
        {
          ...
          onDelete: () => {
            if (ne) {
              const S = ne.getAttribute("data-key");
              S && Lr(S).catch((W) => {
