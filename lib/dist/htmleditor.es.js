import Ke, { createContext as mr, useContext as yr, useReducer as br, useMemo as ge, useState as ne, useCallback as N, useRef as te, useEffect as oe, forwardRef as kt, createElement as bt, memo as vr, useLayoutEffect as vn, useImperativeHandle as Tr } from "react";
  ...
  return Qt || (Qt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function f(l, P, H, B, G, q) {
      ...
      if (z.call(P, "key")) {
        ...
        B = 0 < Y.length ? "{key: someKey, " + Y.join(": ..., ") + ": ...}" : "{key: someKey}", w[L + B] || (Y = 0 < Y.length ? "{" + Y.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    var h = Ke, m = Symbol.for("react.transitional.element"), b = Symbol.for("react.portal"), y = Symbol.for("react.fragment"), x = Symbol.for("react.strict_mode"), S = Symbol.for("react.profiler"), O = Symbol.for("react.consumer"), T = Symbol.for("react.context"), v = Symbol.for("react.forward_ref"), C = Symbol.for("react.suspense"), U = Symbol.for("react.suspense_list"), k = Symbol.for("react.memo"), $ = Symbol.for("react.lazy"), R = Symbol.for("react.activity"), I = Symbol.for("react.client.reference"), j = h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, z = Object.prototype.hasOwnProperty, F = Array.isArray, A = console.createTask ? console.createTask : function() {
      return null;
    };
    h = {
    ...
    _e.Fragment = y, _e.jsx = function(l, P, H) {
...
var en;
function Cr() {
  return en || (en = 1, process.env.NODE_ENV === "production" ? Be.exports = wr() : Be.exports = xr()), Be.exports;
}
var g = Cr();
const vt = 100, Tt = 50, Et = 200, tn = 5, wt = (e) => e < Et, xt = (e) => e > Tt, Ar = 96, me = (e) => Math.round(e * Ar), Ze = {
  NORMAL: {
    name: "Normal",
    label: 'Normal (1")',
    top: 1,
...
}, Ba = (e) => Object.keys(Ye).includes(e), za = () => Object.keys(Ye), Me = wn, Ee = "<p><br></p>", Or = "continuous", Oe = (e, t = Me) => ({
  id: Pt(),
  index: e,
  size: t,
  content: Ee,
  images: [],
  isBreakPoint: !1
}), qe = (e) => typeof e != "string" || e.trim() === "" ? Ee : e, xn = (e, t = Me) => (e.length > 0 ? e : [Oe(0, t)]).map((n, a) => ({
  id: n.id || Pt(),
  index: a,
  size: n.size || t,
  ...
  const t = (/* @__PURE__ */ new Date()).toISOString(), r = e.pageSize || Me, n = xn(e.pages || [Oe(0, r)], r);
  return {
    id: Pt(),
  ...
  switch (t.type) {
    case Z.INITIALIZE_DOCUMENT: {
      const { initialContent: n = Ee, pageSize: a = Me } = t.payload || {}, o = { ...Oe(0, a), content: qe(n) };
      return Ct({
        title: e.title,
        pageSize: a,
        pages: [o]
    ...
    case Z.UPDATE_PAGES: {
      const n = Array.isArray(t.payload) ? { pages: t.payload } : t.payload || {}, a = xn(n.pages || [], e.pageSize), o = Array.isArray(n.pageBreaks) ? n.pageBreaks : ze(a);
      return {
        ...e,
        pages: a,
...
`) || Ee : e.continuousContent && e.continuousContent !== Ee && (o = [{ ...Oe(0, e.pageSize), content: e.continuousContent }]), {
        ...e,
        editorMode: n,
        continuousContent: a,
        pages: o,
...
}, Cn = mr(null), $a = ({ children: e, initialState: t = {} }) => {
  ...
  return /* @__PURE__ */ g.jsx(Cn.Provider, { value: o, children: e });
}, An = () => {
  const e = yr(Cn);
  if (!e)
...
function Pr() {
  ...
  return Q.AsyncMode = u, Q.ConcurrentMode = c, Q.ContextConsumer = i, Q.ContextProvider = s, Q.Element = t, Q.ForwardRef = f, Q.Fragment = n, Q.Lazy = m, Q.Memo = h, Q.Portal = r, Q.Profiler = o, Q.StrictMode = a, Q.Suspense = d, Q.isAsyncMode = function(v) {
    return T(v) || O(v) === u;
  }, Q.isConcurrentMode = T, Q.isContextConsumer = function(v) {
    return O(v) === i;
    ...
    return typeof v == "string" || typeof v == "function" || v === n || v === c || v === o || v === a || v === d || v === p || typeof v == "object" && v !== null && (v.$$typeof === m || v.$$typeof === h || v.$$typeof === s || v.$$typeof === i || v.$$typeof === f || v.$$typeof === y || v.$$typeof === x || v.$$typeof === S || v.$$typeof === b);
  }, Q.typeOf = O, Q;
}
var ee = {};
/** @license React v16.13.1
...
function Nr() {
  return rn || (rn = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    var v = u, C = c, U = i, k = s, $ = t, R = f, I = n, j = m, z = h, F = r, A = o, M = a, V = d, re = !1;
    function se(D) {
      return re || (re = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), w(D) || T(D) === u;
    }
    function w(D) {
      return T(D) === c;
    }
    ...
    ee.AsyncMode = v, ee.ConcurrentMode = C, ee.ContextConsumer = U, ee.ContextProvider = k, ee.Element = $, ee.ForwardRef = R, ee.Fragment = I, ee.Lazy = j, ee.Memo = z, ee.Portal = F, ee.Profiler = A, ee.StrictMode = M, ee.Suspense = V, ee.isAsyncMode = se, ee.isConcurrentMode = w, ee.isContextConsumer = l, ee.isContextProvider = P, ee.isElement = H, ee.isForwardRef = B, ee.isFragment = G, ee.isLazy = q, ee.isMemo = L, ee.isPortal = Y, ee.isProfiler = J, ee.isStrictMode = X, ee.isSuspense = ie, ee.isValidElementType = O, ee.typeOf = T;
  })()), ee;
}
var on;
function Sn() {
  return on || (on = 1, process.env.NODE_ENV === "production" ? Fe.exports = Pr() : Fe.exports = Nr()), Fe.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Ir() {
  if (un) return pt;
  un = 1;
  var e = Sn(), t = Mr(), r = /* @__PURE__ */ Nt(), n = /* @__PURE__ */ _n(), a = /* @__PURE__ */ Lr(), o = function() {
  };
  ...
  return pt = function(i, u) {
    ...
    function y(w) {
      ...
      function H(G, q, L, Y, J, X, ie) {
        ...
        return q[L] == null ? G ? q[L] === null ? new b("The " + J + " `" + X + "` is marked as required " + ("in `" + Y + "`, but its value is `null`.")) : new b("The " + J + " `" + X + "` is marked as required in " + ("`" + Y + "`, but its value is `undefined`.")) : null : w(q, L, Y, J, X);
      }
      var B = H.bind(null, !1);
    ...
    function x(w) {
      function l(P, H, B, G, q, L) {
        ...
        if (J !== w) {
          var X = V(Y);
          return new b(
            "Invalid " + G + " `" + q + "` of type " + ("`" + X + "` supplied to `" + B + "`, expected ") + ("`" + w + "`."),
            { expectedType: w }
          );
        }
        return null;
    ...
    function O(w) {
      function l(P, H, B, G, q) {
        if (typeof w != "function")
          return new b("Property `" + q + "` of component `" + B + "` has invalid PropType notation inside arrayOf.");
        var L = P[H];
        if (!Array.isArray(L)) {
          var Y = M(L);
          return new b("Invalid " + G + " `" + q + "` of type " + ("`" + Y + "` supplied to `" + B + "`, expected an array."));
        }
        for (var J = 0; J < L.length; J++) {
          var X = w(L, J, B, G, q + "[" + J + "]", r);
    ...
    function T() {
      function w(l, P, H, B, G) {
        var q = l[P];
        if (!i(q)) {
          var L = M(q);
          return new b("Invalid " + B + " `" + G + "` of type " + ("`" + L + "` supplied to `" + H + "`, expected a single ReactElement."));
        }
        return null;
      }
      return y(w);
    ...
    function v() {
      function w(l, P, H, B, G) {
        ...
        if (!e.isValidElementType(q)) {
          var L = M(q);
          return new b("Invalid " + B + " `" + G + "` of type " + ("`" + L + "` supplied to `" + H + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return y(w);
    ...
    function C(w) {
      function l(P, H, B, G, q) {
        if (!(P[H] instanceof w)) {
          var L = w.name || p, Y = se(P[H]);
          return new b("Invalid " + G + " `" + q + "` of type " + ("`" + Y + "` supplied to `" + B + "`, expected ") + ("instance of `" + L + "`."));
        }
        return null;
      }
      return y(l);
    ...
    function U(w) {
      ...
      function l(P, H, B, G, q) {
        for (var L = P[H], Y = 0; Y < w.length; Y++)
          if (m(L, w[Y]))
            return null;
        ...
        return new b("Invalid " + G + " `" + q + "` of value `" + String(L) + "` " + ("supplied to `" + B + "`, expected one of " + J + "."));
      }
      return y(l);
    }
    function k(w) {
      function l(P, H, B, G, q) {
        if (typeof w != "function")
          return new b("Property `" + q + "` of component `" + B + "` has invalid PropType notation inside objectOf.");
        var L = P[H], Y = M(L);
        if (Y !== "object")
          return new b("Invalid " + G + " `" + q + "` of type " + ("`" + Y + "` supplied to `" + B + "`, expected an object."));
        for (var J in L)
          if (n(L, J)) {
            var X = w(L, J, B, G, q + "." + J, r);
            if (X instanceof Error)
    ...
    function $(w) {
      ...
      function H(B, G, q, L, Y) {
        for (var J = [], X = 0; X < w.length; X++) {
          var ie = w[X], D = ie(B, G, q, L, Y, r);
          if (D == null)
            return null;
          D.data && n(D.data, "expectedType") && J.push(D.data.expectedType);
        }
        var ue = J.length > 0 ? ", expected one of type [" + J.join(", ") + "]" : "";
        return new b("Invalid " + L + " `" + Y + "` supplied to " + ("`" + q + "`" + ue + "."));
      }
      return y(H);
    }
    function R() {
      function w(l, P, H, B, G) {
        return F(l[P]) ? null : new b("Invalid " + B + " `" + G + "` supplied to " + ("`" + H + "`, expected a ReactNode."));
      }
      return y(w);
    }
    function I(w, l, P, H, B) {
      return new b(
        (w || "React class") + ": " + l + " type `" + P + "." + H + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + B + "`."
      );
    }
    function j(w) {
      function l(P, H, B, G, q) {
        var L = P[H], Y = M(L);
        if (Y !== "object")
          return new b("Invalid " + G + " `" + q + "` of type `" + Y + "` " + ("supplied to `" + B + "`, expected `object`."));
        for (var J in w) {
          var X = w[J];
...
const E = /* @__PURE__ */ Er(jr), On = {
  ...
  const [e, t] = ne(pn), r = ve(), n = N((h, m, b = null) => {
    try {
      ...
      try {
        ...
        O.style[h] = m;
        const T = x.extractContents();
        return O.appendChild(T), x.insertNode(O), x.selectNodeContents(O), y.removeAllRanges(), y.addRange(x), t((v) => ({ ...v, [h]: m })), !0;
      } catch {
        if (b) {
          const O = h === "fontSize" ? Fr[m] || "3" : m;
          return document.execCommand(b, !1, O), t((T) => ({ ...T, [h]: m })), !0;
        }
        return !1;
      }
    } catch (y) {
    ...
    try {
      ...
      if (!S)
        return !1;
      if (!y) {
        const T = b.startContainer, v = T.nodeType === Node.TEXT_NODE ? T.parentElement : T, C = ke(v) || Gr();
      ...
      if (O.length === 0) {
        ...
        T.style.textAlign = S;
        const v = b.extractContents();
        T.appendChild(v), b.insertNode(T), b.selectNodeContents(T), m.removeAllRanges(), m.addRange(b);
      } else
        O.forEach((T) => {
          T.style.textAlign = S;
        });
    ...
    try {
      ...
      if (y.innerHTML = h, Array.from(y.children).some(
        ...
        const S = b.startContainer, O = S.nodeType === Node.TEXT_NODE ? S.parentElement : S, T = ke(O);
        if (T && ["P", "H1", "H2", "H3", "H4", "H5", "H6"].includes(T.tagName)) {
          const v = T.tagName.toLowerCase();
          if (b.startOffset === 0 && (S === T || S.nodeType === Node.TEXT_NODE && S === T.firstChild))
            T.parentNode.insertBefore(y, T);
          else if (b.startOffset === S.textContent?.length && S === T.lastChild && b.endOffset === S.textContent?.length) {
            const k = T.nextSibling;
            k ? T.parentNode.insertBefore(y, k) : T.parentNode.appendChild(y);
          } else {
            const k = b.extractContents(), $ = document.createTextNode(""), R = document.createElement(v);
            R.appendChild($), R.appendChild(k);
            const I = T.parentNode;
            I.insertBefore(y, T.nextSibling), I.insertBefore(R, y.nextSibling), !T.textContent.trim() && T.children.length === 0 && I.removeChild(T);
          }
        } else
          b.insertNode(y);
    ...
    try {
      ...
      let y = Xe, x = "Arial", S = "#000000", O = "p", T = "left";
      if (b) {
        ...
        if (U) {
          ...
          $ && $.endsWith("px") && (y = $), R && R !== "serif" && (x = R.split(",")[0].replace(/['"]/g, "").trim());
          const I = k.color;
          I && I !== "rgb(0, 0, 0)" && I !== "#000000" && (I.startsWith("rgb") ? S = Wr(I) : S = I);
          const j = ke(U);
          if (j) {
            const z = j.tagName?.toLowerCase();
            ["h1", "h2", "h3", "h4", "h5", "h6", "p"].includes(z) && (O = z);
            const A = window.getComputedStyle(j).textAlign;
            ["left", "center", "right", "justify"].includes(A) && (T = A);
          }
        }
      }
      const v = {
...
const be = 'page-break, [data-page-break="true"]', Zr = (e, t = {}) => {
  ...
  try {
    ...
    for (let p = 0; p < c.length && d < hn; p++) {
      const h = c[p], m = oo(h, u);
      if (m && m.overflowIndex > 0) {
        let b = 0;
        for (let O = 0; O < h.length; O++) {
          const T = h[O];
          T && T.getBoundingClientRect && (b += Pn(T));
        }
        if (b - u < ro)
          continue;
        const x = p + 2;
        Kr(m.overflowElement, x) && (f = !0, d++, c = gn(e));
      }
    }
    if (f) {
      if (a) {
  ...
  const d = N((C = {}) => t?.current ? Zr(t.current, C) : [], [t]), p = N((C = {}) => {
    const U = d(C);
    return a.updatePageBoundaries(U), U;
  }, [d, a]), h = N((C = {}) => {
    const U = typeof C.delay == "number" ? C.delay : fo;
    lo(p, o, C, U);
  }, [p]), m = N(() => {
    t?.current && so(
      t.current,
    ...
    ao(m, s, C);
  }, [m]), y = N((C) => !C?.current || !t?.current ? 0 : Yr(C.current, t.current), [t]), x = N((C) => {
    ...
    co(U.current, t.current, C, x);
  }, [t, x]), O = N(async (C) => t?.current ? Xr(
    t.current,
    C,
    i.current,
    u.current,
    ...
    x,
    m
  ) : !1, [t, d, a, p, x, m]), v = N((C) => t?.current ? eo(
    C,
    t.current,
    a.updateContinuousContent,
    p,
...
function mo(e, t = Ae) {
  ...
  return r.style.top = `${n.top}px`, r.style.left = `${n.left}px`, r.style.width = `${n.width}px`, r.style.height = `${n.height}px`, Object.values(W).forEach((o) => {
    ...
    s.className = `resize-handler resize-handler-${o}`, s.dataset.handler = o, s.style.position = "absolute", s.style.width = "10px", s.style.height = "10px", s.style.backgroundColor = "#007bff", s.style.border = "2px solid white", s.style.borderRadius = "50%", s.style.boxShadow = "0 0 3px rgba(0,0,0,0.3)", s.style.cursor = yo(o), s.style.pointerEvents = "all", Mn(s, o, n.width, n.height), r.appendChild(s);
  }), r;
}
function yo(e) {
  switch (e) {
...
function Oo(e) {
  ...
  return Array.from(e.childNodes).forEach((n) => {
    if (n.nodeType === Node.TEXT_NODE)
      ...
      const a = n;
      Ln.includes(a.tagName) ? t.push(a.outerHTML) : r = !0;
    }
...
function Pe(e) {
  ...
  for (let n = 0; n < r.length; n++) {
    ...
    if (a.nodeType === Node.TEXT_NODE) {
      ...
      const o = a, s = o.tagName, i = s.toLowerCase(), u = In(o);
      if (s === "DIV") {
        const c = Pe(o);
        c.trim() ? t.push(c) : t.push("<p><br></p>");
      } else if (s === "P")
        _o(o) ? t.push(Oo(o)) : t.push(o.outerHTML);
...
}, Dn = (...e) => e.filter((t, r, n) => !!t && t.trim() !== "" && n.indexOf(t) === r).join(" ").trim(), Lo = (e) => {
  for (const t in e)
...
const Xs = [
  ...
  const a = Rn(), { pages: o, activePage: s, continuousContent: i } = a, { wordCount: u, outline: c } = ge(() => {
    ...
    return o.forEach((h, m) => {
      d += Qs(h.content), p.push(...yn(h.content, m + 1, `page-${m}-`));
        ...
        !e && /* @__PURE__ */ g.jsxs("div", { className: "sidebar-content", children: [
          ...
          c.length > 0 && /* @__PURE__ */ g.jsxs("div", { className: "sidebar-section", children: [
            /* @__PURE__ */ g.jsxs("h3", { children: [
              /* @__PURE__ */ g.jsx(Hn, { size: 14, style: { display: "inline-block", marginRight: "6px", verticalAlign: "middle" } }),
              "Document Outline"
            ] }),
...
const bn = new ta("Editor"), jn = /* @__PURE__ */ new Set(["P", "DIV", "H1", "H2", "H3", "H4", "H5", "H6", "LI", "BLOCKQUOTE", "PRE", "TABLE"]), Bn = 32;
function zn(e, t) {
  if (!e) return;
  e.dataset || (e.dataset = {}), e.style || (e.style = {});
  const r = parseInt(e.dataset.indentLevel || "0", 10), n = Math.max(0, t ? r - 1 : r + 1);
  n === 0 ? (e.style.marginLeft = "", delete e.dataset.indentLevel) : (e.style.marginLeft = `${n * Bn}px`, e.dataset.indentLevel = String(n));
}
function na(e, t) {
  zn(e, t);
}
function ra(e) {
  let t = e;
  for (; t; ) {
    if (t.nodeType === 1 && t.tagName && jn.has(t.tagName.toUpperCase()))
      return t;
...
function oa() {
  ...
  return n ? (n.querySelectorAll("p, div, h1, h2, h3, h4, h5, h6, li, blockquote, pre, table").forEach((s) => {
    ...
    if (document.createRange().selectNode(i), t.intersectsNode(i)) {
      ...
      for (; c && c !== n; ) {
        if (c.tagName && jn.has(c.tagName.toUpperCase())) {
          r.add(c);
          break;
        }
        c = c.parentElement;
...
function sa(e) {
  if (e.style && e.style.marginLeft && e.style.marginLeft !== "") {
    ...
    r === 0 ? (e.style.marginLeft = "", delete e.dataset.indentLevel) : (e.style.marginLeft = `${r * Bn}px`, e.dataset.indentLevel = String(r));
    return;
  }
...
function aa(e) {
  ...
  return r && r.rangeCount > 0 && n && !n.collapsed && _t(t) || t || document.execCommand("insertHTML", !1, "&nbsp;&nbsp;&nbsp;&nbsp;"), !0;
}
const $n = ({ currentColor: e, onColorSelect: t, title: r = "Font Color" }) => {
...
const ia = [
  ...
  const s = (h, m, b, y = null, x = !1) => /* @__PURE__ */ g.jsx(
    ...
    try {
      ...
      const b = await Eo(h), y = await wo(b);
      if (y && n) {
    ...
    _t(!1) || document.execCommand("insertHTML", !1, "&nbsp;&nbsp;&nbsp;&nbsp;");
  }, f = () => {
    _t(!0);
  }, d = () => {
  ...
  return /* @__PURE__ */ g.jsxs("div", { className: "editor-toolbar", children: [
    ...
    /* @__PURE__ */ g.jsx(
      "select",
      {
        ...
        title: "Font Family",
        children: ia.map(({ value: h, label: m }) => /* @__PURE__ */ g.jsx("option", { value: h, children: m }, h))
      }
    ),
    /* @__PURE__ */ g.jsx(
      "select",
      {
        ...
        value: e.fontSize || Xe,
        title: "Font Size",
        children: Br.map(({ value: h, label: m }) => /* @__PURE__ */ g.jsx("option", { value: h, children: m }, h))
      }
    ),
    /* @__PURE__ */ g.jsx(
      $n,
    ...
    /* @__PURE__ */ g.jsx(
      "select",
      {
        ...
        title: "Heading Level",
        children: ca.map(({ value: h, label: m }) => /* @__PURE__ */ g.jsx("option", { value: h, children: m }, h))
      }
    ),
    i(),
...
const Te = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && Te(e.parentElement) : !1, Ht = ({
  ...
  const d = ge(() => En(f), [f]), p = c / 100, h = N((T, v) => {
    if (!T) return !1;
    const C = T.getBoundingClientRect(), U = v - C.top;
    return U < d.top || U > C.height - d.bottom;
  }, [d.top, d.bottom]), m = N((T, v) => {
    v.preventDefault();
    const C = T.getBoundingClientRect(), U = v.clientX - C.left, k = v.clientY - C.top, $ = C.width - 40, R = -12, I = C.width - 20;
    U >= $ && U <= I && k >= R && k <= 8 && u && u(T);
  }, [u]), b = N((T) => {
    T.preventDefault();
    const v = t.current.getBoundingClientRect();
    if (T.clientY - v.top < d.top) {
    ...
    const C = v.getRangeAt(0), { startContainer: U, endContainer: k } = C;
    ...
    const v = window.getSelection();
    if (!v || v.rangeCount === 0) return;
    const C = v.getRangeAt(0), { startContainer: U } = C;
    if (Te(U))
      return T.preventDefault(), !1;
  }, []), O = N((T) => {
    const v = da(T);
        ...
        /* @__PURE__ */ g.jsxs("div", { className: "page-setting-item", children: [
          ...
          /* @__PURE__ */ g.jsx(
            "select",
            {
              ...
              children: Sr().map((x) => /* @__PURE__ */ g.jsx("option", { value: x, children: _r(x) }, x))
            }
          )
        ] })
      ] })
...
const ha = Ke.memo(Fn), Ue = 10, ma = 300, ya = 200;
function ba(e) {
  switch (e) {
    case W.TOP_LEFT:
    case W.BOTTOM_RIGHT:
...
const jt = ({
  ...
  const u = N((y) => {
    ...
    const x = mo(y, s.current);
    x && (o.current.overlay = x, o.current.image = y, document.body.appendChild(x), x.querySelectorAll(".resize-handler").forEach((O) => {
    ...
    const x = y.currentTarget.dataset.handler, S = o.current.image.getBoundingClientRect(), O = window.pageYOffset || document.documentElement.scrollTop, T = window.pageXOffset || document.documentElement.scrollLeft;
    o.current.start = {
      x: y.clientX,
      y: y.clientY,
      ...
      offsetX: y.clientX - S.left - T,
      offsetY: y.clientY - S.top - O
    }, o.current.handler = x, o.current.isResizing = !0, document.body.classList.add("resize-in-progress"), document.body.style.cursor = ba(x), document.addEventListener("mousemove", d), document.addEventListener("mouseup", p);
  }, []), d = N((y) => {
    if (!o.current.isResizing || !o.current.image || !o.current.start || !o.current.handler) return;
    y.preventDefault(), y.stopPropagation();
    const { x, y: S, width: O, height: T } = o.current.start, v = o.current.handler, C = y.clientX, U = y.clientY, k = Ta({
      handler: v,
      startX: x,
      startY: S,
      currentX: C,
    ...
    y.key === "Escape" && o.current.image && c(), o.current.image && !o.current.isResizing && wa(y, e, o.current.image, s.current);
  }, [e, c]), b = N(() => {
  ...
  return oe(() => {
    ...
    const y = new MutationObserver((x) => {
      x.forEach((S) => {
        S.type === "childList" && S.removedNodes.forEach((O) => {
          O.nodeType === Node.ELEMENT_NODE && we(O) && O === o.current.image && c();
        });
      });
    });
...
const Wn = {
  ...
  const [s, i] = ne({ top: 0, left: 0 }), [u, c] = ne(!1), [f, d] = ne("top"), [p, h] = ne(o), m = te(null), b = ve(), y = (R) => {
  ...
  const v = N(() => {
    ...
    const R = e.getBoundingClientRect(), I = m.current.getBoundingClientRect(), j = window.innerWidth, z = window.innerHeight, F = R.bottom >= 0 && R.top <= z && R.right >= 0 && R.left <= j;
    let A = "top", M = 0, V = 0;
    if (F) {
      const w = R.top - I.height - 10, l = z - R.bottom - I.height - 10;
      l > w && l > 0 ? (A = "bottom", M = R.bottom + 10) : (A = "top", M = R.top - I.height - 10);
    } else
      A = "top", M = 10;
  ...
  const C = {
    ...
    if (e && C[R]) {
      const I = x(e), j = O, z = C[R];
      e.style.float = z.float, e.style.margin = z.margin, e.style.display = z.display, T(R), y(e);
      const F = x(e);
      b.recordOperation(
...
const zt = ({
  ...
  const o = te(null), s = te(null), i = te(null), u = te(null), c = te(null), f = te(a), d = te(!1), [p, h] = ne(null), m = ve();
  oe(() => {
    f.current = a;
  }, [a]);
  const b = N(() => {
    ...
    document.body.style.cursor = z[R] || "default", document.addEventListener("mousemove", O), document.addEventListener("mouseup", T);
  }, []), x = N((k) => {
    ...
    if (!le(k)) return;
    o.current && (We(o.current), o.current = null), k.classList.add("selected"), x(k) && (h(k), r && r(k));
  }, [r, x]), O = N((k) => {
    if (!d.current || !s.current || !i.current || !u.current) return;
    k.preventDefault(), k.stopPropagation();
    const { x: $, y: R, structure: I } = i.current, j = u.current, z = c.current, F = k.clientX, A = k.clientY;
    let M = 0;
    switch (j) {
      case ce.COLUMN:
        M = F - $;
    ...
    xe(s.current, V), o.current && Ot(o.current, s.current);
  }, []), T = N((k) => {
    if (d.current) {
      if (k.preventDefault(), k.stopPropagation(), s.current && i.current) {
        ...
        ($.structure.width !== R.structure.width || $.structure.height !== R.structure.height || JSON.stringify($.structure.columnWidths) !== JSON.stringify(R.structure.columnWidths) || JSON.stringify($.structure.rowHeights) !== JSON.stringify(R.structure.rowHeights)) && m.recordOperation(
          { type: "TABLE_RESIZE", payload: { element: s.current, state: R } },
          { type: "TABLE_RESIZE", payload: { element: s.current, state: $ } }
        );
      }
      if (i.current = null, u.current = null, c.current = null, d.current = !1, document.removeEventListener("mousemove", O), document.removeEventListener("mouseup", T), document.body.classList.remove("table-resize-in-progress"), document.body.style.cursor = "", s.current) {
        const $ = new Event("input", { bubbles: !0, cancelable: !0 });
        s.current.dispatchEvent($), t && t(s.current, fe(s.current));
      }
    }
  }, [t, m]), v = N((k) => {
    o.current && !o.current.contains(k.target) && b();
  ...
  return oe(() => {
    ...
    if (!e.current) return;
    const k = e.current;
    return k.addEventListener("click", v), k.addEventListener("keydown", C), window.addEventListener("resize", U), () => {
      k.removeEventListener("click", v), k.removeEventListener("keydown", C), window.removeEventListener("resize", U), d.current && (document.removeEventListener("mousemove", O), document.removeEventListener("mouseup", T), document.body.classList.remove("table-resize-in-progress"), document.body.style.cursor = ""), o.current && We(o.current);
    };
  }, [e, v, C, U, O, T]), oe(() => {
    if (!e.current) return;
    const k = new MutationObserver(($) => {
      $.forEach((R) => {
        R.type === "childList" && (R.removedNodes.forEach((I) => {
          ...
          j.length > 0 && setTimeout(() => S(j[0]), 50);
        }));
      });
    });
...
const $t = ({
  ...
  const [s, i] = ne({ top: 0, left: 0 }), [u, c] = ne(!1), [f, d] = ne("top"), p = te(null), h = te(null), m = ve(), b = (A) => {
    if (!A)
      return;
  ...
  const T = N(() => {
    ...
    const A = e.getBoundingClientRect(), M = p.current.getBoundingClientRect(), V = window.visualViewport ? window.visualViewport : {
      width: window.innerWidth,
      height: window.innerHeight
    }, re = A.bottom >= 0 && A.top <= V.height && A.right >= 0 && A.left <= V.width;
    let se = "top", w = 0, l = 0;
    if (re) {
      const q = A.top - M.height - 10, L = V.height - A.bottom - M.height - 10;
      L > q && L > 0 ? (se = "bottom", w = A.bottom + 10) : (se = "top", w = A.top - M.height - 10);
    } else
      se = "top", w = 10;
    l = A.left + A.width / 2 - M.width / 2;
    const P = window.innerWidth, H = window.innerHeight;
    let B = Math.max(10, Math.min(l, P - M.width - 10)), G = Math.max(10, Math.min(w, H - M.height - 10));
  ...
  vn(() => {
    ...
    return M && M.addEventListener("scroll", A), window.addEventListener("scroll", A), window.addEventListener("resize", A), () => {
      M && M.removeEventListener("scroll", A), window.removeEventListener("scroll", A), window.removeEventListener("resize", A), c(!1);
    };
  }, [e, T]), oe(() => {
    const A = (M) => {
  ...
  const v = {
    ...
    if (e && v[A]) {
      const M = y(e), V = S, re = v[A];
      e.style.float = re.float, e.style.margin = re.margin, e.style.marginLeft = re.marginLeft, e.style.marginRight = re.marginRight, O(A), b(e);
      const se = y(e);
      m.recordOperation(
    ...
    if (A) {
      if (console.log("Row inserted successfully, updating content"), o && o.current) {
        ...
        console.log("Updated content length:", M.length), m.updateContinuousContent(M);
      } else
    ...
    if (console.log(`Inserting column left of index ${a}`), _a(e, a)) {
    ...
    if (console.log(`Inserting column right of index ${a}`), Oa(e, a)) {
      if (console.log("Column inserted successfully, updating content"), o && o.current) {
        const M = o.current.innerHTML;
        console.log("Updated content length:", M.length), m.updateContinuousContent(M);
      } else
...
const Ft = ({
  ...
  ve(), te(null);
  const S = te(null), O = N(() => {
    n(/* @__PURE__ */ new Set()), o(null), i(null), c(null), b(null), x(null), d(!1), h(!1), document.querySelectorAll(".table-cell-selected, .table-row-selected, .table-col-selected").forEach((j) => {
    ...
    if (!z || !F) return null;
    const A = Array.from(F.rows).indexOf(z), M = Array.from(z.cells).indexOf(j);
    return { rowIndex: A, cellIndex: M, table: F };
  }, []), v = N((j) => {
    if (j.size === 0) return { mode: null, rowIndex: null, colIndex: null };
    const z = Array.from(j), F = z[0], A = T(F);
    if (!A) return { mode: null, rowIndex: null, colIndex: null };
    const { table: M } = A;
    return z.filter((se) => {
      const w = T(se);
      return w && w.table === M && w.rowIndex === A.rowIndex;
    }).length >= 2 ? { mode: "row", rowIndex: A.rowIndex, colIndex: null } : z.filter((se) => {
      const w = T(se);
      return w && w.table === M && w.cellIndex === A.cellIndex;
    ...
    const F = v(j);
    n(j), o(F.mode), i(F.rowIndex), c(F.colIndex), x(z), C(F.mode, F.rowIndex, F.colIndex, j, z);
    const A = F.mode ? {
      mode: F.mode,
      cells: j,
      rowIndex: F.rowIndex,
    ...
    const F = T(m), A = T(z);
    if (!F || !A || F.table !== A.table) return;
    const M = Math.min(F.rowIndex, A.rowIndex), V = Math.max(F.rowIndex, A.rowIndex), re = Math.min(F.cellIndex, A.cellIndex), se = Math.max(F.cellIndex, A.cellIndex), w = /* @__PURE__ */ new Set();
    for (let l = M; l <= V; l++) {
      const P = y.rows[l];
      if (P)
        for (let H = re; H <= se; H++) {
  ...
  return oe(() => {
    if (!e.current) return;
    const j = e.current, z = (A) => {
      A.target.closest("td, th") && k(A);
    }, F = (A) => {
      A.target.closest("td, th") && $(A);
    };
    ...
    const j = new MutationObserver((z) => {
      z.forEach((F) => {
        F.type === "childList" && y && !e.current.contains(y) && O();
      });
    });
...
const Na = 50, yt = 50, Ma = 50, La = 100, Ia = 300, Ut = kt(({
  ...
  const d = Rn(), p = ve(), { pageSize: h, pageMargins: m, continuousContent: b, pageBoundaries: y, activePage: x, zoomLevel: S, canUndo: O, canRedo: T } = d, v = te(null), C = te(null), { currentFormat: U, formatText: k, updateCurrentFormatFromSelection: $ } = Ur(), [R, I] = ne(!1), [j, z] = ne(null), [F, A] = ne(!0), [M, V] = ne(!1), [re, se] = ne(null), [w, l] = ne(null), [P, H] = ne(null), {
  ...
  } = po(h, C, S, m), D = ge(() => Ne(h), [h]), [ue, Ce] = ne(!1), pe = te(null), Ie = te(!1), De = te(!1), He = te(!1), je = te(b), Qe = N(() => {
    Ie.current = !1;
    const _ = Math.max(0, y.length - 1);
  ...
  oe(() => {
    ...
    C.current.innerHTML = b, He.current = !0, je.current = b;
    const _ = setTimeout(() => {
      L();
    }, Na);
    ...
    if (C.current.innerHTML !== b) {
      ...
      return je.current = b, () => clearTimeout(ae);
    }
  }, [b, L, Qe]), oe(() => {
    s && He.current && s(b);
  }, [b, s]);
  const { restoreCursorPosition: et, hasActiveCursorSelection: tt } = ho({
    ...
    _ !== b && p.updateContinuousContent(_), C.current && C.current.innerHTML !== _ && (C.current.innerHTML = _), je.current = _, setTimeout(() => {
      L();
    }, yt);
  }, [b, p, L]), nt = N((_) => {
    if (!C.current || !_) return;
    tt() || et(), document.execCommand("insertHTML", !1, _);
     ...
     */
    getCursorPosition: () => C.current ? uo(C.current) : null,
    /**
     ...
     */
    setPageSize: (_) => {
      p.updatePageSize(_), L({ pageSize: _ });
    },
    /**
     ...
     */
    setPageMargins: (_) => {
      p.updatePageMargins(_), L({ pageMargins: _ });
    },
    /**
  ...
  const rt = N(() => {
    if (!C.current) return;
    let _ = C.current.innerHTML;
    _ = Ge(_), _ !== C.current.innerHTML && (C.current.innerHTML = _);
    const ae = b;
    if (ae !== _) {
      const it = {
    ...
    p.updateContinuousContent(_), B(), Y(200);
    const Re = G(v);
    Re !== x && p.setActivePage(Re);
  }, [p, B, G, x, Y, v, C, b]), tr = N((_) => {
    rt();
  }, [rt]), qt = N((_) => {
    p.updatePageSize(_), L({ pageSize: _ }), a && a(_);
  }, [p, L, a]), Gt = N((_) => {
    p.updatePageMargins(_), L({ pageMargins: _ }), o && o(_);
  }, [p, L, o]), Zt = N((_) => {
    _ < 0 || _ >= y.length || (De.current = !0, p.setActivePage(_), q(_, v), setTimeout(() => {
      De.current = !1;
    }, Ia), t && t(_));
  }, [p, q, t, y.length]), Yt = N(() => {
    const _ = y.length + 1;
    ie(_) && (Ie.current = !0, setTimeout(() => {
      Ie.current && Qe();
    }, 100)), r && r();
  }, [y.length, ie, p, q, r]), nr = N(() => {
    ...
    J(_) && (p.setActivePage(0), n && n(_));
  }, [y.length, J, p, n]), sr = ge(() => ({
  ...
  go(
    ...
    { editorRef: C, containerRef: v }
  );
  const cr = N(() => {
    !v.current || !C.current || De.current || (pe.current && clearTimeout(pe.current), pe.current = setTimeout(() => {
      if (De.current) {
        pe.current = null;
        return;
      }
      const _ = G(v);
      _ !== x && _ >= 0 && p.setActivePage(_), pe.current = null;
    }, La));
  }, [G, x, p]), lr = ge(() => {
    if (!b) return 0;
    const ae = b.replace(/<[^>]*>/g, " ").match(new RegExp("\\p{L}+", "gu"));
    return ae ? ae.length : 0;
  }, [b]), ur = y.length || 1, dr = N((_) => {
    I(!0), z(_);
  }, []), Kt = N(() => {
    I(!1), z(null);
  }, []), fr = N((_, ae) => {
  }, []), pr = N((_) => {
    _ && _.mode === "row" ? (l(_.rowIndex), H(null)) : _ && _.mode === "column" ? (H(_.colIndex), l(null)) : (l(null), H(null));
  }, []), gr = N((_) => {
    V(!0), se(_);
  }, []), Xt = N(() => {
    V(!1), se(null);
    ...
    /* @__PURE__ */ g.jsxs("div", { className: "editor-container", children: [
      ...
      R && j && /* @__PURE__ */ g.jsx(
        Bt,
        {
          ...
          onDelete: () => {
            if (j) {
              const _ = j.getAttribute("data-key");
              _ && xo(_).catch((ae) => {
