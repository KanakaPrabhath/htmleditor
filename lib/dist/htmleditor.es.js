import ot, { createContext as pr, useContext as gr, useReducer as hr, useMemo as Ee, useState as oe, useCallback as _, useRef as ee, useEffect as ae, forwardRef as Ot, createElement as mt, memo as mr, useLayoutEffect as wn, useImperativeHandle as yr } from "react";
...
function vr() {
  return nn || (nn = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function r(f) {
      ...
      if (k) {
        k = console;
        var H = k.error, M = typeof Symbol == "function" && Symbol.toStringTag && f[Symbol.toStringTag] || f.constructor.name || "Object";
        return H.call(
          k,
    ...
    function c(f, k, H, M, Z, G) {
      ...
      if (x.call(k, "key")) {
        z = e(f);
        var U = Object.keys(k).filter(function(Q) {
          return Q !== "key";
        });
        M = 0 < U.length ? "{key: someKey, " + U.join(": ..., ") + ": ...}" : "{key: someKey}", E[z + M] || (U = 0 < U.length ? "{" + U.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (z = null, H !== void 0 && (r(H), z = "" + H), s(k) && (r(k.key), z = "" + k.key), "key" in k) {
        H = {};
        for (var X in k)
          X !== "key" && (H[X] = k[X]);
      } else H = k;
    ...
    var N, V = {}, te = T.react_stack_bottom_frame.bind(
      T,
      o
    )(), ie = C(n(o)), E = {};
    Ie.Fragment = A, Ie.jsx = function(f, k, H) {
...
var rn;
function wr() {
  return rn || (rn = 1, process.env.NODE_ENV === "production" ? Ye.exports = Tr() : Ye.exports = vr()), Ye.exports;
}
var m = wr();
const yt = 100, bt = 50, Tt = 200, on = 5, vt = (e) => e < Tt, wt = (e) => e > bt, Er = 96, ve = (e) => Math.round(e * Er), nt = {
  NORMAL: {
    name: "Normal",
    label: 'Normal (1")',
    top: 1,
...
}, _a = (e) => Object.keys(Pe).includes(e), Na = () => Object.keys(Pe), Be = Cn, ke = "<p><br></p>", Rr = "continuous", He = (e, t = Be) => ({
  id: kt(),
  index: e,
  size: t,
  content: ke,
  images: [],
  isBreakPoint: !1
}), et = (e) => typeof e != "string" || e.trim() === "" ? ke : e, An = (e, t = Be) => (e.length > 0 ? e : [He(0, t)]).map((n, a) => ({
  id: n.id || kt(),
  index: a,
  size: n.size || t,
  ...
  const t = (/* @__PURE__ */ new Date()).toISOString(), r = e.pageSize || Be, n = An(e.pages || [He(0, r)], r);
  return {
    id: kt(),
    ...
    continuousContent: e.continuousContent || ke,
  ...
  switch (t.type) {
    case Y.INITIALIZE_DOCUMENT: {
      const { initialContent: n = ke, pageSize: a = Be } = t.payload || {}, o = { ...He(0, a), content: et(n) };
      return Et({
        title: e.title,
        pageSize: a,
        pages: [o]
    ...
    case Y.SET_EDITOR_MODE: {
      ...
      return n === "continuous" ? a = e.pages.map((i) => i.content).filter((i) => i && i !== ke).join(`
`) || ke : e.continuousContent && e.continuousContent !== ke && (o = [{ ...He(0, e.pageSize), content: e.continuousContent }]), {
        ...e,
        editorMode: n,
        continuousContent: a,
        pages: o,
...
function kr() {
  return an || (an = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    var p = g, y = l, I = i, R = s, j = t, q = c, W = n, B = b, x = T, O = r, C = o, N = a, V = u, te = !1;
    function ie(D) {
    ...
    re.AsyncMode = p, re.ConcurrentMode = y, re.ContextConsumer = I, re.ContextProvider = R, re.Element = j, re.ForwardRef = q, re.Fragment = W, re.Lazy = B, re.Memo = x, re.Portal = O, re.Profiler = C, re.StrictMode = N, re.Suspense = V, re.isAsyncMode = ie, re.isConcurrentMode = E, re.isContextConsumer = f, re.isContextProvider = k, re.isElement = H, re.isForwardRef = M, re.isFragment = Z, re.isLazy = G, re.isMemo = z, re.isPortal = U, re.isProfiler = X, re.isStrictMode = Q, re.isSuspense = ce, re.isValidElementType = P, re.typeOf = h;
  })()), re;
}
var cn;
function kn() {
  ...
  return pt = function(i, g) {
    ...
    function A(E) {
      ...
      function H(Z, G, z, U, X, Q, ce) {
        ...
        return G[z] == null ? Z ? G[z] === null ? new v("The " + X + " `" + Q + "` is marked as required " + ("in `" + U + "`, but its value is `null`.")) : new v("The " + X + " `" + Q + "` is marked as required in " + ("`" + U + "`, but its value is `undefined`.")) : null : E(G, z, U, X, Q);
      }
      var M = H.bind(null, !1);
      return M.isRequired = H.bind(null, !0), M;
    }
    function $(E) {
      function f(k, H, M, Z, G, z) {
        var U = k[H], X = N(U);
        if (X !== E) {
          var Q = V(U);
          return new v(
    ...
    function y(E) {
      function f(k, H, M, Z, G) {
        if (!(k[H] instanceof E)) {
          var z = E.name || d, U = ie(k[H]);
          return new v("Invalid " + Z + " `" + G + "` of type " + ("`" + U + "` supplied to `" + M + "`, expected ") + ("instance of `" + z + "`."));
        }
        return null;
      }
      return A(f);
    ...
    function I(E) {
      ...
      function f(k, H, M, Z, G) {
        for (var z = k[H], U = 0; U < E.length; U++)
          if (b(z, E[U]))
            return null;
    ...
    function R(E) {
      function f(k, H, M, Z, G) {
        ...
        var z = k[H], U = N(z);
        if (U !== "object")
          return new v("Invalid " + Z + " `" + G + "` of type " + ("`" + U + "` supplied to `" + M + "`, expected an object."));
        for (var X in z)
          if (n(z, X)) {
            var Q = E(z, X, M, Z, G + "." + X, r);
            if (Q instanceof Error)
    ...
    function j(E) {
      ...
      for (var f = 0; f < E.length; f++) {
        ...
        if (typeof k != "function")
          return o(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + te(k) + " at index " + f + "."
          ), s;
      }
      function H(M, Z, G, z, U) {
        for (var X = [], Q = 0; Q < E.length; Q++) {
          var ce = E[Q], D = ce(M, Z, G, z, U, r);
          if (D == null)
            return null;
          D.data && n(D.data, "expectedType") && X.push(D.data.expectedType);
        }
        var fe = X.length > 0 ? ", expected one of type [" + X.join(", ") + "]" : "";
        return new v("Invalid " + z + " `" + U + "` supplied to " + ("`" + G + "`" + fe + "."));
      }
      return A(H);
    }
    function q() {
      function E(f, k, H, M, Z) {
        return O(f[k]) ? null : new v("Invalid " + M + " `" + Z + "` supplied to " + ("`" + H + "`, expected a ReactNode."));
      }
      return A(E);
    }
    function W(E, f, k, H, M) {
      return new v(
        (E || "React class") + ": " + f + " type `" + k + "." + H + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + M + "`."
      );
    }
    function B(E) {
      function f(k, H, M, Z, G) {
        var z = k[H], U = N(z);
        if (U !== "object")
          return new v("Invalid " + Z + " `" + G + "` of type `" + U + "` " + ("supplied to `" + M + "`, expected `object`."));
        for (var X in E) {
          var Q = E[X];
          if (typeof Q != "function")
            return W(M, Z, G, X, V(Q));
...
const w = /* @__PURE__ */ br(Ir), Nn = {
  ...
  const [e, t] = oe(mn), r = Ce(), n = _((T, b, v = null) => {
    try {
  ...
  }, []), a = _((T) => n("fontFamily", T, "fontName"), [n]), o = _((T) => n("fontSize", T, "fontSize"), [n]), s = _((T) => n("color", T, "foreColor"), [n]), i = _((T) => {
    t((b) => ({
      ...b,
      alignLeft: T === "left",
    ...
    try {
      ...
      if (!L)
        return !1;
      if (!A) {
        const h = v.startContainer, p = h.nodeType === Node.TEXT_NODE ? h.parentElement : h, y = De(p) || Ur();
    ...
    try {
      ...
      if (A.innerHTML = T, Array.from(A.children).some(
        ...
        const L = v.startContainer, P = L.nodeType === Node.TEXT_NODE ? L.parentElement : L, h = De(P);
    ...
    try {
      ...
      if (v) {
        ...
        if (I) {
          ...
          const W = R.color;
          W && W !== "rgb(0, 0, 0)" && W !== "#000000" && (W.startsWith("rgb") ? L = $r(W) : L = W);
          const B = De(I);
          if (B) {
...
function Fr(e) {
  const t = [], r = e.startContainer, n = e.endContainer, a = De(
...
const xe = 'page-break, [data-page-break="true"]', Pn = (e) => Pe[e] || Pe.A4, Wr = (e, t = {}) => {
  if (!e || typeof document > "u")
    return [];
  const r = t.pageSize || "A4", n = Pn(r), a = e.querySelectorAll(xe), o = [];
  o.push({
    id: "page-0",
    pageNumber: 1,
    top: 0,
  ...
  try {
    ...
    }), e.querySelectorAll(xe).forEach((b, v) => {
  ...
  if (e)
    try {
      e.querySelectorAll(xe).forEach((r, n) => {
  ...
  if (e) {
    ...
    try {
      ...
      if (t === 0)
        ...
        const o = e.querySelectorAll(xe)[t - 1];
  ...
  try {
    ...
    if (r === 0)
      ...
      const s = t.querySelectorAll(xe)[r - 1];
      if (s)
        a = s;
      else {
  ...
  const a = Ce(), o = ee(null), s = ee(null), i = ee(e), g = ee(r), l = ee(n), c = ee(!1);
  ae(() => {
    i.current = e;
  }, [e]), ae(() => {
    g.current = r;
  ...
  const u = _((y = {}) => t?.current ? Wr(t.current, y) : [], [t]), d = _((y = {}) => {
    const I = u(y);
    ...
    ro(b, s, y);
  }, [b]), A = _((y) => !y?.current || !t?.current ? 0 : qr(y.current, t.current), [t]), $ = _((y) => {
    ...
    $,
    b
  ) : !1, [t, u, a, d, $, b]), p = _((y) => t?.current ? Xr(
    y,
    t.current,
    a.updateContinuousContent,
    d,
...
function mo(e) {
  return new Promise((t, r) => {
    ...
    a.onload = async (o) => {
      ...
      try {
        const l = await ze(), c = `editor-image-${ho()}`, d = l.transaction([ge], "readwrite").objectStore(ge), T = {
          key: c,
          dataUrl: s,
          size: g,
          type: e.type,
...
function tt(e) {
  ...
  if (!t)
    return "<p><br></p>";
  const r = document.createElement("div");
  return r.innerHTML = t, je(r) || "<p><br></p>";
}
function Eo(e) {
...
const Gs = [
  ...
  const a = On(), { pages: o, activePage: s, continuousContent: i } = a, { wordCount: g, outline: l } = Ee(() => {
...
const Se = new Ks("Editor"), $n = /* @__PURE__ */ new Set(["P", "DIV", "H1", "H2", "H3", "H4", "H5", "H6", "LI", "BLOCKQUOTE", "PRE", "TABLE"]), Fn = 32;
function Un(e, t) {
  if (!e) return;
...
const na = [
  ...
  const s = async (c) => {
    try {
      ...
      Se.info("Starting image upload", { fileName: c.name, fileSize: c.size });
      const d = await mo(c);
      Se.info("Image saved to IndexedDB", { key: d });
      const T = await yo(d);
      if (Se.info("Image retrieved from IndexedDB", { key: d, hasUrl: !!T }), T && n) {
        const v = `<img src="${T}" data-key="${d}" alt="Inserted image" />`;
        Se.info("Calling onInsertImage with HTML", { imageHtml: v.substring(0, 100) }), n(v), Se.info("Image inserted", { key: d });
      } else
        Se.warn("Image not inserted: missing imageUrl or onInsertImage callback", {
          hasUrl: !!T,
          hasCallback: !!n
        });
      ...
      Se.error("Error uploading image", u);
    }
...
const Oe = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && Oe(e.parentElement) : !1, Ht = ({
  dimensions: e,
  editorRef: t,
  onInput: r,
  onContentChange: n,
  ...
  const u = Ee(() => xn(c), [c]), d = l / 100, T = _((h, p) => {
    if (!h) return !1;
    const y = h.getBoundingClientRect(), I = p - y.top;
    return I < u.top || I > y.height - u.bottom;
  }, [u.top, u.bottom]), b = _((h, p) => {
    p.preventDefault();
    const y = h.getBoundingClientRect(), I = p.clientX - y.left, R = p.clientY - y.top, j = y.width - 40, q = -12, W = y.width - 20;
    I >= j && I <= W && R >= q && R <= 8 && g && g(h);
  }, [g]), v = _((h) => {
    h.preventDefault();
    ...
    if ((Oe(I) || Oe(R)) && (h.key.length === 1 || h.key === "Enter" || h.key === " "))
      return h.preventDefault(), !1;
    if (ta(h))
      return n && n(), !1;
    if ((h.key === "Backspace" || h.key === "Delete") && (Oe(I) || Oe(R)))
      return h.preventDefault(), !1;
    a && a(h);
  }, [a, n]), $ = _((h) => {
    if (!t.current) return;
...
const jt = ({
  ...
  const o = ee(null), s = ee(null), i = ee(null), g = ee(null), l = ee(a), c = ee(!1), u = Ce();
  ae(() => {
    l.current = a;
  }, [a]);
  const d = _((h) => {
    ...
    const { x: p, y, width: I, height: R } = i.current, j = g.current, q = h.clientX, W = h.clientY, B = fa({
      handler: j,
      startX: p,
      startY: y,
      currentX: q,
    ...
    const h = new MutationObserver((p) => {
      p.forEach((y) => {
        y.type === "childList" && (y.removedNodes.forEach((I) => {
          I.nodeType === Node.ELEMENT_NODE && we(I) && I === s.current && T();
...
const Bt = ({
  ...
  const [s, i] = oe({ top: 0, left: 0 }), [g, l] = oe(!1), [c, u] = oe("top"), [d, T] = oe(o), b = ee(null), v = ee(null), A = Ce(), $ = (x) => {
    if (!x)
      return;
  ...
  const y = _(() => {
    ...
    }, N = x.bottom >= 0 && x.top <= C.height && x.right >= 0 && x.left <= C.width;
    let V = "top", te = 0, ie = 0;
    if (N) {
      const M = x.top - O.height - 10, Z = C.height - x.bottom - O.height - 10;
      Z > M && Z > 0 ? (V = "bottom", te = x.bottom + 10) : (V = "top", te = x.top - O.height - 10);
    } else
      V = "top", te = 10;
    ie = x.left + x.width / 2 - O.width / 2;
    const E = window.innerWidth, f = window.innerHeight;
    let k = Math.max(10, Math.min(ie, E - O.width - 10)), H = Math.max(10, Math.min(te, f - O.height - 10));
    i({ top: H, left: k }), u(V), l(!0);
  }, [e]);
  wn(() => {
    y();
    const x = () => {
  ...
  const I = {
    ...
    if (e && I[x]) {
      const O = L(e), C = h, N = I[x];
      e.style.float = N.float, e.style.margin = N.margin, e.style.display = N.display, p(x), $(e);
      const V = L(e);
      A.recordOperation(
...
const zt = ({
  ...
  const o = ee(null), s = ee(null), i = ee(null), g = ee(null), l = ee(null), c = ee(a), u = ee(!1), [d, T] = oe(null), b = Ce();
  ae(() => {
    c.current = a;
  }, [a]);
  const v = _(() => {
    ...
    const j = R.currentTarget, q = j.dataset.type, W = parseInt(j.dataset.index, 10);
    ...
    return j && (o.current = j, s.current = R, document.body.appendChild(j), j.querySelectorAll(".table-resize-handler").forEach((W) => {
    ...
    const { x: j, y: q, structure: W } = i.current, B = g.current, x = l.current, O = R.clientX, C = R.clientY;
    let N = 0;
    switch (B) {
      case le.COLUMN:
        N = O - j;
    ...
    _e(s.current, V), o.current && St(o.current, s.current);
  }, []), h = _((R) => {
    if (u.current) {
    ...
    const R = new MutationObserver((j) => {
      j.forEach((q) => {
        q.type === "childList" && (q.removedNodes.forEach((W) => {
          W.nodeType === Node.ELEMENT_NODE && de(W) && W === d && v();
...
const $t = ({
  ...
  const [s, i] = oe({ top: 0, left: 0 }), [g, l] = oe(!1), [c, u] = oe("top"), d = ee(null), T = ee(null), b = Ce(), v = (C) => {
    if (!C)
      return;
  ...
  const h = _(() => {
    ...
    const C = e.getBoundingClientRect(), N = d.current.getBoundingClientRect(), V = window.visualViewport ? window.visualViewport : {
      width: window.innerWidth,
      height: window.innerHeight
    }, te = C.bottom >= 0 && C.top <= V.height && C.right >= 0 && C.left <= V.width;
    let ie = "top", E = 0, f = 0;
    if (te) {
      const G = C.top - N.height - 10, z = V.height - C.bottom - N.height - 10;
      z > G && z > 0 ? (ie = "bottom", E = C.bottom + 10) : (ie = "top", E = C.top - N.height - 10);
    } else
      ie = "top", E = 10;
    f = C.left + C.width / 2 - N.width / 2;
    const k = window.innerWidth, H = window.innerHeight;
    let M = Math.max(10, Math.min(f, k - N.width - 10)), Z = Math.max(10, Math.min(E, H - N.height - 10));
  ...
  const p = {
    ...
    if (e && p[C]) {
      ...
      b.recordOperation(
        ...
        { type: "TABLE_ALIGN", payload: { element: e, alignment: V, state: N } }
      ), t && t(C);
    }
  }, I = () => {
...
const Ft = ({
  ...
  const L = ee(null), P = _(() => {
    ...
    if (!x || !O) return null;
    const C = Array.from(O.rows).indexOf(x), N = Array.from(x.cells).indexOf(B);
    ...
    return x.filter((ie) => {
      const E = h(ie);
      return E && E.table === N && E.rowIndex === C.rowIndex;
    }).length >= 2 ? { mode: "row", rowIndex: C.rowIndex, colIndex: null } : x.filter((ie) => {
      const E = h(ie);
      return E && E.table === N && E.cellIndex === C.cellIndex;
    ...
    if (document.querySelectorAll(".table-cell-selected, .table-row-selected, .table-col-selected").forEach((V) => {
      ...
      } else B === "column" && O !== null ? Array.from(N.rows).forEach((V) => {
        const te = V.cells[O];
    ...
    const O = p(B);
    n(B), o(O.mode), i(O.rowIndex), l(O.colIndex), $(x), y(O.mode, O.rowIndex, O.colIndex, B, x);
    const C = O.mode ? {
      mode: O.mode,
      cells: B,
      rowIndex: O.rowIndex,
    ...
    const N = Math.min(O.rowIndex, C.rowIndex), V = Math.max(O.rowIndex, C.rowIndex), te = Math.min(O.cellIndex, C.cellIndex), ie = Math.max(O.cellIndex, C.cellIndex), E = /* @__PURE__ */ new Set();
    for (let f = N; f <= V; f++) {
      const k = A.rows[f];
      if (k)
        for (let H = te; H <= ie; H++) {
  ...
  return ae(() => {
    ...
    return B.addEventListener("mousedown", x, !0), B.addEventListener("mouseenter", O, !0), document.addEventListener("mouseup", q), document.addEventListener("click", W), () => {
      B.removeEventListener("mousedown", x, !0), B.removeEventListener("mouseenter", O, !0), document.removeEventListener("mouseup", q), document.removeEventListener("click", W);
    };
  }, [e, R, j, q, W]), ae(() => {
    if (!e.current) return;
...
const xa = 50, Qe = 50, Ca = 50, Aa = 100, Ra = 300, Ut = Ot(({
  ...
  const u = On(), d = Ce(), { pageSize: T, pageMargins: b, continuousContent: v, pageBoundaries: A, activePage: $, zoomLevel: L, canUndo: P, canRedo: h } = u, p = ee(null), y = ee(null), { currentFormat: I, formatText: R, updateCurrentFormatFromSelection: j } = zr(), [q, W] = oe(!1), [B, x] = oe(null), [O, C] = oe(!0), [N, V] = oe(!1), [te, ie] = oe(null), [E, f] = oe(null), [k, H] = oe(null), M = ee(null), {
  ...
  } = lo(T, y, L, b), fe = Ee(() => _t(T), [T]), [Ne, $e] = oe(!1), Ae = ee(null), Fe = ee(!1), Ue = ee(!1), it = ee(!1), Re = ee(v);
  ae(() => {
    if (y.current) {
      if (!it.current) {
        y.current.innerHTML = v, it.current = !0, Re.current = v;
        const S = setTimeout(() => {
          U();
        }, xa);
      ...
      if (Re.current !== v) {
        if (y.current.innerHTML !== v) {
          ...
          return Re.current = v, () => clearTimeout(K);
        }
        Re.current = v;
      }
    }
  ...
  const Wt = Ee(() => ({
    ...
    setContent: (S) => {
      const K = tt(S);
      K !== v && d.updateContinuousContent(K), y.current && y.current.innerHTML !== K && (y.current.innerHTML = K), Re.current = K, y.current && setTimeout(() => {
        U();
      }, Qe);
    },
    /**
     ...
     */
    setPageSize: (S) => {
      d.updatePageSize(S), U({ pageSize: S });
    },
    /**
     ...
     */
    setPageMargins: (S) => {
      d.updatePageMargins(S), U({ pageMargins: S });
    },
    /**
    ...
    insertContent: (S) => {
      ...
      const K = tt(S), se = window.getSelection();
      let ue = !1;
      ...
      if (!ue && M.current)
        try {
          ...
          if (me) {
            ...
            me.nodeType === Node.TEXT_NODE ? Ze.setStart(me, me.textContent.length) : Ze.setStartAfter(me), Ze.collapse(!0), se.removeAllRanges(), se.addRange(Ze);
          }
        }
      document.execCommand("insertHTML", !1, K);
      const pe = y.current.innerHTML;
      d.updateContinuousContent(pe), Re.current = pe, setTimeout(() => {
        U(), X(200);
      }, Qe);
    }
  }), [v, d, U, y, M, Z]);
  yr(c, () => Wt, [Wt]), ae(() => {
    ...
    return y.current && y.current.addEventListener("focus", K), () => {
      document.removeEventListener("selectionchange", S), y.current && y.current.removeEventListener("focus", K);
    };
  }, [j]);
  const qt = _(() => {
    Fe.current = !1;
    const S = Math.max(0, A.length - 1);
    d.setActivePage(S), setTimeout(() => {
      z(S, p);
    }, Ca);
  }, [A.length, d, z]), ct = _(() => {
    if (!y.current) return;
    let S = y.current.innerHTML;
    S = tt(S), S !== y.current.innerHTML && (y.current.innerHTML = S);
    const K = v;
    if (K !== S) {
      const ue = {
    ...
    d.updateContinuousContent(S), Z(), X(200);
    const se = G(p);
    se !== $ && d.setActivePage(se);
  }, [d, Z, G, $, X, p, y, v]), tr = _((S) => {
    ct();
  }, [ct]), Gt = _((S) => {
    d.updatePageSize(S), U({ pageSize: S }), a && a(S);
  }, [d, U, a]), Zt = _((S) => {
    d.updatePageMargins(S), U({ pageMargins: S }), o && o(S);
  }, [d, U, o]), Yt = _((S) => {
    S < 0 || S >= A.length || (Ue.current = !0, d.setActivePage(S), z(S, p), setTimeout(() => {
      Ue.current = !1;
    }, Ra), t && t(S));
  }, [d, z, t, A.length]), Vt = _(() => {
    const S = A.length + 1;
    D(S) && (Fe.current = !0, setTimeout(() => {
      Fe.current && qt();
    }, 100)), r && r();
  }, [A.length, D, d, z, r]), nr = _(() => {
    ...
    d.updateContinuousContent(ue), Re.current = ue, setTimeout(() => {
      U(), X(200);
    }, Qe);
  }, [d, U, X, y, M]), or = _((S) => {
    if (!S) return;
  ...
  const sr = _(() => {
    !p.current || !y.current || Ue.current || (Ae.current && clearTimeout(Ae.current), Ae.current = setTimeout(() => {
      if (Ue.current) {
        Ae.current = null;
        return;
      }
      const S = G(p);
      S !== $ && S >= 0 && d.setActivePage(S), Ae.current = null;
    }, Aa));
  }, [G, $, d]), ar = Ee(() => {
    if (!v) return 0;
    const K = v.replace(/<[^>]*>/g, " ").match(new RegExp("\\p{L}+", "gu"));
    return K ? K.length : 0;
  }, [v]), ir = A.length || 1, cr = _((S) => {
    W(!0), x(S);
  }, []), Qt = _(() => {
    W(!1), x(null);
  }, []), lr = _((S, K) => {
...
export {
  ...
  Me as DEFAULT_IMAGE_RESIZE_OPTIONS,
