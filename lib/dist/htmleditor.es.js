import qe, { createContext as On, useContext as Cn, useReducer as Mn, useMemo as Te, useState as de, useCallback as L, useRef as J, useEffect as ae, forwardRef as ft, createElement as nt, memo as Nn, useLayoutEffect as In, useImperativeHandle as Ln } from "react";
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    var b = qe, T = Symbol.for("react.transitional.element"), v = Symbol.for("react.portal"), _ = Symbol.for("react.fragment"), M = Symbol.for("react.strict_mode"), D = Symbol.for("react.profiler"), N = Symbol.for("react.consumer"), y = Symbol.for("react.context"), d = Symbol.for("react.forward_ref"), m = Symbol.for("react.suspense"), O = Symbol.for("react.suspense_list"), G = Symbol.for("react.memo"), V = Symbol.for("react.lazy"), se = Symbol.for("react.activity"), re = Symbol.for("react.client.reference"), ne = b.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, k = Object.prototype.hasOwnProperty, F = Array.isArray, te = console.createTask ? console.createTask : function() {
      return null;
    };
    b = {
...
function Zn() {
  ...
  return Z.AsyncMode = g, Z.ConcurrentMode = f, Z.ContextConsumer = s, Z.ContextProvider = o, Z.Element = t, Z.ForwardRef = p, Z.Fragment = n, Z.Lazy = T, Z.Memo = b, Z.Portal = r, Z.Profiler = a, Z.StrictMode = i, Z.Suspense = c, Z.isAsyncMode = function(d) {
    ...
    return typeof d == "string" || typeof d == "function" || d === n || d === f || d === a || d === i || d === c || d === l || typeof d == "object" && d !== null && (d.$$typeof === T || d.$$typeof === b || d.$$typeof === o || d.$$typeof === s || d.$$typeof === p || d.$$typeof === _ || d.$$typeof === M || d.$$typeof === D || d.$$typeof === v);
  }, Z.typeOf = N, Z;
}
var Y = {};
/** @license React v16.13.1
...
function Yn() {
  return Lt || (Lt = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function N(P) {
      ...
      P === n || P === f || P === a || P === i || P === c || P === l || typeof P == "object" && P !== null && (P.$$typeof === T || P.$$typeof === b || P.$$typeof === o || P.$$typeof === s || P.$$typeof === p || P.$$typeof === _ || P.$$typeof === M || P.$$typeof === D || P.$$typeof === v);
    }
    function y(P) {
    ...
    var d = g, m = f, O = s, G = o, V = t, se = p, re = n, ne = T, k = b, F = r, te = a, K = i, Q = c, ee = !1;
    function ie(P) {
    ...
    Y.AsyncMode = d, Y.ConcurrentMode = m, Y.ContextConsumer = O, Y.ContextProvider = G, Y.Element = V, Y.ForwardRef = se, Y.Fragment = re, Y.Lazy = ne, Y.Memo = k, Y.Portal = F, Y.Profiler = te, Y.StrictMode = K, Y.Suspense = Q, Y.isAsyncMode = ie, Y.isConcurrentMode = E, Y.isContextConsumer = u, Y.isContextProvider = A, Y.isElement = R, Y.isForwardRef = S, Y.isFragment = z, Y.isLazy = H, Y.isMemo = C, Y.isPortal = j, Y.isProfiler = U, Y.isStrictMode = $, Y.isSuspense = oe, Y.isValidElementType = N, Y.typeOf = y;
  })()), Y;
}
var Dt;
function nn() {
...
const x = /* @__PURE__ */ jn(er), on = {
  ...
  const [e, t] = de(Gt), r = ke(), n = L((c, l, b = null) => {
    try {
      ...
      try {
        ...
        return M.appendChild(D), v.insertNode(M), v.selectNodeContents(M), T.removeAllRanges(), T.addRange(v), t((N) => ({ ...N, [c]: l })), !0;
      } catch {
        if (b) {
          const M = c === "fontSize" ? or[l] || "3" : l;
          return document.execCommand(b, !1, M), t((D) => ({ ...D, [c]: l })), !0;
        }
        return !1;
      }
    } catch (T) {
  ...
  }, []), i = L((c) => n("fontFamily", c, "fontName"), [n]), a = L((c) => n("fontSize", c, "fontSize"), [n]), o = L((c) => {
    t((l) => ({
      ...l,
      alignLeft: c === "left",
...
const me = 'page-break, [data-page-break="true"]', an = (e) => ue[e] || ue.A4, cr = (e, t = {}) => {
    ...
    for (let l = 0; l < f.length && c < Wt; l++) {
      ...
      if (T && T.overflowIndex > 0) {
        ...
        if (v - g < Er)
          continue;
        const M = l + 2;
        dr(T.overflowElement, M) && (p = !0, c++, f = qt(e));
      }
    }
    if (p) {
      if (i) {
  ...
  const c = L((m = {}) => t?.current ? cr(t.current, m) : [], [t]), l = L((m = {}) => {
    const O = c(m);
    return i.updatePageBoundaries(O), O;
  }, [c, i]), b = L((m = {}) => {
    const O = typeof m.delay == "number" ? m.delay : wr;
    Pr(l, a, m, O);
  }, [l]), T = L(() => {
    t?.current && Tr(
      t.current,
    ...
    vr(T, o, m);
  }, [T]), _ = L((m) => !m?.current || !t?.current ? 0 : lr(m.current, t.current), [t]), M = L((m) => {
    ...
    Ar(O.current, t.current, m, M);
  }, [t, M]), N = L(async (m) => t?.current ? fr(
    t.current,
    m,
    s.current,
    g.current,
    ...
    M,
    T
  ) : !1, [t, c, i, l, M, T]), d = L((m) => t?.current ? hr(
    m,
    t.current,
    i.updateContinuousContent,
    l,
...
function Na({
  ...
  if (s.preserveAspectRatio && s.aspectRatio) {
    ...
    [
      ...
      I.BOTTOM_LEFT,
      I.BOTTOM_RIGHT
    ].includes(e) ? p / l > c ? c = Math.max(s.minHeight, p / l) : p = Math.max(s.minWidth, c * l) : [I.TOP, I.BOTTOM].includes(e) ? p = c * l : [I.LEFT, I.RIGHT].includes(e) && (c = p / l);
  }
        ...
        /* @__PURE__ */ h.jsxs("div", { className: "sidebar-header", children: [
          ...
          /* @__PURE__ */ h.jsx(
            "button",
            {
              ...
              children: e ? /* @__PURE__ */ h.jsx(Jr, { size: 16 }) : /* @__PURE__ */ h.jsx(Kr, { size: 16 })
            }
          )
        ] }),
        !e && /* @__PURE__ */ h.jsxs("div", { className: "sidebar-content", children: [
          ...
          p.length > 0 && /* @__PURE__ */ h.jsxs("div", { className: "sidebar-section", children: [
            /* @__PURE__ */ h.jsxs("h3", { children: [
              /* @__PURE__ */ h.jsx(pn, { size: 14, style: { display: "inline-block", marginRight: "6px", verticalAlign: "middle" } }),
              "Document Outline"
            ] }),
            /* @__PURE__ */ h.jsx("div", { className: "document-outline", "data-testid": "outline", children: p.map((b) => {
              ...
              return /* @__PURE__ */ h.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ h.jsx(T, { size: 12, className: "outline-icon" }),
                    /* @__PURE__ */ h.jsx("span", { className: "outline-text", children: b.text }),
  ...
  return /* @__PURE__ */ h.jsxs("div", { className: "editor-toolbar", children: [
    ...
    /* @__PURE__ */ h.jsx(
      "select",
      {
        ...
        title: "Font Family",
        children: la.map(({ value: f, label: p }) => /* @__PURE__ */ h.jsx("option", { value: f, children: p }, f))
      }
    ),
    /* @__PURE__ */ h.jsx(
      "select",
      {
        ...
        value: e.fontSize || We,
        title: "Font Size",
        children: tr.map(({ value: f, label: p }) => /* @__PURE__ */ h.jsx("option", { value: f, children: p }, f))
      }
    ),
    /* @__PURE__ */ h.jsx(
      "select",
      {
        ...
        title: "Heading Level",
        children: ua.map(({ value: f, label: p }) => /* @__PURE__ */ h.jsx("option", { value: f, children: p }, f))
      }
    ),
    g(),
    ...
    /* @__PURE__ */ h.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ h.jsx(xo, { size: 16 })
      }
    ),
    /* @__PURE__ */ h.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ h.jsx(To, { size: 16 })
      }
    ),
    g(),
    /* @__PURE__ */ h.jsx(
      "button",
      {
        ...
        title: "Insert Link",
        children: /* @__PURE__ */ h.jsx(Eo, { size: 16 })
      }
    ),
    ...
    /* @__PURE__ */ h.jsx(
      "button",
      {
        ...
        title: "Insert Image",
        children: /* @__PURE__ */ h.jsx(go, { size: 16 })
      }
    )
  ] });
};
...
const Ee = (e) => e ? e.nodeType === Node.ELEMENT_NODE ? e.tagName === "PAGE-BREAK" || e.getAttribute("data-page-break") === "true" : e.parentElement && Ee(e.parentElement) : !1, yt = ({
  ...
  const c = Te(() => Kt(p), [p]), l = f / 100, b = L((y, d) => {
    if (!y) return !1;
    const m = y.getBoundingClientRect(), O = d - m.top;
    return O < c.top || O > m.height - c.bottom;
  }, [c.top, c.bottom]), T = L((y, d) => {
    d.preventDefault();
    const m = y.getBoundingClientRect(), O = d.clientX - m.left, G = d.clientY - m.top, V = m.width - 40, se = -12, re = m.width - 20;
    O >= V && O <= re && G >= se && G <= 8 && g && g(y);
  }, [g]), v = L((y) => {
    y.preventDefault();
    ...
    if ((Ee(O) || Ee(G)) && (y.key.length === 1 || y.key === "Enter" || y.key === " "))
      return y.preventDefault(), !1;
    if (ca(y))
      return n && n(), !1;
    if ((y.key === "Backspace" || y.key === "Delete") && (Ee(O) || Ee(G)))
      return y.preventDefault(), !1;
    i && i(y);
  }, [i, n]), M = L((y) => {
    if (!t.current) return;
  ...
  return /* @__PURE__ */ h.jsxs("div", { className: "page-manager", children: [
    /* @__PURE__ */ h.jsxs("div", { className: "page-settings-group", children: [
      /* @__PURE__ */ h.jsxs("div", { className: "page-settings-header", children: [
        /* @__PURE__ */ h.jsx(No, { size: 14, style: { marginRight: "4px", verticalAlign: "middle" } }),
        "Page Settings"
      ] }),
        ...
        /* @__PURE__ */ h.jsxs("div", { className: "page-setting-item", children: [
          ...
          /* @__PURE__ */ h.jsx(
            "select",
            {
              ...
              children: Fn().map((d) => /* @__PURE__ */ h.jsx("option", { value: d, children: Gn(d) }, d))
            }
          )
        ] })
      ] })
    ...
    /* @__PURE__ */ h.jsxs("div", { className: "zoom-controls-compact", children: [
      /* @__PURE__ */ h.jsx(
        "button",
        {
          ...
          "aria-label": "Zoom out",
          title: "Zoom out (Ctrl + -)",
          children: /* @__PURE__ */ h.jsx(ea, { size: 12 })
        }
      ),
      ...
      /* @__PURE__ */ h.jsx(
        "button",
        {
          ...
          "aria-label": "Zoom in",
          title: "Zoom in (Ctrl + +)",
          children: /* @__PURE__ */ h.jsx(Jo, { size: 12 })
        }
      ),
      /* @__PURE__ */ h.jsx(
        "button",
...
const bt = ({
  ...
  const l = L((y) => {
    ...
    const { x: d, y: m, width: O, height: G } = s.current, V = g.current, se = y.clientX, re = y.clientY, ne = ba({
      handler: V,
      startX: d,
      startY: m,
      currentX: se,
  ...
  return ae(() => {
    ...
    if (!e.current) return;
    const y = e.current;
    return y.addEventListener("click", M), y.addEventListener("keydown", D), window.addEventListener("resize", N), () => {
      y.removeEventListener("click", M), y.removeEventListener("keydown", D), window.removeEventListener("resize", N), p.current && (document.removeEventListener("mousemove", v), document.removeEventListener("mouseup", _), document.body.classList.remove("resize-in-progress"), document.body.style.cursor = ""), a.current && et(a.current);
    };
  }, [e, M, D, N, v, _]), ae(() => {
    if (!e.current) return;
    const y = new MutationObserver((d) => {
      d.forEach((m) => {
        m.type === "childList" && (m.removedNodes.forEach((O) => {
          O.nodeType === Node.ELEMENT_NODE && he(O) && O === o.current && b();
...
const Tt = ({
  ...
  const [o, s] = de({ top: 0, left: 0 }), [g, f] = de(!1), [p, c] = de("top"), [l, b] = de(a), T = J(null), v = J(null), _ = ke(), M = (k) => {
    if (!k)
      return;
  ...
  const m = L(() => {
    ...
    const k = e.getBoundingClientRect(), F = T.current.getBoundingClientRect(), te = window.visualViewport ? window.visualViewport : {
    ...
    if (K) {
      ...
      Q = "top", ee = 10;
    ie = k.left + k.width / 2 - F.width / 2;
    const E = window.innerWidth, u = window.innerHeight;
    let A = Math.max(10, Math.min(ie, E - F.width - 10)), R = Math.max(10, Math.min(ee, u - F.height - 10));
  ...
  In(() => {
    ...
    const k = (F) => {
      T.current && !T.current.contains(F.target) && F.target !== e && i();
    };
  ...
  const O = {
    ...
    if (e && O[k]) {
      ...
      e.style.float = K.float, e.style.margin = K.margin, e.style.display = K.display, d(k), M(e);
      const Q = D(e);
      _.recordOperation(
        ...
        children: [
          /* @__PURE__ */ h.jsx(
            "button",
            {
              ...
              children: l ? /* @__PURE__ */ h.jsx(Co, { size: 14 }) : /* @__PURE__ */ h.jsx(fo, { size: 14 })
            }
          ),
          /* @__PURE__ */ h.jsx(
            "button",
          ...
          /* @__PURE__ */ h.jsx(
            "button",
            {
              ...
              title: "Align Center",
              style: ne(y === "center"),
              children: /* @__PURE__ */ h.jsx(gn, { size: 14 })
            }
          ),
          /* @__PURE__ */ h.jsx(
            "button",
          ...
          /* @__PURE__ */ h.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ h.jsx(Go, { size: 14 })
            }
          )
        ]
      }
...
const xa = 50, tt = 50, Aa = 50, vt = ft(({
  ...
  const c = tn(), l = ke(), { pageSize: b, pageMargins: T, continuousContent: v, pageBoundaries: _, activePage: M, zoomLevel: D, canUndo: N, canRedo: y } = c, d = J(null), m = J(null), { currentFormat: O, formatText: G, updateCurrentFormatFromSelection: V } = ar(), [se, re] = de(!1), [ne, k] = de(null), [F, te] = de(!0), K = J(null), {
  ...
  } = Sr(b, m, D, T), z = Te(() => gt(b), [b]), [H, C] = de(!1), j = J(null), U = J(!1), $ = J(!1), oe = J(!1), P = J(v);
  ae(() => {
    if (m.current) {
      if (!oe.current) {
  ...
  const ce = Te(() => ({
     ...
     */
    getCursorPosition: () => m.current ? _r(m.current) : null,
    /**
  ...
  const ye = L(() => {
    ...
    const X = ee(d);
    X !== M && l.setActivePage(X);
  }, [l, Q, ee, M, u, d, m, v]), xn = L((w) => {
    ve();
  }, [ve]), xt = L((w) => {
    ...
    w < 0 || w >= _.length || ($.current = !0, l.setActivePage(w), ie(w, d), setTimeout(() => {
      $.current = !1;
    }, NAVIGATION_LOCK_TIMEOUT), t && t(w));
  }, [l, ie, t, _.length]), _t = L(() => {
    const w = _.length + 1;
    S(w) && (U.current = !0, setTimeout(() => {
      U.current && ye();
    }, 100)), r && r();
  }, [_.length, S, l, ie, r]), An = L(() => {
  ...
  ae(() => {
    const w = (W) => {
      if (W.ctrlKey || W.metaKey) {
        ...
        const X = document.activeElement === m.current, le = document.activeElement === d.current, ge = document.activeElement?.tagName === "INPUT" || document.activeElement?.tagName === "TEXTAREA" || document.activeElement?.isContentEditable === !1;
        if (X || le || !ge)
          switch (W.key) {
            case "+":
            case "=":
  ...
  const _n = L(() => {
    !d.current || !m.current || $.current || (j.current && clearTimeout(j.current), j.current = setTimeout(() => {
      ...
      const w = ee(d);
      w !== M && w >= 0 && l.setActivePage(w), j.current = null;
    }, SCROLL_DEBOUNCE));
  }, [ee, M, l]), wn = Te(() => {
    if (!v) return 0;
    const W = v.replace(/<[^>]*>/g, " ").match(new RegExp("\\p{L}+", "gu"));
    return W ? W.length : 0;
  }, [v]), Sn = _.length || 1, Rn = L((w) => {
    re(!0), k(w);
  }, []), kt = L(() => {
    re(!1), k(null);
  }, []), kn = L((w, W) => {
